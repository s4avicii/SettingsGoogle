...
public class ResetDashboardFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.reset_dashboard_fragment) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.reset_dashboard_fragment;
    }
