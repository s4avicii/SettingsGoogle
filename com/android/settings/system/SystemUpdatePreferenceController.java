...
public class SystemUpdatePreferenceController extends BasePreferenceController {
    ...
    public int getAvailabilityStatus() {
        return (!this.mContext.getResources().getBoolean(C0444R.bool.config_show_system_update_settings) || !this.mUm.isAdminUser()) ? 3 : 0;
    }
    ...
    public CharSequence getSummary() {
        String string = this.mContext.getString(C0444R.string.android_version_summary, new Object[]{Build.VERSION.RELEASE_OR_PREVIEW_DISPLAY});
        ...
        try {
            ...
            if (i == 0) {
                ...
                if (i == 2 || i == 3 || i == 4 || i == 5) {
                    return this.mContext.getText(C0444R.string.android_version_pending_update_summary);
                }
                return string;
            }
            ...
            return this.mContext.getString(C0444R.string.android_version_summary, new Object[]{string2});
