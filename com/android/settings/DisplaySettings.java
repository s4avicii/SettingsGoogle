...
public class DisplaySettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.display_settings) {
    ...
    public int getHelpResource() {
        return C0444R.string.help_uri_display;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.display_settings;
    }
