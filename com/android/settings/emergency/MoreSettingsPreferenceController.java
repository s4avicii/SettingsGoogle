...
public class MoreSettingsPreferenceController extends BasePreferenceController implements View.OnClickListener {
    ...
    public MoreSettingsPreferenceController(Context context, String str) {
        super(context, str);
        String string = this.mContext.getResources().getString(C0444R.string.config_emergency_package_name);
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        Button button = (Button) layoutPreference.findViewById(C0444R.C0448id.button);
    ...
    private Drawable getIcon() {
        try {
            ApplicationInfo applicationInfo = this.mContext.getPackageManager().getApplicationInfo(this.mContext.getResources().getString(C0444R.string.config_emergency_package_name), 33280);
    ...
    private CharSequence getButtonText() {
        ...
        try {
            ...
            return this.mContext.getString(C0444R.string.open_app_button, new Object[]{applicationInfo.loadLabel(packageManager)});
