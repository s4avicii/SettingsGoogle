...
class LocaleDragCell extends RelativeLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mLabel = (TextView) findViewById(C0444R.C0448id.label);
        this.mLocalized = (TextView) findViewById(C0444R.C0448id.l10nWarn);
        this.mMiniLabel = (TextView) findViewById(C0444R.C0448id.miniLabel);
        this.mCheckbox = (CheckBox) findViewById(C0444R.C0448id.checkbox);
        this.mDragHandle = (ImageView) findViewById(C0444R.C0448id.dragHandle);
    }
