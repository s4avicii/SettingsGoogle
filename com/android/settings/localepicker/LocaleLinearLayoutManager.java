...
public class LocaleLinearLayoutManager extends LinearLayoutManager {
    ...
    public LocaleLinearLayoutManager(Context context, LocaleDragAndDropAdapter localeDragAndDropAdapter) {
        ...
        this.mActionMoveUp = new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C0444R.C0448id.action_drag_move_up, context.getString(C0444R.string.action_drag_label_move_up));
        this.mActionMoveDown = new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C0444R.C0448id.action_drag_move_down, context.getString(C0444R.string.action_drag_label_move_down));
        this.mActionMoveTop = new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C0444R.C0448id.action_drag_move_top, context.getString(C0444R.string.action_drag_label_move_top));
        this.mActionMoveBottom = new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C0444R.C0448id.action_drag_move_bottom, context.getString(C0444R.string.action_drag_label_move_bottom));
        this.mActionRemove = new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C0444R.C0448id.action_drag_remove, context.getString(C0444R.string.action_drag_label_remove));
    }
