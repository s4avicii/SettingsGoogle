...
public class WifiSliceItem {
    ...
    public CharSequence getContentDescription() {
        ...
        charSequenceArr[1] = ",";
        if (this.mSecurity == 0) {
            str = this.mContext.getString(C0444R.string.accessibility_wifi_security_type_none);
        } else {
            str = this.mContext.getString(C0444R.string.accessibility_wifi_security_type_secured);
        }
