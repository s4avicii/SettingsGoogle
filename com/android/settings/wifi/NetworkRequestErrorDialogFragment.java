...
public class NetworkRequestErrorDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        if (error_dialog_type2 == error_dialog_type) {
            builder.setMessage((int) C0444R.string.network_connection_timeout_dialog_message).setPositiveButton((int) C0444R.string.network_connection_timeout_dialog_ok, (DialogInterface.OnClickListener) new NetworkRequestErrorDialogFragment$$ExternalSyntheticLambda0(this)).setNegativeButton((int) C0444R.string.cancel, (DialogInterface.OnClickListener) new NetworkRequestErrorDialogFragment$$ExternalSyntheticLambda1(this));
        } else {
            builder.setMessage((int) C0444R.string.network_connection_errorstate_dialog_message).setPositiveButton((int) C0444R.string.okay, (DialogInterface.OnClickListener) new NetworkRequestErrorDialogFragment$$ExternalSyntheticLambda2(this));
        }
