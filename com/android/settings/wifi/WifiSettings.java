...
public class WifiSettings extends RestrictedSettingsFragment implements WifiPickerTracker.WifiPickerTrackerCallback, WifiDialog2.WifiDialog2Listener, DialogInterface.OnDismissListener {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.wifi_settings) {
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        ((SettingsActivity) activity).getSwitchBar().setTitle(getContext().getString(C0444R.string.wifi_settings_primary_switch_title));
    }
    ...
    private void addPreferences() {
        addPreferencesFromResource(C0444R.xml.wifi_settings);
    ...
    public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
        ...
        if (preference instanceof LongPressWifiEntryPreference) {
            ...
            if (this.mSelectedWifiEntry.canDisconnect()) {
                contextMenu.add(0, 6, 0, C0444R.string.share);
    ...
    public void onWifiStateChanged() {
        if (!this.mIsRestricted) {
            ...
            if (wifiState == 0) {
                ...
                addMessagePreference(C0444R.string.wifi_stopping);
            } else if (wifiState == 1) {
                setOffMessage();
                ...
                removeConnectedWifiEntryPreference();
                removeWifiEntryPreference();
                addMessagePreference(C0444R.string.wifi_starting);
    ...
    private void setOffMessage() {
        CharSequence charSequence;
        CharSequence text = getText(C0444R.string.wifi_empty_list_wifi_off);
        if (this.mWifiManager.isScanAlwaysAvailable()) {
            charSequence = getText(C0444R.string.wifi_scan_notify_text);
        } else {
            charSequence = getText(C0444R.string.wifi_scan_notify_text_scanning_off);
        }
    ...
    public /* synthetic */ void lambda$setOffMessage$9() {
        new SubSettingLauncher(getContext()).setDestination(WifiScanningFragment.class.getName()).setTitleRes(C0444R.string.location_scanning_wifi_always_scanning_title).setSourceMetricsCategory(getMetricsCategory()).launch();
    }
    ...
    private class WifiConnectActionListener implements WifiManager.ActionListener {
        ...
        public void onFailure(int i) {
            if (!WifiSettings.this.isFinishingOrDestroyed()) {
                Toast.makeText(WifiSettings.this.getContext(), C0444R.string.wifi_failed_connect_message, 0).show();
            }
        }
    }
