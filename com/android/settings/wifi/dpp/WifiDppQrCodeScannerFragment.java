...
public class WifiDppQrCodeScannerFragment extends WifiDppQrCodeBaseFragment implements TextureView.SurfaceTextureListener, QrCamera.ScannerCallback, WifiManager.ActionListener {
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 1) {
                ...
                if (i == 4) {
                    ...
                    if (!z) {
                        WifiDppQrCodeScannerFragment.this.showErrorMessageAndRestartCamera(C0444R.string.wifi_dpp_check_connection_try_again);
                        return;
                    }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        if (this.mIsConfiguratorMode) {
            getActivity().setTitle(C0444R.string.wifi_dpp_add_device_to_network);
        } else {
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return layoutInflater.inflate(C0444R.C0450layout.wifi_dpp_qrcode_scanner_fragment, viewGroup, false);
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (this.mIsConfiguratorMode) {
            setHeaderTitle(C0444R.string.wifi_dpp_add_device_to_network, new Object[0]);
            WifiNetworkConfig wifiNetworkConfig = ((WifiNetworkConfig.Retriever) getActivity()).getWifiNetworkConfig();
            if (WifiNetworkConfig.isValidConfig(wifiNetworkConfig)) {
                this.mSummary.setText(getString(C0444R.string.wifi_dpp_center_qr_code, wifiNetworkConfig.getSsid()));
            } else {
    ...
    private class EasyConnectEnrolleeStatusCallback extends EasyConnectStatusCallback {
        ...
        public void onFailure(int i) {
            ...
            int i2 = C0444R.string.wifi_dpp_failure_authentication_or_configuration;
            switch (i) {
                case -9:
                ...
                case -7:
                    i2 = C0444R.string.wifi_dpp_failure_generic;
                    break;
                case -6:
                    i2 = C0444R.string.wifi_dpp_failure_timeout;
                    break;
                case -5:
                ...
                case -2:
                    break;
                case -3:
                    i2 = C0444R.string.wifi_dpp_failure_not_compatible;
                    break;
                case -1:
                    i2 = C0444R.string.wifi_dpp_qr_code_is_not_valid_format;
                    break;
                default:
    ...
    public void onFailure(int i) {
        ...
        showErrorMessageAndRestartCamera(C0444R.string.wifi_dpp_check_connection_try_again);
    }
    ...
    public void updateEnrolleeSummary() {
        String str;
        if (isWifiDppHandshaking()) {
            this.mSummary.setText(C0444R.string.wifi_dpp_connecting);
            return;
        }
        if (TextUtils.isEmpty(this.mSsid)) {
            str = getString(C0444R.string.wifi_dpp_scan_qr_code_join_unknown_network, this.mSsid);
        } else {
            str = getString(C0444R.string.wifi_dpp_scan_qr_code_join_network, this.mSsid);
        }
