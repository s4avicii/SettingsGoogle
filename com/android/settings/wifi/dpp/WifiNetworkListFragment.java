...
public class WifiNetworkListFragment extends SettingsPreferenceFragment implements SavedNetworkTracker.SavedNetworkTrackerCallback, Preference.OnPreferenceClickListener {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        addPreferencesFromResource(C0444R.xml.wifi_dpp_network_list);
        ...
        this.mAddPreference.setTitle((int) C0444R.string.wifi_add_network);
    ...
    public boolean onPreferenceClick(Preference preference) {
        if (preference instanceof WifiEntryPreference) {
            ...
            new SubSettingLauncher(getContext()).setTitleRes(C0444R.string.wifi_add_network).setDestination(AddNetworkFragment.class.getName()).setSourceMetricsCategory(getMetricsCategory()).setResultListener(this, 1).launch();
        }
        return true;
    }
