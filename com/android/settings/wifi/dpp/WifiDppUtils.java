...
public class WifiDppUtils {
    ...
    public static void showLockScreen(Context context, final Runnable runnable) {
        ...
        if (keyguardManager.isKeyguardSecure()) {
            C13971 r1 = new BiometricPrompt.AuthenticationCallback() {
            ...
            BiometricPrompt.Builder title = new BiometricPrompt.Builder(context).setTitle(context.getText(C0444R.string.wifi_dpp_lockscreen_title));
