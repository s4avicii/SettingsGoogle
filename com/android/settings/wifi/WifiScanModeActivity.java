    ...
    public static class AlertDialogFragment extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            if (TextUtils.isEmpty(this.mApp)) {
                str = getString(C0444R.string.wifi_scan_always_turn_on_message_unknown);
            } else {
                str = getString(C0444R.string.wifi_scan_always_turnon_message, this.mApp);
            }
            return builder.setMessage((CharSequence) str).setPositiveButton((int) C0444R.string.wifi_scan_always_confirm_allow, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                    ((WifiScanModeActivity) AlertDialogFragment.this.getActivity()).doPositiveClick();
                }
            }).setNegativeButton((int) C0444R.string.wifi_scan_always_confirm_deny, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
