...
public class WifiP2pPeer extends Preference {
    ...
    public WifiP2pPeer(Context context, WifiP2pDevice wifiP2pDevice) {
        ...
        setWidgetLayoutResource(C0444R.C0450layout.preference_widget_wifi_signal);
        ...
        setSummary((CharSequence) context.getResources().getStringArray(C0444R.array.wifi_p2p_status)[this.device.status]);
    }

    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        super.onBindViewHolder(preferenceViewHolder);
        ImageView imageView = (ImageView) preferenceViewHolder.findViewById(C0444R.C0448id.signal);
        this.mSignal = imageView;
        if (this.mRssi == Integer.MAX_VALUE) {
            imageView.setImageDrawable((Drawable) null);
        } else {
            imageView.setImageResource(C0444R.C0447drawable.wifi_signal);
