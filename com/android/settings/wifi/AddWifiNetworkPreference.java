...
public class AddWifiNetworkPreference extends Preference {
    ...
    private final Drawable mScanIconDrawable = getDrawable(C0444R.C0447drawable.ic_scan_24dp);
    ...
    public AddWifiNetworkPreference(Context context) {
        ...
        setIcon((int) C0444R.C0447drawable.ic_add_24dp);
        setTitle((int) C0444R.string.wifi_add_network);
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        imageButton.setContentDescription(getContext().getString(C0444R.string.wifi_dpp_scan_qr_code));
    ...
    public void updatePreferenceForRestriction() {
        if (!this.mIsAddWifiConfigAllow) {
            setEnabled(false);
            setSummary((int) C0444R.string.not_allowed_by_ent);
        }
    }
}
