...
public class WifiCallingSettings extends InstrumentedFragment implements HelpResourceProvider {
    ...
    public int getHelpResource() {
        return C0444R.string.help_uri_wifi_calling;
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(C0444R.C0450layout.wifi_calling_settings_tabs, viewGroup, false);
        this.mTabLayout = (SlidingTabLayout) inflate.findViewById(C0444R.C0448id.sliding_tabs);
        this.mViewPager = (RtlCompatibleViewPager) inflate.findViewById(C0444R.C0448id.view_pager);
    ...
    public void updateTitleForCurrentSub() {
        if (CollectionUtils.size(this.mSil) > 1) {
            getActivity().getActionBar().setTitle(SubscriptionManager.getResourcesForSubId(getContext(), this.mSil.get(this.mViewPager.getCurrentItem()).getSubscriptionId()).getString(C0444R.string.wifi_calling_settings_title));
        }
    }
