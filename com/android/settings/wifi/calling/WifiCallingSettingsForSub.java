...
public class WifiCallingSettingsForSub extends SettingsPreferenceFragment implements OnMainSwitchChangeListener, Preference.OnPreferenceChangeListener {
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        SettingsMainSwitchBar settingsMainSwitchBar = (SettingsMainSwitchBar) getView().findViewById(C0444R.C0448id.switch_bar);
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.wifi_calling_settings);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(C0444R.C0450layout.wifi_calling_settings_preferences, viewGroup, false);
    ...
    public void updateBody() {
        ...
        this.mButtonWfcMode.setTitle((CharSequence) resourcesForSubId.getString(C0444R.string.wifi_calling_mode_title));
        this.mButtonWfcMode.setDialogTitle(resourcesForSubId.getString(C0444R.string.wifi_calling_mode_dialog_title));
        this.mButtonWfcRoamingMode.setTitle((CharSequence) resourcesForSubId.getString(C0444R.string.wifi_calling_roaming_mode_title));
        this.mButtonWfcRoamingMode.setDialogTitle(resourcesForSubId.getString(C0444R.string.wifi_calling_roaming_mode_dialog_title));
        if (z) {
            this.mButtonWfcMode.setEntries((CharSequence[]) resourcesForSubId.getStringArray(C0444R.array.wifi_calling_mode_choices));
            this.mButtonWfcMode.setEntryValues(resourcesForSubId.getStringArray(C0444R.array.wifi_calling_mode_values));
            this.mButtonWfcMode.setEntrySummaries(resourcesForSubId.getStringArray(C0444R.array.wifi_calling_mode_summaries));
            this.mButtonWfcRoamingMode.setEntries((CharSequence[]) resourcesForSubId.getStringArray(C0444R.array.wifi_calling_mode_choices_v2));
            this.mButtonWfcRoamingMode.setEntryValues(resourcesForSubId.getStringArray(C0444R.array.wifi_calling_mode_values));
            this.mButtonWfcRoamingMode.setEntrySummaries(resourcesForSubId.getStringArray(C0444R.array.wifi_calling_mode_summaries));
        } else {
            this.mButtonWfcMode.setEntries((CharSequence[]) resourcesForSubId.getStringArray(C0444R.array.wifi_calling_mode_choices_without_wifi_only));
            this.mButtonWfcMode.setEntryValues(resourcesForSubId.getStringArray(C0444R.array.wifi_calling_mode_values_without_wifi_only));
            this.mButtonWfcMode.setEntrySummaries(resourcesForSubId.getStringArray(C0444R.array.wifi_calling_mode_summaries_without_wifi_only));
            this.mButtonWfcRoamingMode.setEntries((CharSequence[]) resourcesForSubId.getStringArray(C0444R.array.wifi_calling_mode_choices_v2_without_wifi_only));
            this.mButtonWfcRoamingMode.setEntryValues(resourcesForSubId.getStringArray(C0444R.array.wifi_calling_mode_values_without_wifi_only));
            this.mButtonWfcRoamingMode.setEntrySummaries(resourcesForSubId.getStringArray(C0444R.array.wifi_calling_mode_summaries_without_wifi_only));
        }
    ...
    public void onSwitchChanged(Switch switchR, boolean z) {
        ...
        new SubSettingLauncher(activity).setDestination(WifiCallingDisclaimerFragment.class.getName()).setArguments(bundle).setTitleRes(C0444R.string.wifi_calling_settings_title).setSourceMetricsCategory(getMetricsCategory()).setResultListener(this, 2).launch();
    }
    ...
    private void updateDescriptionForOptions(List<Preference> list) {
        ...
        if (linkifyDescriptionPreference != null) {
            ...
            if (!anyMatch) {
                Resources resourcesForSubId = getResourcesForSubId();
                linkifyDescriptionPreference.setSummary((CharSequence) resourcesForSubId.getString(C0444R.string.wifi_calling_off_explanation, new Object[]{resourcesForSubId.getString(C0444R.string.wifi_calling_off_explanation_2)}));
            }
