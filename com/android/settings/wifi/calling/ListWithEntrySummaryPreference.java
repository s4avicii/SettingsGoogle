...
public class ListWithEntrySummaryPreference extends CustomListPreference {
    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder, DialogInterface.OnClickListener onClickListener) {
        builder.setSingleChoiceItems((ListAdapter) new SelectorAdapter(this.mContext, C0444R.xml.single_choice_list_item_2, this), findIndexOfValue(getValue()), onClickListener);
    ...
    private static class SelectorAdapter extends ArrayAdapter<CharSequence> {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            View inflate = LayoutInflater.from(this.mContext).inflate(C0444R.xml.single_choice_list_item_2, viewGroup, false);
            ((TextView) inflate.findViewById(C0444R.C0448id.title)).setText(this.mSelector.getEntries()[i]);
            ((TextView) inflate.findViewById(C0444R.C0448id.summary)).setText(this.mSelector.getEntrySummary(i));
            RadioButton radioButton = (RadioButton) inflate.findViewById(C0444R.C0448id.radio);
