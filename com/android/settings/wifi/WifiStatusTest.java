...
public class WifiStatusTest extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C0444R.C0450layout.wifi_status_test);
        Button button = (Button) findViewById(C0444R.C0448id.update);
        this.updateButton = button;
        button.setOnClickListener(this.updateButtonHandler);
        this.mWifiState = (TextView) findViewById(C0444R.C0448id.wifi_state);
        this.mNetworkState = (TextView) findViewById(C0444R.C0448id.network_state);
        this.mSupplicantState = (TextView) findViewById(C0444R.C0448id.supplicant_state);
        this.mRSSI = (TextView) findViewById(C0444R.C0448id.rssi);
        this.mBSSID = (TextView) findViewById(C0444R.C0448id.bssid);
        this.mSSID = (TextView) findViewById(C0444R.C0448id.ssid);
        this.mHiddenSSID = (TextView) findViewById(C0444R.C0448id.hidden_ssid);
        this.mIPAddr = (TextView) findViewById(C0444R.C0448id.ipaddr);
        this.mMACAddr = (TextView) findViewById(C0444R.C0448id.macaddr);
        this.mNetworkId = (TextView) findViewById(C0444R.C0448id.networkid);
        this.mTxLinkSpeed = (TextView) findViewById(C0444R.C0448id.tx_link_speed);
        this.mRxLinkSpeed = (TextView) findViewById(C0444R.C0448id.rx_link_speed);
        this.mScanList = (TextView) findViewById(C0444R.C0448id.scan_list);
        this.mPingHostname = (TextView) findViewById(C0444R.C0448id.pingHostname);
        this.mHttpClientTest = (TextView) findViewById(C0444R.C0448id.httpClientTest);
        Button button2 = (Button) findViewById(C0444R.C0448id.ping_test);
    ...
    public void setWifiStateText(int i) {
        String str;
        if (i == 0) {
            str = getString(C0444R.string.wifi_state_disabling);
        } else if (i == 1) {
            str = getString(C0444R.string.wifi_state_disabled);
        } else if (i == 2) {
            str = getString(C0444R.string.wifi_state_enabling);
        } else if (i == 3) {
            str = getString(C0444R.string.wifi_state_enabled);
        } else if (i != 4) {
            Log.e("WifiStatusTest", "wifi state is bad");
            str = "BAD";
        } else {
            str = getString(C0444R.string.wifi_state_unknown);
        }
    ...
    public final void updatePingState() {
        ...
        this.mPingHostnameResult = getResources().getString(C0444R.string.radioInfo_unknown);
        this.mHttpClientTestResult = getResources().getString(C0444R.string.radioInfo_unknown);
        this.mPingHostname.setText(this.mPingHostnameResult);
        this.mHttpClientTest.setText(this.mHttpClientTestResult);
        final C13784 r1 = new Runnable() {
            public void run() {
