...
public class WifiDialog2 extends AlertDialog implements WifiConfigUiBase2, DialogInterface.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        setWindowsOverlay();
        View inflate = getLayoutInflater().inflate(C0444R.C0450layout.wifi_dialog, (ViewGroup) null);
        this.mView = inflate;
        setView(inflate);
    ...
    /* access modifiers changed from: protected */
    public void onStart() {
        ImageButton imageButton = (ImageButton) findViewById(C0444R.C0448id.ssid_scanner_button);
        if (this.mHideSubmitButton) {
    ...
    public /* synthetic */ void lambda$onStart$0(View view) {
        if (this.mListener != null) {
            this.mListener.onScan(this, ((TextView) findViewById(C0444R.C0448id.ssid)).getText().toString());
        }
    }
