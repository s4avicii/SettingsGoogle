...
public class WifiTetherMaximizeCompatibilityPreferenceController extends WifiTetherBasePreferenceController {
    ...
    public void updateDisplay() {
        ...
        if (preference != null) {
            ...
            this.mPreference.setSummary(this.mWifiManager.isBridgedApConcurrencySupported() ? C0444R.string.wifi_hotspot_maximize_compatibility_dual_ap_summary : C0444R.string.wifi_hotspot_maximize_compatibility_single_ap_summary);
        }
    }
