...
public class WifiTetherSettings extends RestrictedDashboardFragment implements WifiTetherBasePreferenceController.OnTetherConfigUpdateListener {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.wifi_tether_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.wifi_tether_settings;
    }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        if (!this.mUnavailable) {
            ...
            switchBar.setTitle(getContext().getString(C0444R.string.use_wifi_hotsopt_main_switch_title));
