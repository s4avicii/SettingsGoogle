...
public class WifiTetherApBandPreferenceController extends WifiTetherBasePreferenceController {
    ...
    public void updateDisplay() {
        ...
        if (!is5GhzBandSupported()) {
            ...
            listPreference.setSummary((int) C0444R.string.wifi_ap_choose_2G);
            return;
        }
    ...
    public String getConfigSummary() {
        ...
        if (i != 2) {
            return this.mContext.getString(C0444R.string.wifi_ap_prefer_5G);
        }
    ...
    public void updatePreferenceEntries() {
        ...
        this.mBandEntries = resources.getStringArray(C0444R.array.wifi_ap_band);
        this.mBandSummaries = resources.getStringArray(C0444R.array.wifi_ap_band_summary);
    }
