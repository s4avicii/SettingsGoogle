...
public class AddNetworkFragment extends InstrumentedFragment implements WifiConfigUiBase2, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(C0444R.C0450layout.wifi_add_network_view, viewGroup, false);
        ...
        ((ImageButton) inflate.findViewById(C0444R.C0448id.ssid_scanner_button)).setOnClickListener(this);
    ...
    public void onClick(View view) {
        if (view.getId() == SUBMIT_BUTTON_ID) {
            ...
            handleCancelAction();
        } else if (view.getId() == C0444R.C0448id.ssid_scanner_button) {
            startActivityForResult(WifiDppUtils.getEnrolleeQrCodeScannerIntent(view.getContext(), ((TextView) getView().findViewById(C0444R.C0448id.ssid)).getText().toString()), 0);
        }
    }
