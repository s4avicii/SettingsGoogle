...
public class NetworkRequestDialogActivity extends FragmentActivity implements WifiManager.NetworkRequestMatchCallback {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.mIsSpecifiedSsid) {
            showProgressDialog(getString(C0444R.string.network_connection_searching_message));
            return;
        }
    ...
    public void onUserSelectionConnectSuccess(WifiConfiguration wifiConfiguration) {
        if (!isFinishing()) {
            Toast.makeText(this, C0444R.string.network_connection_connect_successful, 0).show();
            setResult(-1);
            finish();
        }
    }
    ...
    public void onUserSelectionConnectFailure(WifiConfiguration wifiConfiguration) {
        if (!isFinishing()) {
            Toast.makeText(this, C0444R.string.network_connection_connect_failure, 0).show();
            setResult(-1);
            finish();
        }
    }
    ...
    public void onClickConnectButton() {
        ...
        if (networkRequestUserSelectionCallback != null) {
            ...
            showProgressDialog(getString(C0444R.string.network_connection_connecting_message));
        }
    }
