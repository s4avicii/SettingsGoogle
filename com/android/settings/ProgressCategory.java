...
public class ProgressCategory extends ProgressCategoryBase {
    ...
    public ProgressCategory(Context context) {
        super(context);
        setLayoutResource(C0444R.C0450layout.preference_progress_category);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        View findViewById = preferenceViewHolder.findViewById(C0444R.C0448id.scanning_progress);
        ...
        if (this.mProgress || !z) {
            ...
            if (this.mNoDeviceFoundPreference == null) {
                ...
                preference.setLayoutResource(C0444R.C0450layout.preference_empty_list);
