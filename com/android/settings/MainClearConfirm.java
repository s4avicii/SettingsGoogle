...
public class MainClearConfirm extends InstrumentedFragment {
    ...
    private View.OnClickListener mFinalClickListener = new View.OnClickListener() {
                ...
                if (MainClearConfirm.this.shouldWipePersistentDataBlock(persistentDataBlockManager)) {
                    new AsyncTask<Void, Void, Void>() {
                        ...
                        public void onPreExecute() {
                            ProgressDialog r0 = C05291.this.getProgressDialog();
        ...
        public ProgressDialog getProgressDialog() {
            ...
            progressDialog.setTitle(MainClearConfirm.this.getActivity().getString(C0444R.string.main_clear_progress_title));
            progressDialog.setMessage(MainClearConfirm.this.getActivity().getString(C0444R.string.main_clear_progress_text));
    ...
    private void establishFinalConfirmationState() {
        ((FooterBarMixin) ((GlifLayout) this.mContentView.findViewById(C0444R.C0448id.setup_wizard_layout)).getMixin(FooterBarMixin.class)).setPrimaryButton(new FooterButton.Builder(getActivity()).setText((int) C0444R.string.main_clear_button_text).setListener(this.mFinalClickListener).setButtonType(0).setTheme(C0444R.style.SudGlifButton_Primary).build());
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mContentView = layoutInflater.inflate(C0444R.C0450layout.main_clear_confirm, (ViewGroup) null);
    ...
    private void setAccessibilityTitle() {
        ...
        TextView textView = (TextView) this.mContentView.findViewById(C0444R.C0448id.sud_layout_description);
        if (textView != null) {
    ...
    public void setSubtitle() {
        if (this.mEraseEsims) {
            ((TextView) this.mContentView.findViewById(C0444R.C0448id.sud_layout_description)).setText(C0444R.string.main_clear_final_desc_esim);
        }
    }
