...
public class FaceEnrollEnrolling extends BiometricsEnrollEnrolling {
    ...
    public static class FaceErrorDialog extends BiometricErrorDialog {
        ...
        public int getOkButtonTextResId() {
            return C0444R.string.security_settings_face_enroll_dialog_ok;
        }

        public int getTitleResId() {
            return C0444R.string.security_settings_face_enroll_error_dialog_title;
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) C0444R.C0450layout.face_enroll_enrolling);
        setHeaderText((int) C0444R.string.security_settings_face_enroll_repeat_title);
        ...
        footerBarMixin.setSecondaryButton(new FooterButton.Builder(this).setText((int) C0444R.string.security_settings_face_enroll_enrolling_skip).setListener(new FaceEnrollEnrolling$$ExternalSyntheticLambda0(this)).setButtonType(7).setTheme(C0444R.style.SudGlifButton_Secondary).build());
    ...
    public void onEnrollmentError(int i, CharSequence charSequence) {
        int i2 = i != 3 ? C0444R.string.security_settings_face_enroll_error_generic_dialog_message : C0444R.string.security_settings_face_enroll_error_timeout_dialog_message;
