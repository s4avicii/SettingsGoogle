...
public class FaceSettingsRemoveButtonPreferenceController extends BasePreferenceController implements View.OnClickListener {
    ...
    public static class ConfirmRemoveDialog extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            builder.setTitle(C0444R.string.security_settings_face_settings_remove_dialog_title).setMessage(this.mIsConvenience ? C0444R.string.f73xb32344a7 : C0444R.string.security_settings_face_settings_remove_dialog_details).setPositiveButton(C0444R.string.delete, this.mOnClickListener).setNegativeButton(C0444R.string.cancel, this.mOnClickListener);
    ...
    public void updateState(Preference preference) {
        ...
        Button button = (Button) ((LayoutPreference) preference).findViewById(C0444R.C0448id.security_settings_face_settings_remove_button);
        this.mButton = button;
