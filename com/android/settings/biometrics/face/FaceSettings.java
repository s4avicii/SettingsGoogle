...
public class FaceSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.security_settings_face) {
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_face;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.security_settings_face;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.mUserManager.getUserInfo(this.mUserId).isManagedProfile()) {
            getActivity().setTitle(this.mDevicePolicyManager.getString("Settings.FACE_SETTINGS_FOR_WORK_TITLE", new FaceSettings$$ExternalSyntheticLambda3(this)));
        }
    ...
    public /* synthetic */ String lambda$onCreate$2() throws Exception {
        return getActivity().getResources().getString(C0444R.string.security_settings_face_profile_preference_title);
    }
    ...
    public void onResume() {
        ...
        if (bArr != null || this.mConfirmingPassword) {
            ...
            boolean show = new ChooseLockSettingsHelper.Builder(getActivity(), this).setRequestCode(4).setTitle(getString(C0444R.string.security_settings_face_preference_title)).setRequestGatekeeperPasswordHandle(true).setUserId(this.mUserId).setForegroundOnly(true).setReturnCredentials(true).show();
