...
public class FingerprintSettings extends SubSettings {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setTitle(getText(C0444R.string.security_settings_fingerprint_preference_title));
    }
    ...
    public static class FingerprintSettingsFragment extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, FingerprintPreference.OnDeleteClickListener {
        ...
        public int getHelpResource() {
            return C0444R.string.help_url_fingerprint;
        }
        ...
        public void onCreate(Bundle bundle) {
            ...
            AnnotationSpan.LinkInfo linkInfo = new AnnotationSpan.LinkInfo("admin_details", new C0763xd2803eab(activity, checkIfKeyguardFeaturesDisabled));
            ...
            if (checkIfKeyguardFeaturesDisabled != null) {
                this.mFooterTitle = AnnotationSpan.linkify(((DevicePolicyManager) getSystemService(DevicePolicyManager.class)).getString("Settings.FINGERPRINT_UNLOCK_DISABLED_EXPLANATION", new C0764xd2803eac(this)), linkInfo2, linkInfo);
                return;
            }
            this.mFooterTitle = AnnotationSpan.linkify(getText(C0444R.string.security_settings_fingerprint_v2_home_screen), linkInfo2, linkInfo);
        }

        /* access modifiers changed from: private */
        public /* synthetic */ String lambda$onCreate$1() throws Exception {
            return getString(C0444R.string.f74x60fec2a1);
        }
        ...
        private PreferenceScreen createPreferenceHierarchy() {
            ...
            addPreferencesFromResource(C0444R.xml.security_settings_fingerprint);
        ...
        private void addFingerprintItemPreferences(PreferenceGroup preferenceGroup) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                fingerprintPreference.setIcon((int) C0444R.C0447drawable.ic_fingerprint_24dp);
            ...
            preference.setTitle((int) C0444R.string.fingerprint_add_title);
            preference.setIcon((int) C0444R.C0447drawable.ic_add_24dp);
        ...
        public void updateAddPreference() {
            if (getActivity() != null) {
                ...
                findPreference.setSummary((CharSequence) z2 ? getContext().getString(C0444R.string.fingerprint_add_max, new Object[]{Integer.valueOf(integer)}) : "");
        ...
        private void showRenameDialog(Fingerprint fingerprint) {
            ...
            renameDialog.setOnDismissListener(new C0761xd2803ea9(this));
            renameDialog.setDeleteInProgress(this.mRemovalSidecar.inProgress());
        ...
        public void onActivityResult(int i, int i2, Intent intent) {
            ...
            if (i == 101 || i == 102) {
                ...
                if (i2 != 1 && i2 != -1) {
                    ...
                    this.mFingerprintManager.generateChallenge(this.mUserId, new C0762xd2803eaa(this, intent));
                }
            } else if (i == 10) {
        ...
        private Drawable getHighlightDrawable() {
            ...
            if (this.mHighlightDrawable == null && (activity = getActivity()) != null) {
                this.mHighlightDrawable = activity.getDrawable(C0444R.C0447drawable.preference_highlight);
            }
        ...
        private void launchChooseOrConfirmLock() {
            Intent intent = new Intent();
            if (!new ChooseLockSettingsHelper.Builder(getActivity(), this).setRequestCode(101).setTitle(getString(C0444R.string.security_settings_fingerprint_preference_title)).setRequestGatekeeperPasswordHandle(true).setUserId(this.mUserId).setForegroundOnly(true).setReturnCredentials(true).show()) {
        ...
        public static class DeleteFingerprintDialog extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
            ...
            public Dialog onCreateDialog(Bundle bundle) {
                ...
                this.mFp = parcelable;
                AlertDialog create = new AlertDialog.Builder(getActivity()).setTitle((CharSequence) getString(C0444R.string.fingerprint_delete_title, parcelable.getName())).setMessage((int) C0444R.string.fingerprint_delete_message).setPositiveButton((int) C0444R.string.security_settings_fingerprint_enroll_dialog_delete, (DialogInterface.OnClickListener) this).setNegativeButton((int) C0444R.string.cancel, (DialogInterface.OnClickListener) null).create();
        ...
        public static class RenameDialog extends InstrumentedDialogFragment {
            ...
            public Dialog onCreateDialog(Bundle bundle) {
                ...
                AlertDialog create = new AlertDialog.Builder(getActivity()).setView((int) C0444R.C0450layout.fingerprint_rename_dialog).setPositiveButton((int) C0444R.string.security_settings_fingerprint_enroll_dialog_ok, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogInterface, int i) {
                ...
                create.setOnShowListener(new DialogInterface.OnShowListener() {
                    public void onShow(DialogInterface dialogInterface) {
                        ...
                        renameDialog.mDialogTextField = renameDialog.mAlertDialog.findViewById(C0444R.C0448id.fingerprint_rename_field);
        ...
        public static class ConfirmLastDeleteDialog extends InstrumentedDialogFragment {
            ...
            public Dialog onCreateDialog(Bundle bundle) {
                ...
                return new AlertDialog.Builder(getActivity()).setTitle((int) C0444R.string.fingerprint_last_delete_title).setMessage((CharSequence) ((DevicePolicyManager) getContext().getSystemService(DevicePolicyManager.class)).getString(z ? "Settings.WORK_PROFILE_FINGERPRINT_LAST_DELETE_MESSAGE" : "UNDEFINED", new C0765xd6c4af0e(this, z ? C0444R.string.fingerprint_last_delete_message_profile_challenge : C0444R.string.fingerprint_last_delete_message))).setPositiveButton((int) C0444R.string.fingerprint_last_delete_confirm, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogInterface, int i) {
                ...
                }).setNegativeButton((int) C0444R.string.cancel, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
                    }
                }).create();
    ...
    public static class FingerprintPreference extends TwoTargetPreference {
        ...
        public int getSecondTargetResId() {
            return C0444R.C0450layout.preference_widget_delete;
        }
        ...
        public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
            ...
            this.mView = view;
            View findViewById = view.findViewById(C0444R.C0448id.delete_button);
