...
public class FingerprintEnrollFinish extends BiometricEnrollBase {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) C0444R.C0450layout.fingerprint_enroll_finish);
        setHeaderText((int) C0444R.string.security_settings_fingerprint_enroll_finish_title);
        setDescriptionText((int) C0444R.string.security_settings_fingerprint_enroll_finish_message);
        FooterBarMixin footerBarMixin = (FooterBarMixin) getLayout().getMixin(FooterBarMixin.class);
        this.mFooterBarMixin = footerBarMixin;
        footerBarMixin.setSecondaryButton(new FooterButton.Builder(this).setText((int) C0444R.string.fingerprint_enroll_button_add).setButtonType(7).setTheme(C0444R.style.SudGlifButton_Secondary).build());
        this.mFooterBarMixin.setPrimaryButton(new FooterButton.Builder(this).setText((int) C0444R.string.security_settings_fingerprint_enroll_done).setListener(new FingerprintEnrollFinish$$ExternalSyntheticLambda0(this)).setButtonType(5).setTheme(C0444R.style.SudGlifButton_Primary).build());
    }
    ...
    private void launchFingerprintSettings() {
        ...
        overridePendingTransition(C0444R.C0445anim.sud_slide_back_in, C0444R.C0445anim.sud_slide_back_out);
    }
