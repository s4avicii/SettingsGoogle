...
public final /* synthetic */ class C0762xd2803eaa implements FingerprintManager.GenerateChallengeCallback {
    public final /* synthetic */ FingerprintSettings.FingerprintSettingsFragment f$0;
    public final /* synthetic */ Intent f$1;

    public /* synthetic */ C0762xd2803eaa(FingerprintSettings.FingerprintSettingsFragment fingerprintSettingsFragment, Intent intent) {
        this.f$0 = fingerprintSettingsFragment;
        this.f$1 = intent;
    }

    public final void onChallengeGenerated(int i, int i2, long j) {
        this.f$0.lambda$onActivityResult$3(this.f$1, i, i2, j);
    }
}
