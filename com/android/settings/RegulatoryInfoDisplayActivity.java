...
public class RegulatoryInfoDisplayActivity extends Activity implements DialogInterface.OnDismissListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AlertDialog.Builder positiveButton = new AlertDialog.Builder(this).setTitle((int) C0444R.string.regulatory_labels).setOnDismissListener(this).setPositiveButton(17039370, (DialogInterface.OnClickListener) null);
        ...
        CharSequence text = getResources().getText(C0444R.string.regulatory_info_text);
        if (z2) {
            View inflate = getLayoutInflater().inflate(C0444R.C0450layout.regulatory_info, (ViewGroup) null);
            ImageView imageView = (ImageView) inflate.findViewById(C0444R.C0448id.regulatoryInfo);
            if (decodeFile != null) {
