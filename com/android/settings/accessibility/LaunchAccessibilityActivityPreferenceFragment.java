...
public class LaunchAccessibilityActivityPreferenceFragment extends ToggleFeaturePreferenceFragment {
    ...
    private void initLaunchPreference() {
        ...
        preference.setLayoutResource(C0444R.C0450layout.accessibility_launch_activity_preference);
        ...
        if (accessibilityShortcutInfo == null) {
            ...
            str = getString(C0444R.string.accessibility_service_primary_open_title, accessibilityShortcutInfo.getActivityInfo().loadLabel(getPackageManager()));
        }
        preference.setTitle((CharSequence) str);
        preference.setOnPreferenceClickListener(new C0594xd3ae02e4(this));
