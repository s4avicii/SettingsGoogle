...
public class BalanceSeekBar extends SeekBar {
    ...
    public BalanceSeekBar(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        C05871 r6 = new SeekBar.OnSeekBarChangeListener() {
        ...
        this.mCenterMarkerRect = new Rect(0, 0, resources.getDimensionPixelSize(C0444R.dimen.balance_seekbar_center_marker_width), resources.getDimensionPixelSize(C0444R.dimen.balance_seekbar_center_marker_height));
