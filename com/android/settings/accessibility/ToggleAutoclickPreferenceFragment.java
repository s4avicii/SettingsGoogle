...
public class ToggleAutoclickPreferenceFragment extends DashboardFragment implements ToggleAutoclickPreferenceController.OnChangeListener {
    private static final int[] AUTOCLICK_PREFERENCE_SUMMARIES = {C0444R.plurals.accessibilty_autoclick_preference_subtitle_short_delay, C0444R.plurals.accessibilty_autoclick_preference_subtitle_medium_delay, C0444R.plurals.accessibilty_autoclick_preference_subtitle_long_delay};
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.accessibility_autoclick_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.accessibility_autoclick_settings;
    }
    ...
    public static List<AbstractPreferenceController> buildPreferenceControllers(Context context, Lifecycle lifecycle) {
        for (String toggleAutoclickPreferenceController : context.getResources().getStringArray(C0444R.array.accessibility_autoclick_control_selector_keys)) {
