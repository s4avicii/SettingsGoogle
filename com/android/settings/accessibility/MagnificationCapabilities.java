...
public final class MagnificationCapabilities {
    public static String getSummary(Context context, int i) {
        String[] stringArray = context.getResources().getStringArray(C0444R.array.magnification_mode_summaries);
        int indexOf = Ints.indexOf(context.getResources().getIntArray(C0444R.array.magnification_mode_values), i);
        if (indexOf == -1) {
            indexOf = 0;
        }
