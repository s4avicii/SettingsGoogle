...
public class ShortcutPreference extends Preference {
    ...
    ShortcutPreference(Context context, AttributeSet attributeSet) {
        ...
        setLayoutResource(C0444R.C0450layout.accessibility_shortcut_secondary_action);
        setWidgetLayoutResource(C0444R.C0450layout.preference_widget_primary_switch);
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        LinearLayout linearLayout = (LinearLayout) preferenceViewHolder.itemView.findViewById(C0444R.C0448id.main_frame);
        int i = 0;
        ...
        Switch switchR = (Switch) preferenceViewHolder.itemView.findViewById(C0444R.C0448id.switchWidget);
        if (switchR != null) {
            switchR.setOnTouchListener(ShortcutPreference$$ExternalSyntheticLambda3.INSTANCE);
            switchR.setContentDescription(getContext().getText(C0444R.string.accessibility_shortcut_settings));
        ...
        View findViewById = preferenceViewHolder.itemView.findViewById(C0444R.C0448id.divider);
