...
public class RTTSettingPreferenceController extends BasePreferenceController {
    ...
    public RTTSettingPreferenceController(Context context, String str) {
        ...
        this.mModes = context.getResources().getTextArray(C0444R.array.rtt_setting_mode);
        this.mDialerPackage = context.getString(C0444R.string.config_rtt_setting_package_name);
        this.mPackageManager = context.getPackageManager();
        this.mCarrierConfigManager = (CarrierConfigManager) context.getSystemService(CarrierConfigManager.class);
        this.mRTTIntent = new Intent(context.getString(C0444R.string.config_rtt_setting_intent_action));
    ...
    private static boolean isDefaultDialerSupportedRTT(Context context) {
        return TextUtils.equals(context.getString(C0444R.string.config_rtt_setting_package_name), TelecomUtil.getTelecomManager(context).getDefaultDialerPackage());
    }
}
