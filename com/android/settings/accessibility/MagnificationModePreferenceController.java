...
public class MagnificationModePreferenceController extends BasePreferenceController implements DialogCreatable, LifecycleObserver, OnCreate, OnResume, OnSaveInstanceState {
    ...
    private void initModeInfos() {
        this.mModeInfos.add(new MagnificationModeInfo(this.mContext.getText(C0444R.string.accessibility_magnification_mode_dialog_option_full_screen), (CharSequence) null, C0444R.C0447drawable.ic_illustration_fullscreen, 1));
        this.mModeInfos.add(new MagnificationModeInfo(this.mContext.getText(C0444R.string.accessibility_magnification_mode_dialog_option_window), (CharSequence) null, C0444R.C0447drawable.ic_illustration_window, 2));
        this.mModeInfos.add(new MagnificationModeInfo(this.mContext.getText(C0444R.string.accessibility_magnification_mode_dialog_option_switch), this.mContext.getText(C0444R.string.accessibility_magnification_area_settings_mode_switch_summary), C0444R.C0447drawable.ic_illustration_switch, 3));
    }
    ...
    private Dialog createMagnificationModeDialog() {
        ...
        this.mMagnificationModesListView.addHeaderView(LayoutInflater.from(this.mContext).inflate(C0444R.C0450layout.accessibility_magnification_mode_header, this.mMagnificationModesListView, false), (Object) null, false);
        this.mMagnificationModesListView.setItemChecked(computeSelectionIndex(), true);
        return AccessibilityDialogUtils.createCustomDialog(this.mContext, this.mContext.getString(C0444R.string.accessibility_magnification_mode_dialog_title), this.mMagnificationModesListView, new MagnificationModePreferenceController$$ExternalSyntheticLambda0(this));
    }
