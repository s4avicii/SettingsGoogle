...
public class AccessibilityDetailsSettingsFragment extends InstrumentedFragment {
    ...
    public boolean isServiceAllowed(int i, String str) {
        ...
        try {
            ...
            if (noteOpNoThrow == 2 || noteOpNoThrow == 1) {
                return false;
            }
            return true;
    ...
    private Bundle buildArguments(AccessibilityServiceInfo accessibilityServiceInfo) {
        ...
        if (contains && accessibilityServiceInfo.crashed) {
            loadDescription = getString(C0444R.string.accessibility_description_state_stopped);
        }
        Bundle bundle = new Bundle();
        ...
        if (!TextUtils.isEmpty(settingsActivityName)) {
            bundle.putString("settings_title", getString(C0444R.string.accessibility_menu_item_settings));
