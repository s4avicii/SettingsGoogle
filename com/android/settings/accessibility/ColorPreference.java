...
public class ColorPreference extends ListDialogPreference {
    ...
    public ColorPreference(Context context, AttributeSet attributeSet) {
        ...
        setListItemLayoutResource(C0444R.C0450layout.color_picker_item);
    }
    ...
    public CharSequence getTitleAt(int i) {
        ...
        return getContext().getString(C0444R.string.color_custom, new Object[]{Integer.valueOf(red), Integer.valueOf(green), Integer.valueOf(blue)});
    }

    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        super.onBindViewHolder(preferenceViewHolder);
        if (this.mPreviewEnabled) {
            ImageView imageView = (ImageView) preferenceViewHolder.findViewById(C0444R.C0448id.color_preview);
            int value = getValue();
            if (Color.alpha(value) < 255) {
                imageView.setBackgroundResource(C0444R.C0447drawable.transparency_tileable);
            } else {
    ...
    public void onBindListItem(View view, int i) {
        ...
        ImageView imageView = (ImageView) view.findViewById(C0444R.C0448id.color_swatch);
        if (alpha < 255) {
            imageView.setBackgroundResource(C0444R.C0447drawable.transparency_tileable);
        } else {
            imageView.setBackground((Drawable) null);
