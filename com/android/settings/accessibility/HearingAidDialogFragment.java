...
public class HearingAidDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        return new AlertDialog.Builder(getActivity()).setMessage((int) C0444R.string.accessibility_hearingaid_pair_instructions_message).setPositiveButton((int) C0444R.string.accessibility_hearingaid_instruction_continue_button, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
