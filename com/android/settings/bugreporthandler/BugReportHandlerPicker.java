...
public class BugReportHandlerPicker extends DefaultAppPickerFragment {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.bug_report_handler_settings;
    }
    ...
    public void addStaticPreferences(PreferenceScreen preferenceScreen) {
        if (this.mFooter == null) {
            ...
            footerPreference.setIcon((int) C0444R.C0447drawable.ic_info_outline_24dp);
            this.mFooter.setSingleLineTitle(false);
            this.mFooter.setTitle((int) C0444R.string.bug_report_handler_picker_footer_text);
    ...
    private String getDescription(String str, int i) {
        ...
        if ("com.android.shell".equals(str)) {
            return context.getString(C0444R.string.system_default_app_subtext);
        }
        ...
        if (userInfo == null || !userInfo.isManagedProfile()) {
            return devicePolicyManager.getString("Settings.PERSONAL_PROFILE_APP_SUBTEXT", new BugReportHandlerPicker$$ExternalSyntheticLambda0(context));
        }
        return devicePolicyManager.getString("Settings.WORK_PROFILE_APP_SUBTEXT", new BugReportHandlerPicker$$ExternalSyntheticLambda1(context));
    }
