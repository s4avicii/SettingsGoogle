...
public final class EnableContentCaptureWithServiceSettingsPreferenceController extends TogglePreferenceController {
    ...
    public int getSliceHighlightMenuRes() {
        return C0444R.string.menu_key_privacy;
    }
    ...
    public void updateState(Preference preference) {
        ...
        preference.setOnPreferenceClickListener(new C1237xa5b4eea8(this));
    }
    ...
    private static final class ProfileSelectDialog {
        public static void show(Context context, Preference preference) {
            ...
            builder.setTitle((int) C0444R.string.choose_profile).setAdapter(UserAdapter.createUserAdapter(userManager, context, arrayList), new C1238xde084dd1(arrayList, preference, context)).show();
        }
    }
}
