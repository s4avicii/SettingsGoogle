...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        public int getHelpResource() {
            return C0444R.string.help_url_choose_lockscreen;
        }
        ...
        public void onCreate(Bundle bundle) {
            ...
            if (WizardManagerHelper.isDeviceProvisioned(activity) || canRunBeforeDeviceProvisioned()) {
                ...
                if (this.mPasswordConfirmed) {
                    ...
                    builder.setRequestCode(100).setTitle(getString(C0444R.string.unlock_set_unlock_launch_picker_title)).setReturnCredentials(true).setUserId(this.mUserId);
            ...
            if (lockPatternUtils != null) {
                if (this.mIsManagedProfile) {
                    if (lockPatternUtils.isSeparateProfileChallengeEnabled(this.mUserId)) {
                        getActivity().setTitle(C0444R.string.lock_settings_picker_update_profile_lock_title);
                    } else {
                        getActivity().setTitle(C0444R.string.lock_settings_picker_new_profile_lock_title);
                    }
                } else if (lockPatternUtils.isSecure(this.mUserId)) {
                    getActivity().setTitle(C0444R.string.lock_settings_picker_update_lock_title);
                } else {
                    getActivity().setTitle(C0444R.string.lock_settings_picker_new_lock_title);
                }
            }
        }
        ...
        public void addHeaderView() {
            setHeaderView((int) C0444R.C0450layout.choose_lock_generic_biometric_header);
            TextView textView = (TextView) getHeaderView().findViewById(C0444R.C0448id.biometric_header_description);
            if (this.mForFingerprint) {
                if (this.mIsSetNewPassword) {
                    textView.setText(C0444R.string.fingerprint_unlock_title);
                } else {
                    textView.setText(C0444R.string.lock_settings_picker_biometric_message);
                }
            } else if (this.mForFace) {
                if (this.mIsSetNewPassword) {
                    textView.setText(C0444R.string.face_unlock_title);
                } else {
                    textView.setText(C0444R.string.lock_settings_picker_biometric_message);
                }
            } else if (this.mForBiometrics) {
                if (this.mIsSetNewPassword) {
                    textView.setText(C0444R.string.biometrics_unlock_title);
                } else {
                    textView.setText(C0444R.string.lock_settings_picker_biometric_message);
                }
            } else if (this.mIsManagedProfile) {
                textView.setText(this.mDpm.getString("Settings.WORK_PROFILE_SCREEN_LOCK_SETUP_MESSAGE", new C1181x320961c6(this)));
            } else {
                ...
                if (!this.mController.isScreenLockRestrictedByAdmin() || managedProfileId == -10000) {
                    ...
                    LinkifyUtils.linkify(textView, new StringBuilder(this.mDpm.getString("Settings.WORK_PROFILE_IT_ADMIN_CANT_RESET_SCREEN_LOCK", new C1182x320961c7(this))), new C1180x320961c5(this, managedProfileId));
                }
            }
        }
        ...
        public /* synthetic */ String lambda$addHeaderView$0() throws Exception {
            return getString(C0444R.string.lock_settings_picker_profile_message);
        }

        /* access modifiers changed from: private */
        public /* synthetic */ String lambda$addHeaderView$1() throws Exception {
            return getString(C0444R.string.lock_settings_picker_admin_restricted_personal_message);
        }
        ...
        public void addPreferences() {
            addPreferencesFromResource(C0444R.xml.security_settings_picker);
            ...
            findPreference(ScreenLockType.NONE.preferenceKey).setViewId(C0444R.C0448id.lock_none);
            findPreference("unlock_skip_fingerprint").setViewId(C0444R.C0448id.lock_none);
            findPreference("unlock_skip_face").setViewId(C0444R.C0448id.lock_none);
            findPreference("unlock_skip_biometrics").setViewId(C0444R.C0448id.lock_none);
            findPreference(ScreenLockType.PIN.preferenceKey).setViewId(C0444R.C0448id.lock_pin);
            findPreference(ScreenLockType.PASSWORD.preferenceKey).setViewId(C0444R.C0448id.lock_password);
        }

        private String getFooterString() {
            int aggregatedPasswordComplexity = this.mController.getAggregatedPasswordComplexity();
            return getResources().getString(aggregatedPasswordComplexity != 65536 ? aggregatedPasswordComplexity != 196608 ? aggregatedPasswordComplexity != 327680 ? C0444R.string.unlock_footer_none_complexity_requested : C0444R.string.unlock_footer_high_complexity_requested : C0444R.string.unlock_footer_medium_complexity_requested : C0444R.string.unlock_footer_low_complexity_requested, new Object[]{this.mCallerAppName});
        }

        private void updatePreferenceText() {
            if (this.mForFingerprint) {
                setPreferenceTitle(ScreenLockType.PATTERN, (int) C0444R.string.fingerprint_unlock_set_unlock_pattern);
                setPreferenceTitle(ScreenLockType.PIN, (int) C0444R.string.fingerprint_unlock_set_unlock_pin);
                setPreferenceTitle(ScreenLockType.PASSWORD, (int) C0444R.string.fingerprint_unlock_set_unlock_password);
            } else if (this.mForFace) {
                setPreferenceTitle(ScreenLockType.PATTERN, (int) C0444R.string.face_unlock_set_unlock_pattern);
                setPreferenceTitle(ScreenLockType.PIN, (int) C0444R.string.face_unlock_set_unlock_pin);
                setPreferenceTitle(ScreenLockType.PASSWORD, (int) C0444R.string.face_unlock_set_unlock_password);
            } else if (this.mForBiometrics) {
                setPreferenceTitle(ScreenLockType.PATTERN, (int) C0444R.string.biometrics_unlock_set_unlock_pattern);
                setPreferenceTitle(ScreenLockType.PIN, (int) C0444R.string.biometrics_unlock_set_unlock_pin);
                setPreferenceTitle(ScreenLockType.PASSWORD, (int) C0444R.string.biometrics_unlock_set_unlock_password);
            }
        ...
        private void updateCurrentPreference() {
            ...
            if (findPreference != null) {
                findPreference.setSummary((int) C0444R.string.current_screen_lock);
            }
        }
        ...
        private int getResIdForFactoryResetProtectionWarningTitle() {
            return this.mIsManagedProfile ? C0444R.string.unlock_disable_frp_warning_title_profile : C0444R.string.unlock_disable_frp_warning_title;
        }
            ...
            if (keyguardStoredPasswordQuality != 65536) {
                if (keyguardStoredPasswordQuality == 131072 || keyguardStoredPasswordQuality == 196608) {
                    if (hasEnrolledFingerprints && z) {
                        return C0444R.string.unlock_disable_frp_warning_content_pin_face_fingerprint;
                    }
                    if (hasEnrolledFingerprints) {
                        return C0444R.string.unlock_disable_frp_warning_content_pin_fingerprint;
                    }
                    return z ? C0444R.string.unlock_disable_frp_warning_content_pin_face : C0444R.string.unlock_disable_frp_warning_content_pin;
                    ...
                    if (hasEnrolledFingerprints && z) {
                        return C0444R.string.unlock_disable_frp_warning_content_password_face_fingerprint;
                    }
                    if (hasEnrolledFingerprints) {
                        return C0444R.string.unlock_disable_frp_warning_content_password_fingerprint;
                    }
                    return z ? C0444R.string.unlock_disable_frp_warning_content_password_face : C0444R.string.unlock_disable_frp_warning_content_password;
                } else if (hasEnrolledFingerprints && z) {
                    return C0444R.string.unlock_disable_frp_warning_content_unknown_face_fingerprint;
                } else {
                    if (hasEnrolledFingerprints) {
                        return C0444R.string.unlock_disable_frp_warning_content_unknown_fingerprint;
                    }
                    return z ? C0444R.string.unlock_disable_frp_warning_content_unknown_face : C0444R.string.unlock_disable_frp_warning_content_unknown;
                }
            } else if (hasEnrolledFingerprints && z) {
                return C0444R.string.unlock_disable_frp_warning_content_pattern_face_fingerprint;
            } else {
                if (hasEnrolledFingerprints) {
                    return C0444R.string.unlock_disable_frp_warning_content_pattern_fingerprint;
                }
                return z ? C0444R.string.unlock_disable_frp_warning_content_pattern_face : C0444R.string.unlock_disable_frp_warning_content_pattern;
            }
        }
        ...
        public boolean setUnlockMethod(String str) {
            ...
            if (fromKey != null) {
                switch (C11791.$SwitchMap$com$android$settings$password$ScreenLockType[fromKey.ordinal()]) {
                    case 1:
                    case 2:
        ...
        public static class FactoryResetProtectionWarningDialog extends InstrumentedDialogFragment {
            ...
            public Dialog onCreateDialog(Bundle bundle) {
                Bundle arguments = getArguments();
                return new AlertDialog.Builder(getActivity()).setTitle(arguments.getInt("titleRes")).setMessage(arguments.getInt("messageRes")).setPositiveButton((int) C0444R.string.unlock_disable_frp_warning_ok, (DialogInterface.OnClickListener) new C1184x10535b08(this, arguments)).setNegativeButton((int) C0444R.string.cancel, (DialogInterface.OnClickListener) new C1183x10535b07(this)).create();
            }
    ...
    static /* synthetic */ class C11791 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settings.password.ChooseLockGeneric.C11791.<clinit>():void");
        }
    }
}
