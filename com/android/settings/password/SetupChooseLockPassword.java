...
public class SetupChooseLockPassword extends ChooseLockPassword {
    ...
    public static class SetupChooseLockPasswordFragment extends ChooseLockPassword.ChooseLockPasswordFragment implements ChooseLockTypeDialogFragment.OnLockTypeSelectedListener {
        ...
        public void onViewCreated(View view, Bundle bundle) {
            ...
            if (booleanExtra && z) {
                Button button = (Button) view.findViewById(C0444R.C0448id.screen_lock_options);
        ...
        public void updateUi() {
            ...
            if (stage == stage2) {
                ...
                this.mSkipOrClearButton.setText(getActivity(), C0444R.string.lockpassword_clear_label);
