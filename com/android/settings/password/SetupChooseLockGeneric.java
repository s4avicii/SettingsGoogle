...
public class SetupChooseLockGeneric extends ChooseLockGeneric {
    ...
    public static class SetupChooseLockGenericFragment extends ChooseLockGeneric.ChooseLockGenericFragment {
        ...
        public void onViewCreated(View view, Bundle bundle) {
            ...
            glifPreferenceLayout.setDividerInset(getContext().getResources().getDimensionPixelSize(C0444R.dimen.sud_items_glif_text_divider_inset));
            glifPreferenceLayout.setIcon(getContext().getDrawable(C0444R.C0447drawable.ic_lock));
            int i = isForBiometric() ? C0444R.string.lock_settings_picker_title : C0444R.string.setup_lock_settings_picker_title;
            if (getActivity() != null) {
        ...
        public void addHeaderView() {
            if (isForBiometric()) {
                setHeaderView((int) C0444R.C0450layout.setup_choose_lock_generic_biometrics_header);
            } else {
                setHeaderView((int) C0444R.C0450layout.setup_choose_lock_generic_header);
            }
        }
        ...
        public void addPreferences() {
            if (isForBiometric()) {
                ...
                addPreferencesFromResource(C0444R.xml.setup_security_settings_picker);
            }
        }
