...
public class SetupChooseLockPattern extends ChooseLockPattern {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setTitle((int) C0444R.string.lockpassword_choose_your_pattern_header);
    }
    ...
    public static class SetupChooseLockPatternFragment extends ChooseLockPattern.ChooseLockPatternFragment implements ChooseLockTypeDialogFragment.OnLockTypeSelectedListener {
        ...
        public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            ...
            if (!getResources().getBoolean(C0444R.bool.config_lock_pattern_minimal_ui)) {
                Button button = (Button) onCreateView.findViewById(C0444R.C0448id.screen_lock_options);
        ...
        public void updateStage(ChooseLockPattern.ChooseLockPatternFragment.Stage stage) {
            ...
            if (!getResources().getBoolean(C0444R.bool.config_lock_pattern_minimal_ui) && (button = this.mOptionsButton) != null) {
            ...
            if (stage.leftMode == ChooseLockPattern.ChooseLockPatternFragment.LeftButtonMode.Gone && stage == ChooseLockPattern.ChooseLockPatternFragment.Stage.Introduction) {
                ...
                this.mSkipOrClearButton.setText(getActivity(), C0444R.string.skip_label);
                this.mLeftButtonIsSkip = true;
            } else {
                this.mLeftButtonIsSkip = false;
            }
            ((GlifLayout) getActivity().findViewById(C0444R.C0448id.setup_wizard_layout)).setDescriptionText((CharSequence) "");
        }
