...
public class ChooseLockPassword extends SettingsActivity {
    ...
    public static class ChooseLockPasswordFragment extends InstrumentedFragment implements TextView.OnEditorActionListener, TextWatcher, SaveChosenLockWorkerBase.Listener {
        ...
        protected enum Stage {
            Introduction(C0444R.string.lockpassword_choose_your_password_header, "Settings.SET_WORK_PROFILE_PASSWORD_HEADER", C0444R.string.lockpassword_choose_your_profile_password_header, C0444R.string.lockpassword_choose_your_password_header_for_fingerprint, C0444R.string.lockpassword_choose_your_password_header_for_face, C0444R.string.lockpassword_choose_your_password_header_for_biometrics, C0444R.string.lockpassword_choose_your_pin_header, "Settings.SET_WORK_PROFILE_PIN_HEADER", C0444R.string.lockpassword_choose_your_profile_pin_header, C0444R.string.lockpassword_choose_your_pin_header_for_fingerprint, C0444R.string.lockpassword_choose_your_pin_header_for_face, C0444R.string.lockpassword_choose_your_pin_header_for_biometrics, C0444R.string.lock_settings_picker_biometrics_added_security_message, C0444R.string.lock_settings_picker_biometrics_added_security_message, C0444R.string.next_label),
            NeedToConfirm(C0444R.string.lockpassword_confirm_your_password_header, "Settings.REENTER_WORK_PROFILE_PASSWORD_HEADER", C0444R.string.lockpassword_reenter_your_profile_password_header, C0444R.string.lockpassword_confirm_your_password_header, C0444R.string.lockpassword_confirm_your_password_header, C0444R.string.lockpassword_confirm_your_password_header, C0444R.string.lockpassword_confirm_your_pin_header, "Settings.REENTER_WORK_PROFILE_PIN_HEADER", C0444R.string.lockpassword_reenter_your_profile_pin_header, C0444R.string.lockpassword_confirm_your_pin_header, C0444R.string.lockpassword_confirm_your_pin_header, C0444R.string.lockpassword_confirm_your_pin_header, 0, 0, C0444R.string.lockpassword_confirm_label),
            ConfirmWrong(C0444R.string.lockpassword_confirm_passwords_dont_match, "UNDEFINED", C0444R.string.lockpassword_confirm_passwords_dont_match, C0444R.string.lockpassword_confirm_passwords_dont_match, C0444R.string.lockpassword_confirm_passwords_dont_match, C0444R.string.lockpassword_confirm_passwords_dont_match, C0444R.string.lockpassword_confirm_pins_dont_match, "UNDEFINED", C0444R.string.lockpassword_confirm_pins_dont_match, C0444R.string.lockpassword_confirm_pins_dont_match, C0444R.string.lockpassword_confirm_pins_dont_match, C0444R.string.lockpassword_confirm_pins_dont_match, 0, 0, C0444R.string.lockpassword_confirm_label);
            ...
            public String getHint(Context context, boolean z, int i, boolean z2) {
                if (z) {
                    ...
                    if (z2) {
                        return ((DevicePolicyManager) context.getSystemService(DevicePolicyManager.class)).getString(this.alphaHintOverrideForProfile, new C1191x36b0f3fe(this, context));
                    }
                    ...
                    if (z2) {
                        return ((DevicePolicyManager) context.getSystemService(DevicePolicyManager.class)).getString(this.numericHintOverrideForProfile, new C1190x36b0f3fd(this, context));
                    }
        ...
        public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            return layoutInflater.inflate(C0444R.C0450layout.choose_lock_password, viewGroup, false);
        }

        public void onViewCreated(View view, Bundle bundle) {
            super.onViewCreated(view, bundle);
            this.mLayout = (GlifLayout) view;
            ((ViewGroup) view.findViewById(C0444R.C0448id.password_container)).setOpticalInsets(Insets.NONE);
            FooterBarMixin footerBarMixin = (FooterBarMixin) this.mLayout.getMixin(FooterBarMixin.class);
            footerBarMixin.setSecondaryButton(new FooterButton.Builder(getActivity()).setText((int) C0444R.string.lockpassword_clear_label).setListener(new C1187xcfed0644(this)).setButtonType(7).setTheme(C0444R.style.SudGlifButton_Secondary).build());
            footerBarMixin.setPrimaryButton(new FooterButton.Builder(getActivity()).setText((int) C0444R.string.next_label).setListener(new C1186xcfed0643(this)).setButtonType(5).setTheme(C0444R.style.SudGlifButton_Primary).build());
            this.mSkipOrClearButton = footerBarMixin.getSecondaryButton();
            this.mNextButton = footerBarMixin.getPrimaryButton();
            this.mMessage = (TextView) view.findViewById(C0444R.C0448id.sud_layout_description);
            this.mLayout.setIcon(getActivity().getDrawable(C0444R.C0447drawable.ic_lock));
            ...
            ImeAwareEditText findViewById = view.findViewById(C0444R.C0448id.password_entry);
            ...
            if (this.mIsAlphaMode) {
                this.mPasswordEntry.setContentDescription(getString(C0444R.string.unlock_set_unlock_password_title));
            } else {
                this.mPasswordEntry.setContentDescription(getString(C0444R.string.unlock_set_unlock_pin_title));
            }
            ...
            if (bundle == null) {
                ...
                if (booleanExtra) {
                    new ChooseLockSettingsHelper.Builder(getActivity()).setRequestCode(58).setTitle(getString(C0444R.string.unlock_set_unlock_launch_picker_title)).setReturnCredentials(true).setRequestGatekeeperPasswordHandle(this.mRequestGatekeeperPassword).setUserId(this.mUserId).show();
                }
            } else {
        ...
        private void setupPasswordRequirementsView(View view) {
            RecyclerView recyclerView = (RecyclerView) view.findViewById(C0444R.C0448id.password_requirements_view);
        ...
        public String[] convertErrorCodeToMessages() {
            ...
            for (PasswordValidationError next : this.mValidationErrors) {
                switch (next.errorCode) {
                    case 2:
                        arrayList.add(getString(C0444R.string.lockpassword_illegal_character));
                        break;
                    case 3:
                        Resources resources = getResources();
                        int i = this.mIsAlphaMode ? C0444R.plurals.lockpassword_password_too_short : C0444R.plurals.lockpassword_pin_too_short;
                        int i2 = next.requirement;
                        arrayList.add(resources.getQuantityString(i, i2, new Object[]{Integer.valueOf(i2)}));
                        break;
                    case 4:
                        Resources resources2 = getResources();
                        int i3 = this.mIsAlphaMode ? C0444R.plurals.lockpassword_password_too_long : C0444R.plurals.lockpassword_pin_too_long;
                        int i4 = next.requirement;
                        arrayList.add(resources2.getQuantityString(i3, i4 + 1, new Object[]{Integer.valueOf(i4 + 1)}));
                        break;
                    case 5:
                        arrayList.add(getString(C0444R.string.lockpassword_pin_no_sequential_digits));
                        break;
                    case 6:
                        Resources resources3 = getResources();
                        int i5 = next.requirement;
                        arrayList.add(resources3.getQuantityString(C0444R.plurals.lockpassword_password_requires_letters, i5, new Object[]{Integer.valueOf(i5)}));
                        break;
                    case 7:
                        Resources resources4 = getResources();
                        int i6 = next.requirement;
                        arrayList.add(resources4.getQuantityString(C0444R.plurals.lockpassword_password_requires_uppercase, i6, new Object[]{Integer.valueOf(i6)}));
                        break;
                    case 8:
                        Resources resources5 = getResources();
                        int i7 = next.requirement;
                        arrayList.add(resources5.getQuantityString(C0444R.plurals.lockpassword_password_requires_lowercase, i7, new Object[]{Integer.valueOf(i7)}));
                        break;
                    case 9:
                        Resources resources6 = getResources();
                        int i8 = next.requirement;
                        arrayList.add(resources6.getQuantityString(C0444R.plurals.lockpassword_password_requires_numeric, i8, new Object[]{Integer.valueOf(i8)}));
                        break;
                    case 10:
                        Resources resources7 = getResources();
                        int i9 = next.requirement;
                        arrayList.add(resources7.getQuantityString(C0444R.plurals.lockpassword_password_requires_symbols, i9, new Object[]{Integer.valueOf(i9)}));
                        break;
                    case 11:
                        Resources resources8 = getResources();
                        int i10 = next.requirement;
                        arrayList.add(resources8.getQuantityString(C0444R.plurals.lockpassword_password_requires_nonletter, i10, new Object[]{Integer.valueOf(i10)}));
                        break;
                    case 12:
                        Resources resources9 = getResources();
                        int i11 = next.requirement;
                        arrayList.add(resources9.getQuantityString(C0444R.plurals.lockpassword_password_requires_nonnumerical, i11, new Object[]{Integer.valueOf(i11)}));
                        break;
                    case 13:
                        DevicePolicyManager devicePolicyManager = (DevicePolicyManager) getContext().getSystemService(DevicePolicyManager.class);
                        if (!this.mIsAlphaMode) {
                            arrayList.add(devicePolicyManager.getString("Settings.PIN_RECENTLY_USED", new C1189xcfed0646(this)));
                            break;
                        } else {
                            arrayList.add(devicePolicyManager.getString("Settings.PASSWORD_RECENTLY_USED", new C1188xcfed0645(this)));
                            break;
                        }
                    default:
        ...
        public /* synthetic */ String lambda$convertErrorCodeToMessages$0() throws Exception {
            return getString(C0444R.string.lockpassword_password_recently_used);
        }

        /* access modifiers changed from: private */
        public /* synthetic */ String lambda$convertErrorCodeToMessages$1() throws Exception {
            return getString(C0444R.string.lockpassword_pin_recently_used);
        }
