...
public class RemoveAccountPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, View.OnClickListener {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        ((Button) layoutPreference.findViewById(C0444R.C0448id.button)).setOnClickListener(this);
    }
    ...
    public static class ConfirmRemoveAccountDialog extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            return new AlertDialog.Builder(getActivity()).setTitle((int) C0444R.string.really_remove_account_title).setMessage((int) C0444R.string.really_remove_account_message).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).setPositiveButton((int) C0444R.string.remove_account_label, (DialogInterface.OnClickListener) this).create();
        }

        public void onClick(DialogInterface dialogInterface, int i) {
            FragmentActivity activity = getTargetFragment().getActivity();
            AccountManager.get(activity).removeAccountAsUser(this.mAccount, activity, new C0628x609c4744(this), (Handler) null, this.mUserHandle);
        }
    ...
    public static class RemoveAccountFailureDialog extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            return new AlertDialog.Builder(getActivity()).setTitle((int) C0444R.string.remove_account_label).setMessage((CharSequence) ((DevicePolicyManager) getContext().getSystemService(DevicePolicyManager.class)).getString("Settings.REMOVE_ACCOUNT_FAILED_ADMIN_RESTRICTION", new C0629xd276c95c(this))).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).create();
        }

        /* access modifiers changed from: private */
        public /* synthetic */ String lambda$onCreateDialog$0() throws Exception {
            return getString(C0444R.string.remove_account_failed);
        }
    }
}
