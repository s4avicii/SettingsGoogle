...
public class AccountDashboardFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.accounts_dashboard_settings) {
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_user_and_account_dashboard;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.accounts_dashboard_settings;
    }
