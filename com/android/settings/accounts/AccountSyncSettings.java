...
public class AccountSyncSettings extends AccountPreferenceBase {
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_accounts;
    }
    ...
    public Dialog onCreateDialog(int i) {
        if (i == 102) {
            return new AlertDialog.Builder(getActivity()).setTitle((int) C0444R.string.cant_sync_dialog_title).setMessage((int) C0444R.string.cant_sync_dialog_message).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).create();
        }
        return null;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.account_sync_settings);
    ...
    private void setAccessibilityTitle() {
        ...
        if (isManagedProfile) {
            str = devicePolicyManager.getString("Settings.ACCESSIBILITY_WORK_ACCOUNT_TITLE", new AccountSyncSettings$$ExternalSyntheticLambda1(this, title), new Object[]{title});
        } else {
            str = devicePolicyManager.getString("Settings.ACCESSIBILITY_PERSONAL_ACCOUNT_TITLE", new AccountSyncSettings$$ExternalSyntheticLambda0(this, title), new Object[]{title});
        }
    ...
    public /* synthetic */ String lambda$setAccessibilityTitle$0(CharSequence charSequence) throws Exception {
        return getString(C0444R.string.accessibility_work_account_title, charSequence);
    }

    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$setAccessibilityTitle$1(CharSequence charSequence) throws Exception {
        return getString(C0444R.string.accessibility_personal_account_title, charSequence);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        MenuItem add = menu.add(0, 1, 0, getString(C0444R.string.sync_menu_sync_now));
        MenuItem add2 = menu.add(0, 2, 0, getString(C0444R.string.sync_menu_sync_cancel));
    ...
    private void setFeedsState() {
        ...
        while (i3 < preferenceCount) {
            ...
            if (!(preference instanceof SyncStateSwitchPreference)) {
                ...
                if (!syncAutomaticallyAsUser) {
                    syncStateSwitchPreference.setSummary((int) C0444R.string.sync_disabled);
                } else if (isSyncing) {
                    syncStateSwitchPreference.setSummary((int) C0444R.string.sync_in_progress);
                } else {
                    if (j != 0) {
                        date.setTime(j);
                        i2 = i4;
                        z3 = false;
                        syncStateSwitchPreference.setSummary((CharSequence) getResources().getString(C0444R.string.last_synced, new Object[]{formatSyncDate(getContext(), date)}));
                    } else {
                        i2 = i4;
                        z3 = false;
        ...
        if (z4) {
            getPreferenceScreen().addPreference(new FooterPreference.Builder(getActivity()).setTitle((int) C0444R.string.sync_is_failing).build());
        }
    }
