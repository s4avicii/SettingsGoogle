...
public class ManagedProfileSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        ...
        public List<SearchIndexableResource> getXmlResourcesToIndex(Context context, boolean z) {
            ...
            searchIndexableResource.xmlResId = C0444R.xml.managed_profile_settings;
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.managed_profile_settings;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        replaceEnterpriseStringTitle("work_mode", "Settings.WORK_PROFILE_SETTING", C0444R.string.work_mode_label);
        replaceEnterpriseStringTitle("contacts_search", "Settings.WORK_PROFILE_CONTACT_SEARCH_TITLE", C0444R.string.managed_profile_contact_search_title);
        replaceEnterpriseStringSummary("contacts_search", "Settings.WORK_PROFILE_CONTACT_SEARCH_SUMMARY", C0444R.string.managed_profile_contact_search_summary);
        replaceEnterpriseStringTitle("cross_profile_calendar", "Settings.CROSS_PROFILE_CALENDAR_TITLE", C0444R.string.cross_profile_calendar_title);
        replaceEnterpriseStringSummary("cross_profile_calendar", "Settings.CROSS_PROFILE_CALENDAR_SUMMARY", C0444R.string.cross_profile_calendar_summary);
    }
