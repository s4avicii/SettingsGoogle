...
public class AccountPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, AuthenticatorHelper.OnAccountsUpdateListener, Preference.OnPreferenceClickListener, LifecycleObserver, OnPause, OnResume {
    ...
    public void updateDynamicRawDataToIndex(List<SearchIndexableRaw> list) {
        if (isAvailable()) {
            ...
            String string = resources.getString(C0444R.string.account_settings_title);
            for (UserInfo userInfo : this.mUm.getProfiles(UserHandle.myUserId())) {
                if (userInfo.isEnabled() && userInfo.isManagedProfile()) {
                    if (!this.mHelper.hasBaseUserRestriction("no_remove_managed_profile", UserHandle.myUserId())) {
                        ...
                        searchIndexableRaw.title = this.mDpm.getString("Settings.REMOVE_WORK_PROFILE", new AccountPreferenceController$$ExternalSyntheticLambda0(resources));
                    ...
                    searchIndexableRaw2.title = this.mDpm.getString("Settings.MANAGED_PROFILE_SETTINGS_TITLE", new AccountPreferenceController$$ExternalSyntheticLambda1(resources));
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        while (i < size) {
            ...
            if (preference == valueAt.addAccountPreference) {
                ...
                new SubSettingLauncher(this.mContext).setSourceMetricsCategory(metricsCategory).setDestination(ManagedProfileSettings.class.getName()).setTitleText(this.mDpm.getString("Settings.MANAGED_PROFILE_SETTINGS_TITLE", new AccountPreferenceController$$ExternalSyntheticLambda6(this))).setArguments(bundle).launch();
                return true;
            } else {
                i++;
            }
    ...
    public /* synthetic */ String lambda$onPreferenceClick$2() throws Exception {
        return this.mContext.getString(C0444R.string.managed_profile_settings_title);
    }
    ...
    private void updateProfileUi(UserInfo userInfo) {
        if (this.mFragment.getPreferenceManager() != null) {
            ...
            createAccessiblePreferenceCategory.setTitle((int) C0444R.string.account_settings);
            if (isSingleProfile()) {
                String string = context.getString(C0444R.string.account_for_section_header, new Object[]{BidiFormatter.getInstance().unicodeWrap(userInfo.name)});
                ...
                if (this.mType == 3) {
                    createAccessiblePreferenceCategory.setTitle((CharSequence) this.mDpm.getString("Settings.WORK_CATEGORY_HEADER", new AccountPreferenceController$$ExternalSyntheticLambda4(this)));
                    ...
                    createAccessiblePreferenceCategory.setContentDescription(this.mDpm.getString("Settings.ACCESSIBILITY_CATEGORY_WORK", new AccountPreferenceController$$ExternalSyntheticLambda10(this, workGroupSummary)));
                }
                ...
                createAccessiblePreferenceCategory.setTitle((CharSequence) this.mDpm.getString("Settings.category_personal", new AccountPreferenceController$$ExternalSyntheticLambda5(this)));
                createAccessiblePreferenceCategory.setContentDescription(this.mDpm.getString("Settings.ACCESSIBILITY_CATEGORY_PERSONAL", new AccountPreferenceController$$ExternalSyntheticLambda8(this)));
            }
    ...
    public /* synthetic */ String lambda$updateProfileUi$4(String str) throws Exception {
        return this.mContext.getString(C0444R.string.accessibility_category_work, new Object[]{str});
    }
    ...
    public /* synthetic */ String lambda$updateProfileUi$6() throws Exception {
        return this.mContext.getString(C0444R.string.accessibility_category_personal);
    }
    ...
    private RestrictedPreference newAddAccountPreference() {
        ...
        restrictedPreference.setTitle((int) C0444R.string.add_account_label);
        restrictedPreference.setIcon((int) C0444R.C0447drawable.ic_add_24dp);
    ...
    private RestrictedPreference newRemoveWorkProfilePreference() {
        ...
        restrictedPreference.setTitle((CharSequence) this.mDpm.getString("Settings.REMOVE_WORK_PROFILE", new AccountPreferenceController$$ExternalSyntheticLambda3(this)));
        restrictedPreference.setIcon((int) C0444R.C0447drawable.ic_delete);
        restrictedPreference.setOnPreferenceClickListener(this);
    ...
    public /* synthetic */ String lambda$newRemoveWorkProfilePreference$7() throws Exception {
        return this.mContext.getString(C0444R.string.remove_managed_profile_label);
    }
    ...
    private Preference newManagedProfileSettings() {
        ...
        preference.setTitle((CharSequence) this.mDpm.getString("Settings.MANAGED_PROFILE_SETTINGS_TITLE", new AccountPreferenceController$$ExternalSyntheticLambda7(this)));
        preference.setIcon((int) C0444R.C0447drawable.ic_settings_24dp);
    ...
    private String getWorkGroupSummary(Context context, UserInfo userInfo) {
        ...
        return this.mDpm.getString("Settings.MANAGED_BY", new AccountPreferenceController$$ExternalSyntheticLambda9(this, applicationLabel), new Object[]{applicationLabel});
    }

    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$getWorkGroupSummary$9(CharSequence charSequence) throws Exception {
        return this.mContext.getString(C0444R.string.managing_admin, new Object[]{charSequence});
    }
    ...
    private void updateAccountTypes(ProfileData profileData) {
        if (this.mFragment.getPreferenceManager() != null && profileData.preferenceGroup.getPreferenceManager() != null) {
            if (profileData.userInfo.isEnabled()) {
                ...
                this.mProfileNotAvailablePreference.setIcon((int) C0444R.C0447drawable.empty_icon);
                this.mProfileNotAvailablePreference.setTitle((CharSequence) null);
                this.mProfileNotAvailablePreference.setSummary((CharSequence) this.mDpm.getString("Settings.WORK_PROFILE_NOT_AVAILABLE", new AccountPreferenceController$$ExternalSyntheticLambda2(this)));
    ...
    public /* synthetic */ String lambda$updateAccountTypes$10() throws Exception {
        return this.mContext.getString(C0444R.string.managed_profile_not_available_label);
    }
