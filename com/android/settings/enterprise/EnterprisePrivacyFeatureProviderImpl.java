...
public class EnterprisePrivacyFeatureProviderImpl implements EnterprisePrivacyFeatureProvider {
    ...
    public CharSequence getDeviceOwnerDisclosure() {
        ...
        CharSequence deviceOwnerOrganizationName = this.mDpm.getDeviceOwnerOrganizationName();
        if (deviceOwnerOrganizationName != null) {
            spannableStringBuilder.append(this.mDpm.getString("Settings.DEVICE_MANAGED_WITH_NAME", new EnterprisePrivacyFeatureProviderImpl$$ExternalSyntheticLambda1(this, deviceOwnerOrganizationName), new Object[]{deviceOwnerOrganizationName}));
        } else {
            spannableStringBuilder.append(this.mDpm.getString("Settings.DEVICE_MANAGED_WITHOUT_NAME", new EnterprisePrivacyFeatureProviderImpl$$ExternalSyntheticLambda0(this)));
        }
    ...
    public /* synthetic */ String lambda$getDeviceOwnerDisclosure$0(CharSequence charSequence) throws Exception {
        return this.mResources.getString(C0444R.string.do_disclosure_with_name, new Object[]{charSequence});
    }

    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$getDeviceOwnerDisclosure$1() throws Exception {
        return this.mResources.getString(C0444R.string.do_disclosure_generic);
    }
