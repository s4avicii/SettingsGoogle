...
public abstract class FailedPasswordWipePreferenceControllerBase extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    public void updateState(Preference preference) {
        ...
        preference.setSummary((CharSequence) this.mContext.getResources().getQuantityString(C0444R.plurals.enterprise_privacy_number_failed_password_wipe, maximumFailedPasswordsBeforeWipe, new Object[]{Integer.valueOf(maximumFailedPasswordsBeforeWipe)}));
    }
