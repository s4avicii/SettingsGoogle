...
public final class ActionDisabledByAdminDialogHelper {
    ...
    public ActionDisabledByAdminDialogHelper(Activity activity, String str) {
        ...
        ((TextView) this.mDialogView.findViewById(C0444R.C0448id.admin_support_dialog_title)).setText(((DevicePolicyManager) activity.getSystemService(DevicePolicyManager.class)).getString("Settings.DISABLED_BY_IT_ADMIN_TITLE", new ActionDisabledByAdminDialogHelper$$ExternalSyntheticLambda0(this)));
    }

    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$new$0() throws Exception {
        return this.mActivity.getString(C0444R.string.disabled_by_policy_title);
    }
    ...
    public AlertDialog.Builder prepareDialogBuilder(String str, RestrictedLockUtils.EnforcedAdmin enforcedAdmin) {
        AlertDialog.Builder view = new AlertDialog.Builder(this.mActivity).setPositiveButton((int) C0444R.string.okay, this.mActionDisabledByAdminController.getPositiveButtonListener(this.mActivity, enforcedAdmin)).setView((View) this.mDialogView);
    ...
    public void setAdminSupportIcon(View view, ComponentName componentName, int i) {
        ImageView imageView = (ImageView) view.requireViewById(C0444R.C0448id.admin_support_icon);
        imageView.setImageDrawable(this.mActivity.getDrawable(C0444R.C0447drawable.ic_lock_closed));
    ...
    public void setAdminSupportDetails(Activity activity, View view, RestrictedLockUtils.EnforcedAdmin enforcedAdmin) {
        if (enforcedAdmin != null && enforcedAdmin.component != null) {
            ...
            TextView textView = (TextView) view.findViewById(C0444R.C0448id.admin_support_msg);
