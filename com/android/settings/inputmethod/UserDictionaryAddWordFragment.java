...
public class UserDictionaryAddWordFragment extends InstrumentedFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.mRootView = layoutInflater.inflate(C0444R.C0450layout.user_dictionary_add_word_fullscreen, (ViewGroup) null);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        menu.add(0, 1, 0, C0444R.string.delete).setIcon(C0444R.C0447drawable.ic_delete).setShowAsAction(5);
    }
