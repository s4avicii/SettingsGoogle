...
public class KeyboardLayoutDialogFragment extends InstrumentedDialogFragment implements InputManager.InputDeviceListener, LoaderManager.LoaderCallbacks<Keyboards> {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        AlertDialog.Builder view = new AlertDialog.Builder(activity).setTitle((int) C0444R.string.keyboard_layout_dialog_title).setPositiveButton((int) C0444R.string.keyboard_layout_dialog_setup_button, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
        ...
        }).setView(LayoutInflater.from(activity).inflate(C0444R.C0450layout.keyboard_layout_dialog_switch_hint, (ViewGroup) null));
    ...
    private void updateSwitchHintVisibility() {
        AlertDialog alertDialog = (AlertDialog) getDialog();
        if (alertDialog != null) {
            alertDialog.findViewById(C0444R.C0448id.customPanel).setVisibility(this.mAdapter.getCount() > 1 ? 0 : 8);
        }
    }
    ...
    private static final class KeyboardLayoutAdapter extends ArrayAdapter<KeyboardLayout> {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (keyboardLayout != null) {
                ...
                str = getContext().getString(C0444R.string.keyboard_layout_default_label);
                str2 = "";
            }
            String str3 = str2;
            String str4 = str;
