...
public class UserDictionarySettings extends ListFragment implements Instrumentable, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        getActivity().setTitle(C0444R.string.user_dict_settings_title);
        ActionBar actionBar = getActivity().getActionBar();
        if (actionBar != null) {
            actionBar.setTitle(C0444R.string.user_dict_settings_title);
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        textView.setText(C0444R.string.user_dict_settings_empty_text);
    ...
    private ListAdapter createAdapter() {
        return new MyAdapter(getActivity(), C0444R.C0450layout.user_dictionary_item, this.mCursor, new String[]{"word", "shortcut"}, new int[]{16908308, 16908309});
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        menu.add(0, 1, 0, C0444R.string.user_dict_settings_add_menu_title).setIcon(C0444R.C0447drawable.ic_add_24dp).setShowAsAction(5);
    }
    ...
    private void showAddOrEditDialog(String str, String str2) {
        ...
        new SubSettingLauncher(getContext()).setDestination(UserDictionaryAddWordFragment.class.getName()).setArguments(bundle).setTitleRes(C0444R.string.user_dict_settings_add_dialog_title).setSourceMetricsCategory(getMetricsCategory()).launch();
    }
    ...
    private static class MyAdapter extends SimpleCursorAdapter implements SectionIndexer {
        ...
        public MyAdapter(Context context, int i, Cursor cursor, String[] strArr, int[] iArr) {
            ...
            C09831 r2 = new SimpleCursorAdapter.ViewBinder() {
