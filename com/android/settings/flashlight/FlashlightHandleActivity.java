...
public class FlashlightHandleActivity extends Activity {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean z) {
            ...
            searchIndexableRaw.title = context.getString(C0444R.string.power_flashlight);
            searchIndexableRaw.screenTitle = context.getString(C0444R.string.power_flashlight);
            searchIndexableRaw.keywords = context.getString(C0444R.string.keywords_flashlight);
