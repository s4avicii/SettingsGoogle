...
public class AppLocationPermissionPreferenceController extends LocationBasePreferenceController implements PreferenceControllerMixin {
    ...
    public CharSequence getSummary() {
        if (!this.mLocationManager.isLocationEnabled()) {
            return this.mContext.getString(C0444R.string.location_app_permission_summary_location_off);
        }
        if (this.mNumTotal == -1 || this.mNumHasLocation == -1) {
            return this.mContext.getString(C0444R.string.location_settings_loading_app_permission_stats);
        }
        Resources resources = this.mContext.getResources();
        int i = this.mNumHasLocation;
        return resources.getQuantityString(C0444R.plurals.location_app_permission_summary_location_on, i, new Object[]{Integer.valueOf(i), Integer.valueOf(this.mNumTotal)});
    }
