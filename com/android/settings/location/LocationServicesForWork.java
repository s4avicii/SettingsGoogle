...
public class LocationServicesForWork extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.location_services_workprofile) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.location_services_workprofile;
    }
