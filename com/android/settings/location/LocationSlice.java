...
public class LocationSlice implements CustomSliceable {
    ...
    public Slice getSlice() {
        ...
        CharSequence text = this.mContext.getText(C0444R.string.location_settings_title);
    ...
    public Intent getIntent() {
        String charSequence = this.mContext.getText(C0444R.string.location_settings_title).toString();
