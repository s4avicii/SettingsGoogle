...
public class TopLevelLocationPreferenceController extends BasePreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    public CharSequence getSummary() {
        if (!this.mLocationManager.isLocationEnabled()) {
            return this.mContext.getString(C0444R.string.location_settings_summary_location_off);
        }
        if (this.mNumTotal == -1) {
        ...
        return resources.getQuantityString(C0444R.plurals.location_settings_summary_location_on, i, new Object[]{Integer.valueOf(i)});
    }
