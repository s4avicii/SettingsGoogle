...
public class ActivityEmbeddingRulesController {
    ...
    public static void registerTwoPanePairRuleForSettingsHome(Context context, ComponentName componentName, String str, boolean z, boolean z2, boolean z3) {
        if (ActivityEmbeddingUtils.isEmbeddingActivityEnabled(context)) {
            ...
            registerTwoPanePairRule(context, new ComponentName(context, SliceDeepLinkHomepageActivity.class), componentName, str, z ? 1 : 0, z2 ? 1 : 0, z3);
        }
    }
    ...
    private void registerHomepagePlaceholderRule() {
        ...
        addActivityFilter((Set<ActivityFilter>) hashSet, (Class<? extends Activity>) DeepLinkHomepageActivity.class);
        addActivityFilter((Set<ActivityFilter>) hashSet, (Class<? extends Activity>) SliceDeepLinkHomepageActivity.class);
