...
public class ResetNetwork extends InstrumentedFragment {
    ...
    public void onCreate(Bundle bundle) {
        ...
        getActivity().setTitle(C0444R.string.reset_network_title);
    }

    /* access modifiers changed from: private */
    public boolean runKeyguardConfirmation(int i) {
        return new ChooseLockSettingsHelper.Builder(getActivity(), this).setRequestCode(i).setTitle(getActivity().getResources().getText(C0444R.string.reset_network_title)).show();
    }
    ...
    public void showFinalConfirmation() {
        ...
        new SubSettingLauncher(getContext()).setDestination(ResetNetworkConfirm.class.getName()).setArguments(bundle).setTitleRes(C0444R.string.reset_network_confirm_title).setSourceMetricsCategory(getMetricsCategory()).launch();
    }

    private void establishInitialState(List<SubscriptionInfo> list) {
        this.mSubscriptionSpinner = (Spinner) this.mContentView.findViewById(C0444R.C0448id.reset_network_subscription);
        this.mEsimContainer = this.mContentView.findViewById(C0444R.C0448id.erase_esim_container);
        this.mEsimCheckbox = (CheckBox) this.mContentView.findViewById(C0444R.C0448id.erase_esim);
        ...
        Button button = (Button) this.mContentView.findViewById(C0444R.C0448id.initiate_reset_network);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (!userManager.isAdminUser() || RestrictedLockUtilsInternal.hasBaseUserRestriction(getActivity(), "no_network_reset", UserHandle.myUserId())) {
            return layoutInflater.inflate(C0444R.C0450layout.network_reset_disallowed_screen, (ViewGroup) null);
        }
        ...
        this.mContentView = layoutInflater.inflate(C0444R.C0450layout.reset_network, (ViewGroup) null);
        establishInitialState(getActiveSubscriptionInfoList());
