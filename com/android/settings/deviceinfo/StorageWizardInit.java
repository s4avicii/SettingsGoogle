...
public class StorageWizardInit extends StorageWizardBase {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C0444R.C0450layout.storage_wizard_init);
        this.mIsPermittedToAdopt = UserManager.get(this).isAdminUser() && !ActivityManager.isUserAMonkey();
        setHeaderText(C0444R.string.storage_wizard_init_v2_title, getDiskShortDescription());
        this.mInternal = (Button) requireViewById(C0444R.C0448id.storage_wizard_init_internal);
        setBackButtonText(C0444R.string.storage_wizard_init_v2_later, new CharSequence[0]);
