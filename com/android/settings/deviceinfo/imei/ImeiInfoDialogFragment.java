...
public class ImeiInfoDialogFragment extends InstrumentedDialogFragment {
    ...
    private static final int[] sViewIdsInDigitFormat = IntStream.of(new int[]{C0444R.C0448id.meid_number_value, C0444R.C0448id.min_number_value, C0444R.C0448id.imei_value, C0444R.C0448id.imei_sv_value}).sorted().toArray();
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        this.mRootView = LayoutInflater.from(positiveButton.getContext()).inflate(C0444R.C0450layout.dialog_imei_info, (ViewGroup) null);
    ...
    public void setText(int i, CharSequence charSequence) {
        ...
        if (textView != null) {
            if (TextUtils.isEmpty(charSequence)) {
                charSequence = getResources().getString(C0444R.string.device_info_default);
