...
public class ImeiInfoPreferenceController extends BasePreferenceController {
    ...
    private CharSequence getTitleForGsmPhone(int i) {
        if (!this.mIsMultiSim) {
            return this.mContext.getString(C0444R.string.status_imei);
        }
        return this.mContext.getString(C0444R.string.imei_multi_sim, new Object[]{Integer.valueOf(i + 1)});
    }

    private CharSequence getTitleForCdmaPhone(int i) {
        if (!this.mIsMultiSim) {
            return this.mContext.getString(C0444R.string.status_meid_number);
        }
        return this.mContext.getString(C0444R.string.meid_multi_sim, new Object[]{Integer.valueOf(i + 1)});
    }
