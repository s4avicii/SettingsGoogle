...
public class StorageUtils {
    ...
    public static void launchForgetMissingVolumeRecordFragment(Context context, StorageEntry storageEntry) {
        if (storageEntry != null && storageEntry.isVolumeRecordMissed()) {
            ...
            new SubSettingLauncher(context).setDestination(PrivateVolumeForget.class.getCanonicalName()).setTitleRes(C0444R.string.storage_menu_forget).setSourceMetricsCategory(745).setArguments(bundle).launch();
        }
    }
    ...
    public static String getStorageSizeLabel(Context context, long j) {
        ...
        return TextUtils.expandTemplate(context.getText(C0444R.string.storage_size_large), new CharSequence[]{formatBytes.value, formatBytes.units}).toString();
    }
    ...
    public static class UnmountTask extends AsyncTask<Void, Void, Exception> {
        ...
        public void onPostExecute(Exception exc) {
            if (exc == null) {
                ...
                Toast.makeText(context, context.getString(C0444R.string.storage_unmount_success, new Object[]{this.mDescription}), 0).show();
                return;
            }
            Log.e("StorageUtils", "Failed to unmount " + this.mVolumeId, exc);
            Context context2 = this.mContext;
            Toast.makeText(context2, context2.getString(C0444R.string.storage_unmount_failure, new Object[]{this.mDescription}), 0).show();
        }
    }
    ...
    public static class MountTask extends AsyncTask<Void, Void, Exception> {
        ...
        public void onPostExecute(Exception exc) {
            if (exc == null) {
                Context context = this.mContext;
                Toast.makeText(context, context.getString(C0444R.string.storage_mount_success, new Object[]{this.mDescription}), 0).show();
                return;
            }
            Log.e("StorageUtils", "Failed to mount " + this.mVolumeId, exc);
            Context context2 = this.mContext;
            Toast.makeText(context2, context2.getString(C0444R.string.storage_mount_failure, new Object[]{this.mDescription}), 0).show();
        }
    }
    ...
    public static class SystemInfoFragment extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            return new AlertDialog.Builder(getActivity()).setMessage((CharSequence) getContext().getString(C0444R.string.storage_detail_dialog_system, new Object[]{Build.VERSION.RELEASE_OR_PREVIEW_DISPLAY})).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).create();
        }
    }
