...
public class StorageRenameFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        View inflate = LayoutInflater.from(builder.getContext()).inflate(C0444R.C0450layout.dialog_edittext, (ViewGroup) null, false);
        EditText editText = (EditText) inflate.findViewById(C0444R.C0448id.edittext);
        editText.setText(findRecordByUuid.getNickname());
        editText.requestFocus();
        return builder.setTitle((int) C0444R.string.storage_rename_title).setView(inflate).setPositiveButton((int) C0444R.string.save, (DialogInterface.OnClickListener) new StorageRenameFragment$$ExternalSyntheticLambda0(storageManager, string, editText)).setNegativeButton((int) C0444R.string.cancel, (DialogInterface.OnClickListener) null).create();
    }
}
