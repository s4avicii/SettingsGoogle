...
public class EmptyTrashFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        return new AlertDialog.Builder(getActivity()).setTitle((int) C0444R.string.storage_trash_dialog_title).setMessage((CharSequence) getActivity().getString(C0444R.string.storage_trash_dialog_ask_message, new Object[]{StorageUtils.getStorageSizeLabel(getActivity(), this.mTrashSize)})).setPositiveButton((int) C0444R.string.storage_trash_dialog_confirm, (DialogInterface.OnClickListener) new EmptyTrashFragment$$ExternalSyntheticLambda0(this)).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).create();
    }
