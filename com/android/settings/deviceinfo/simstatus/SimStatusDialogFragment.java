...
public class SimStatusDialogFragment extends InstrumentedDialogFragment {
    private static final int[] sViewIdsInDigitFormat = IntStream.of(new int[]{C0444R.C0448id.icc_id_value, C0444R.C0448id.number_value, C0444R.C0448id.esim_id_value}).sorted().toArray();
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        this.mRootView = LayoutInflater.from(positiveButton.getContext()).inflate(C0444R.C0450layout.dialog_sim_status, (ViewGroup) null);
