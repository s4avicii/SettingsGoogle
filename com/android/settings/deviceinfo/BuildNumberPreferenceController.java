...
public class BuildNumberPreferenceController extends BasePreferenceController implements LifecycleObserver, OnStart {
    ...
    public void copy() {
        Sliceable.setCopyContent(this.mContext, getSummary(), this.mContext.getText(C0444R.string.build_number));
    }
        ...
        if (!this.mUm.isAdminUser() && !this.mUm.isDemoUser()) {
            ...
            if (i > 0) {
                ...
                if (i2 == 0 && !this.mProcessingLastDevHit) {
                    ...
                    boolean show = new ChooseLockSettingsHelper.Builder(this.mActivity, this.mFragment).setRequestCode(100).setTitle(this.mContext.getString(C0444R.string.unlock_set_unlock_launch_picker_title)).show();
                    ...
                    Toast makeText = Toast.makeText(context, resources.getQuantityString(C0444R.plurals.show_dev_countdown, i3, new Object[]{Integer.valueOf(i3)}), 0);
                ...
                Toast makeText2 = Toast.makeText(this.mContext, C0444R.string.show_dev_already, 1);
    ...
    private void enableDevelopmentSettings() {
        ...
        Toast makeText = Toast.makeText(this.mContext, C0444R.string.show_dev_on, 1);
        this.mDevHitToast = makeText;
        makeText.show();
    }
