...
public class StorageWizardFormatProgress extends StorageWizardBase {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setHeaderText(C0444R.string.storage_wizard_format_progress_title, getDiskShortDescription());
        setBodyText(C0444R.string.storage_wizard_format_progress_body, getDiskDescription());
