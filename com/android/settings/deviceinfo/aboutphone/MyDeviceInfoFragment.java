...
public class MyDeviceInfoFragment extends DashboardFragment implements DeviceNamePreferenceController.DeviceNamePreferenceHost {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.my_device_info) {
    ...
    public int getHelpResource() {
        return C0444R.string.help_uri_about;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.my_device_info;
    }
    ...
    private void initHeader() {
        ...
        boolean z = getContext().getResources().getBoolean(C0444R.bool.config_show_device_header_in_device_info);
        layoutPreference.setVisible(z);
        if (z) {
            View findViewById = layoutPreference.findViewById(C0444R.C0448id.entity_header);
