...
public class PrivateVolumeUnmount extends InstrumentedFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View inflate = layoutInflater.inflate(C0444R.C0450layout.storage_internal_unmount, viewGroup, false);
        ((TextView) inflate.findViewById(C0444R.C0448id.body)).setText(TextUtils.expandTemplate(getText(C0444R.string.storage_internal_unmount_details), new CharSequence[]{this.mDisk.getDescription()}));
