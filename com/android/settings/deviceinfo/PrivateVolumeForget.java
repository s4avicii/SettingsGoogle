...
public class PrivateVolumeForget extends InstrumentedFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View inflate = layoutInflater.inflate(C0444R.C0450layout.storage_internal_forget, viewGroup, false);
        ((TextView) inflate.findViewById(C0444R.C0448id.body)).setText(TextUtils.expandTemplate(getText(C0444R.string.storage_internal_forget_details), new CharSequence[]{this.mRecord.getNickname()}));
    ...
    public static class ForgetConfirmFragment extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            builder.setTitle(TextUtils.expandTemplate(getText(C0444R.string.storage_internal_forget_confirm_title), new CharSequence[]{findRecordByUuid.getNickname()}));
            builder.setMessage(TextUtils.expandTemplate(getText(C0444R.string.storage_internal_forget_confirm), new CharSequence[]{findRecordByUuid.getNickname()}));
            builder.setPositiveButton((int) C0444R.string.storage_menu_forget, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                    storageManager.forgetVolume(string);
                    ForgetConfirmFragment.this.getActivity().finish();
                }
            });
            builder.setNegativeButton((int) C0444R.string.cancel, (DialogInterface.OnClickListener) null);
