...
public class SettingsActivity extends SettingsBaseActivity implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceFragmentCompat.OnPreferenceStartFragmentCallback, ButtonBarHandler, FragmentManager.OnBackStackChangedListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (isSubSettings(intent) && !WizardManagerHelper.isAnySetupWizard(getIntent())) {
            setTheme(C0444R.style.Theme_SubSettings);
        }
        setContentView((int) C0444R.C0450layout.settings_main_prefs);
        ...
        SettingsMainSwitchBar settingsMainSwitchBar = (SettingsMainSwitchBar) findViewById(C0444R.C0448id.switch_bar);
        this.mMainSwitch = settingsMainSwitchBar;
        if (settingsMainSwitchBar != null) {
            settingsMainSwitchBar.setMetricsTag(getMetricsTag());
            this.mMainSwitch.setTranslationZ(findViewById(C0444R.C0448id.main_content).getTranslationZ() + 1.0f);
        }
        if (intent.getBooleanExtra("extra_prefs_show_button_bar", false) && (findViewById = findViewById(C0444R.C0448id.button_bar)) != null) {
            findViewById.setVisibility(0);
            Button button = (Button) findViewById(C0444R.C0448id.back_button);
            button.setOnClickListener(new SettingsActivity$$ExternalSyntheticLambda0(this));
            Button button2 = (Button) findViewById(C0444R.C0448id.skip_button);
            button2.setOnClickListener(new SettingsActivity$$ExternalSyntheticLambda2(this));
            Button button3 = (Button) findViewById(C0444R.C0448id.next_button);
    ...
    public void launchSettingFragment(String str, Intent intent) {
        ...
        this.mInitialTitleResId = C0444R.string.dashboard_title;
    ...
    public void setTaskDescription(ActivityManager.TaskDescription taskDescription) {
        taskDescription.setIcon(Icon.createWithResource(this, C0444R.C0447drawable.ic_launcher_settings));
    ...
    private void switchToFragment(String str, Bundle bundle, boolean z, int i, CharSequence charSequence) {
        ...
        if (!z || isValidFragment(str)) {
            ...
            if (targetFragment != null) {
                ...
                beginTransaction.replace(C0444R.C0448id.main_content, targetFragment);
                if (i > 0) {
