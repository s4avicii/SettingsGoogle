...
public class DisableDevSettingsDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        return new AlertDialog.Builder(getActivity()).setMessage((int) C0444R.string.bluetooth_disable_a2dp_hw_offload_dialog_message).setTitle((int) C0444R.string.bluetooth_disable_a2dp_hw_offload_dialog_title).setPositiveButton((int) C0444R.string.bluetooth_disable_a2dp_hw_offload_dialog_confirm, (DialogInterface.OnClickListener) this).setNegativeButton((int) C0444R.string.bluetooth_disable_a2dp_hw_offload_dialog_cancel, (DialogInterface.OnClickListener) this).create();
    }
