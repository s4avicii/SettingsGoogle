...
public class WirelessDebuggingFragment extends DashboardFragment implements WirelessDebuggingEnabler.OnEnabledListener {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.adb_wireless_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.adb_wireless_settings;
    }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        switchBar.setTitle(getContext().getString(C0444R.string.wireless_debugging_main_switch_title));
    ...
    private void addPreferences() {
        ...
        this.mOffMessagePreference.setTitle(getText(C0444R.string.adb_wireless_list_empty_off));
    ...
    private void launchPairedDeviceDetailsFragment(AdbPairedDevicePreference adbPairedDevicePreference) {
        ...
        new SubSettingLauncher(getContext()).setTitleRes(C0444R.string.adb_wireless_device_details_title).setDestination(AdbDeviceDetailsFragment.class.getName()).setArguments(adbPairedDevicePreference.getExtras()).setSourceMetricsCategory(getMetricsCategory()).setResultListener(this, 0).launch();
    }
