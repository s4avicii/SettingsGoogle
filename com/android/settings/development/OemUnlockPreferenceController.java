...
public class OemUnlockPreferenceController extends DeveloperOptionsPreferenceController implements Preference.OnPreferenceChangeListener, PreferenceControllerMixin, OnActivityResultListener {
    ...
    private void updateOemUnlockSettingDescription() {
        ...
        if (isBootloaderUnlocked()) {
            i = C0444R.string.oem_unlock_enable_disabled_summary_bootloader_unlocked;
        } else if (isSimLockedDevice()) {
            i = C0444R.string.oem_unlock_enable_disabled_summary_sim_locked_device;
        } else {
            i = !isOemUnlockAllowedByUserAndCarrier() ? C0444R.string.oem_unlock_enable_disabled_summary_connectivity_or_locked : C0444R.string.oem_unlock_enable_summary;
        }
    ...
    public boolean showKeyguardConfirmation(Resources resources, int i) {
        return new ChooseLockSettingsHelper.Builder(this.mActivity, this.mFragment).setRequestCode(i).setTitle(resources.getString(C0444R.string.oem_unlock_enable)).show();
    }
