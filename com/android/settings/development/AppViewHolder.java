...
public class AppViewHolder {
    ...
    public static AppViewHolder createOrRecycle(LayoutInflater layoutInflater, View view) {
        ...
        View inflate = layoutInflater.inflate(C0444R.C0450layout.preference_app, (ViewGroup) null);
        ...
        appViewHolder.disabled = (TextView) inflate.findViewById(C0444R.C0448id.appendix);
