...
public class EnableOemUnlockSettingWarningDialog extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        return new AlertDialog.Builder(getActivity()).setTitle((int) C0444R.string.confirm_enable_oem_unlock_title).setMessage((int) C0444R.string.confirm_enable_oem_unlock_text).setPositiveButton((int) C0444R.string.enable_text, (DialogInterface.OnClickListener) this).setNegativeButton(17039360, (DialogInterface.OnClickListener) this).create();
    }
