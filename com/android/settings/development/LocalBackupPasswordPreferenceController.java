        ...
        if (iBackupManager != null) {
            try {
                if (iBackupManager.hasBackupPassword()) {
                    preference.setSummary((int) C0444R.string.local_backup_password_summary_change);
                } else {
                    preference.setSummary((int) C0444R.string.local_backup_password_summary_none);
                }
