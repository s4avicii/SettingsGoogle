...
public class JobSchedulerFragment extends Fragment {
    ...
    public class SavedTabsListAdapter extends BaseExpandableListAdapter {
        private String[][] mChildren = {new String[0], new String[0], this.mResources.getStringArray(C0444R.array.tare_min_satiated_balance_subfactors), this.mResources.getStringArray(C0444R.array.tare_modifiers_subfactors), this.mResources.getStringArray(C0444R.array.tare_job_scheduler_actions), this.mResources.getStringArray(C0444R.array.tare_rewards_subfactors)};
