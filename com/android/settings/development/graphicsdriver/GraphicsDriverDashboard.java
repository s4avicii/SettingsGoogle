...
public class GraphicsDriverDashboard extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.graphics_driver_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.graphics_driver_settings;
    }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        switchBar.setTitle(getContext().getString(C0444R.string.graphics_driver_main_switch_title));
        switchBar.show();
    }
}
