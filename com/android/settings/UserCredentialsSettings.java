...
public class UserCredentialsSettings extends SettingsPreferenceFragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        getActivity().setTitle(C0444R.string.user_credentials);
    }

    /* access modifiers changed from: protected */
    public void announceRemoval(String str) {
        if (isAdded()) {
            getListView().announceForAccessibility(getString(C0444R.string.user_credential_removed, str));
        }
    }
    ...
    public static class CredentialDialogFragment extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            View inflate = getActivity().getLayoutInflater().inflate(C0444R.C0450layout.user_credential_dialog, (ViewGroup) null);
            ViewGroup viewGroup = (ViewGroup) inflate.findViewById(C0444R.C0448id.credential_container);
            viewGroup.addView(UserCredentialsSettings.getCredentialView(credential, C0444R.C0450layout.user_credential, (View) null, viewGroup, true));
            AlertDialog.Builder positiveButton = new AlertDialog.Builder(getActivity()).setView(inflate).setTitle((int) C0444R.string.user_credential_title).setPositiveButton((int) C0444R.string.done, (DialogInterface.OnClickListener) null);
            final int myUserId = UserHandle.myUserId();
            if (!RestrictedLockUtilsInternal.hasBaseUserRestriction(getContext(), "no_config_credentials", myUserId)) {
                positiveButton.setNegativeButton((int) C0444R.string.trusted_credentials_remove_label, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
        ...
        public void onPostExecute(List<Credential> list) {
            if (UserCredentialsSettings.this.isAdded()) {
                if (list == null || list.size() == 0) {
                    ...
                    textView.setText(C0444R.string.user_credential_none_installed);
    ...
    private static class CredentialAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C0444R.C0450layout.user_credential_preference, viewGroup, false));
        }

        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            UserCredentialsSettings.getCredentialView(this.mItems.get(i), C0444R.C0450layout.user_credential_preference, viewHolder.itemView, (ViewGroup) null, false);
    ...
    static {
        ...
        sparseArray.put(C0444R.C0448id.contents_userkey, Credential.Type.USER_KEY);
        sparseArray.put(C0444R.C0448id.contents_usercrt, Credential.Type.USER_CERTIFICATE);
        sparseArray.put(C0444R.C0448id.contents_cacrt, Credential.Type.CA_CERTIFICATE);
    }
    ...
    protected static View getCredentialView(Credential credential, int i, View view, ViewGroup viewGroup, boolean z) {
        ...
        ((TextView) view.findViewById(C0444R.C0448id.alias)).setText(credential.alias);
        ((TextView) view.findViewById(C0444R.C0448id.purpose)).setText(credential.isSystem() ? C0444R.string.credential_for_vpn_and_apps : C0444R.string.credential_for_wifi);
        view.findViewById(C0444R.C0448id.contents).setVisibility(z ? 0 : 8);
        if (z) {
            int i2 = 0;
            while (true) {
