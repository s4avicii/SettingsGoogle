...
public class ProcessStatsUi extends ProcessStatsBase {
    ...
    public int getHelpResource() {
        return C0444R.string.help_uri_process_stats_apps;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.process_stats_ui);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        ...
        this.mMenuAvg = menu.add(0, 1, 0, C0444R.string.sort_avg_use);
        this.mMenuMax = menu.add(0, 2, 0, C0444R.string.sort_max_use);
        updateMenu();
    }
    ...
    public void refreshUi() {
        ...
        this.mAppListGroup.setTitle(this.mShowMax ? C0444R.string.maximum_memory_use : C0444R.string.average_memory_use);
