...
public class PremiumSmsAccess extends EmptyTextSettings implements AppStateBaseBridge.Callback, ApplicationsState.Callbacks, Preference.OnPreferenceChangeListener {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.premium_sms_settings);
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.premium_sms_settings;
    }
    ...
    private void updatePrefs(ArrayList<ApplicationsState.AppEntry> arrayList) {
        if (arrayList != null) {
            setEmptyText(C0444R.string.premium_sms_none);
            ...
            if (arrayList.size() != 0) {
                ...
                footerPreference.setTitle((int) C0444R.string.premium_sms_warning);
    ...
    private class PremiumSmsPreference extends DropDownPreference {
        ...
        public PremiumSmsPreference(ApplicationsState.AppEntry appEntry, Context context) {
            ...
            setEntries((int) C0444R.array.security_settings_premium_sms_values);
