...
public class ScaryWarningDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        return new AlertDialog.Builder(getContext()).setMessage((CharSequence) getResources().getString(C0444R.string.zen_access_warning_dialog_summary)).setTitle((CharSequence) getResources().getString(C0444R.string.zen_access_warning_dialog_title, new Object[]{string2})).setCancelable(true).setPositiveButton((int) C0444R.string.allow, (DialogInterface.OnClickListener) new ScaryWarningDialogFragment$$ExternalSyntheticLambda0(this, string, (ZenAccessDetails) getTargetFragment())).setNegativeButton((int) C0444R.string.deny, (DialogInterface.OnClickListener) ScaryWarningDialogFragment$$ExternalSyntheticLambda1.INSTANCE).create();
    }
