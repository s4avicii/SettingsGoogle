...
public class PictureInPictureDetails extends AppInfoWithHeader implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.picture_in_picture_permissions_details);
        ...
        switchPreference.setTitle((int) C0444R.string.picture_in_picture_app_detail_switch);
    ...
    public static int getPreferenceSummary(Context context, int i, String str) {
        return getEnterPipStateForPackage(context, i, str) ? C0444R.string.app_permission_summary_allowed : C0444R.string.app_permission_summary_not_allowed;
    }
