...
public class PictureInPictureSettings extends EmptyTextSettings {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.picture_in_picture_settings);
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.picture_in_picture_settings;
    }
        ...
        while (it.hasNext()) {
            ...
            appPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference preference) {
                    String string = PictureInPictureSettings.this.getString(C0444R.string.picture_in_picture_app_detail_title);
                    String str = str;
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        setEmptyText(C0444R.string.picture_in_picture_empty_text);
    }
