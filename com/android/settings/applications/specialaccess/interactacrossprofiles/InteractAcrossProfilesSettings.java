...
public class InteractAcrossProfilesSettings extends EmptyTextSettings {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.interact_across_profiles);
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.interact_across_profiles;
    }
        ...
        while (it.hasNext()) {
            ...
            appPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference preference) {
                    String string = InteractAcrossProfilesSettings.this.mDevicePolicyManager.getString("Settings.CONNECTED_WORK_AND_PERSONAL_APPS_TITLE", new InteractAcrossProfilesSettings$1$$ExternalSyntheticLambda0(this));
                    String str = str;
                ...
                public /* synthetic */ String lambda$onPreferenceClick$0() throws Exception {
                    return InteractAcrossProfilesSettings.this.getString(C0444R.string.interact_across_profiles_title);
                }
            });
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        setEmptyText(C0444R.string.interact_across_profiles_empty_text);
    }
