...
public class HeaderPreferenceController extends BasePreferenceController implements PreferenceControllerMixin, LifecycleObserver {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        if (this.mFragment != null) {
            EntityHeaderController newInstance = EntityHeaderController.newInstance(this.mFragment.getActivity(), this.mFragment, ((LayoutPreference) preferenceScreen.findPreference(getPreferenceKey())).findViewById(C0444R.C0448id.entity_header));
