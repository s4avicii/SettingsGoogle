...
public class NotificationAccessDetails extends DashboardFragment {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.notification_access_permission_details;
    }
    ...
    public /* synthetic */ boolean lambda$onResume$2(Preference preference) {
        ...
        new SubSettingLauncher(getContext()).setDestination(BridgedAppsSettings.class.getName()).setSourceMetricsCategory(getMetricsCategory()).setTitleRes(C0444R.string.notif_listener_excluded_app_screen_title).setArguments(bundle).setUserHandle(UserHandle.of(this.mUserId)).launch();
        return true;
    }
