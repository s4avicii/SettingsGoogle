...
public class VrListenerSettings extends ManagedServiceSettings {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.vr_listeners_settings);
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.vr_listeners_settings;
    }

    static {
        String simpleName = VrListenerSettings.class.getSimpleName();
        TAG = simpleName;
        CONFIG = new ManagedServiceSettings.Config.Builder().setTag(simpleName).setSetting("enabled_vr_listeners").setIntentAction("android.service.vr.VrListenerService").setPermission("android.permission.BIND_VR_LISTENER_SERVICE").setNoun("vr listener").setWarningDialogTitle(C0444R.string.vr_listener_security_warning_title).setWarningDialogSummary(C0444R.string.vr_listener_security_warning_summary).setEmptyText(C0444R.string.no_vr_listeners).build();
    }
