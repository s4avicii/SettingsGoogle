...
public class AppOpsCategory extends ListFragment implements LoaderManager.LoaderCallbacks<List<AppOpsState.AppOpEntry>> {
    ...
    public static class AppListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            boolean z = false;
            if (view == null) {
                view = this.mInflater.inflate(C0444R.C0450layout.app_ops_item, viewGroup, false);
            }
            AppOpsState.AppOpEntry item = getItem(i);
            ((ImageView) view.findViewById(C0444R.C0448id.app_icon)).setImageDrawable(item.getAppEntry().getIcon());
            ((TextView) view.findViewById(C0444R.C0448id.app_name)).setText(item.getAppEntry().getLabel());
            ((TextView) view.findViewById(C0444R.C0448id.op_name)).setText(item.getTimeText(this.mResources, false));
            view.findViewById(C0444R.C0448id.op_time).setVisibility(8);
            Switch switchR = (Switch) view.findViewById(C0444R.C0448id.op_switch);
