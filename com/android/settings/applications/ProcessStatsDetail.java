...
public class ProcessStatsDetail extends SettingsPreferenceFragment {
    ...
    private void createDetails() {
        addPreferencesFromResource(C0444R.xml.app_memory_settings);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        this.mForceStop = menu.add(0, 1, 0, C0444R.string.force_stop);
        checkForceStop();
    }
    ...
    private void fillProcessesSection() {
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            ...
            preference.setSummary((CharSequence) getString(C0444R.string.memory_use_running_format, Formatter.formatShortFileSize(getActivity(), Math.max((long) (d * d2), (long) (procStatsEntry2.mBgWeight * d2))), ProcStatsPackageEntry.getFrequency(((float) max) / ((float) this.mTotalTime), getActivity())));
    ...
    private void showStopServiceDialog(final String str, final String str2) {
        new AlertDialog.Builder(getActivity()).setTitle((int) C0444R.string.runningservicedetails_stop_dlg_title).setMessage((int) C0444R.string.runningservicedetails_stop_dlg_text).setPositiveButton((int) C0444R.string.dlg_ok, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                ProcessStatsDetail.this.doStopService(str, str2);
            }
        }).setNegativeButton((int) C0444R.string.dlg_cancel, (DialogInterface.OnClickListener) null).show();
    }
