...
public class RunningServices extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle bundle) {
        ...
        getActivity().setTitle(C0444R.string.runningservices_settings_title);
    }

    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(C0444R.C0450layout.manage_applications_running, (ViewGroup) null);
        RunningProcessesView runningProcessesView = (RunningProcessesView) inflate.findViewById(C0444R.C0448id.running_processes);
        this.mRunningProcessesView = runningProcessesView;
        runningProcessesView.doCreate();
        View findViewById = inflate.findViewById(C0444R.C0448id.loading_container);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        ...
        menu.add(0, 1, 1, C0444R.string.show_running_services).setShowAsAction(0);
        menu.add(0, 2, 2, C0444R.string.show_background_processes).setShowAsAction(0);
        updateOptionsMenu();
    }
