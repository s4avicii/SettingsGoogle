...
public class RunningServiceDetails extends InstrumentedFragment implements RunningState.OnRefreshUiListener {
    ...
    public void addServicesHeader() {
        if (this.mNumServices == 0) {
            TextView textView = (TextView) this.mInflater.inflate(C0444R.C0450layout.preference_category, this.mAllDetails, false);
            this.mServicesHeader = textView;
            textView.setText(C0444R.string.runningservicedetails_services_title);
    ...
    public void addProcessesHeader() {
        if (this.mNumProcesses == 0) {
            ...
            textView.setText(C0444R.string.runningservicedetails_processes_title);
    ...
    public void addServiceDetailsView(com.android.settings.applications.RunningState.ServiceItem r8, com.android.settings.applications.RunningState.MergedItem r9, boolean r10, boolean r11) {
        ...
        L_0x0016:
            ...
            r11 = 2131559689(0x7f0d0509, float:1.874473E38)
        ...
        L_0x0061:
            r11 = 2131558769(0x7f0d0171, float:1.8742863E38)
            android.view.View r11 = r2.findViewById(r11)
            android.widget.TextView r11 = (android.widget.TextView) r11
            r3 = 2131559238(0x7f0d0346, float:1.8743814E38)
            android.view.View r3 = r2.findViewById(r3)
            android.widget.Button r3 = (android.widget.Button) r3
            r1.mStopButton = r3
            r3 = 2131559624(0x7f0d04c8, float:1.8744597E38)
            android.view.View r3 = r2.findViewById(r3)
            android.widget.Button r3 = (android.widget.Button) r3
            r1.mReportButton = r3
            ...
            r11.setVisibility(r0)
            r8 = 2131558795(0x7f0d018b, float:1.8742916E38)
        ...
        L_0x00ba:
            ...
            r9 = 2130969423(0x7f04034f, float:1.7547527E38)
            r11.setText(r9)
            goto L_0x0108
        L_0x00c5:
            ...
            r2 = 2130973262(0x7f04124e, float:1.7555314E38)
        ...
        L_0x00f4:
            ...
            r0 = 2130973267(0x7f041253, float:1.7555324E38)
            goto L_0x0101
        L_0x00fe:
            r0 = 2130971151(0x7f040a0f, float:1.7551032E38)
        L_0x0101:
        ...
        L_0x0108:
            ...
            r0 = 2130973261(0x7f04124d, float:1.7555312E38)
            goto L_0x011e
        L_0x011b:
            r0 = 2130973266(0x7f041252, float:1.7555322E38)
        L_0x011e:
            ...
            r9.setOnClickListener(r1)
            android.widget.Button r9 = r1.mReportButton
            r11 = 17041370(0x10407da, float:2.4250204E-38)
            r9.setText(r11)
            androidx.fragment.app.FragmentActivity r9 = r7.getActivity()
    ...
    public void addProcessDetailsView(RunningState.ProcessItem processItem, boolean z) {
        ...
        View inflate = this.mInflater.inflate(C0444R.C0450layout.running_service_details_process, this.mAllDetails, false);
        ...
        TextView textView = (TextView) inflate.findViewById(C0444R.C0448id.comp_description);
        if (processItem.mUserId != UserHandle.myUserId()) {
            textView.setVisibility(8);
        } else if (z) {
            textView.setText(C0444R.string.main_running_process_description);
        } else {
            ...
            if (i2 == 1) {
                i = C0444R.string.process_provider_in_use_description;
                ...
                i = C0444R.string.process_service_in_use_description;
                if (componentName != null) {
                    try {
        ...
        if (z) {
            ...
            if (mergedItem != null) {
                ...
                if (activeItem != null) {
                    ...
                    this.mSnippetActiveItem.mHolder.description.setText(C0444R.string.no_services);
                } else {
                    finish();
                    return;
                }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(C0444R.C0450layout.running_service_details, viewGroup, false);
        Utils.prepareCustomPreferencesList(viewGroup, inflate, inflate, false);
        this.mRootView = inflate;
        this.mAllDetails = (ViewGroup) inflate.findViewById(C0444R.C0448id.all_details);
        ViewGroup viewGroup2 = (ViewGroup) inflate.findViewById(C0444R.C0448id.snippet);
    ...
    public static class MyAlertDialogFragment extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            if (i == 1) {
                ...
                return new AlertDialog.Builder(getActivity()).setTitle((CharSequence) getActivity().getString(C0444R.string.runningservicedetails_stop_dlg_title)).setMessage((CharSequence) getActivity().getString(C0444R.string.runningservicedetails_stop_dlg_text)).setPositiveButton((int) C0444R.string.dlg_ok, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
