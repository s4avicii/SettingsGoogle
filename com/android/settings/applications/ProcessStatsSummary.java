...
public class ProcessStatsSummary extends ProcessStatsBase implements Preference.OnPreferenceClickListener {
    ...
    public int getHelpResource() {
        return C0444R.string.help_uri_process_stats_summary;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.process_stats_summary);
    ...
    public void refreshUi() {
        ...
        CharSequence[] textArray = getResources().getTextArray(C0444R.array.ram_states);
        ...
        this.mAppListPreference.setSummary((CharSequence) getResources().getQuantityString(C0444R.plurals.memory_usage_apps_summary, size, new Object[]{Integer.valueOf(size), string}));
    }
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        new SubSettingLauncher(getContext()).setDestination(ProcessStatsUi.class.getName()).setTitleRes(C0444R.string.memory_usage_apps).setArguments(bundle).setSourceMetricsCategory(getMetricsCategory()).launch();
        return true;
    }
}
