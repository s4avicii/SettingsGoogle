...
public class AppLaunchSettings extends AppInfoBase implements Preference.OnPreferenceChangeListener, OnMainSwitchChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.installed_app_launch_settings);
    ...
    private AlertDialog createVerifiedLinksDialog() {
        int linksNumber = getLinksNumber(2);
        View inflate = LayoutInflater.from(this.mContext).inflate(C0444R.C0450layout.app_launch_verified_links_title, (ViewGroup) null);
        ((TextView) inflate.findViewById(C0444R.C0448id.dialog_title)).setText(getVerifiedLinksTitle(linksNumber));
        ((TextView) inflate.findViewById(C0444R.C0448id.dialog_message)).setText(getVerifiedLinksMessage(linksNumber));
        return new AlertDialog.Builder(this.mContext).setCustomTitle(inflate).setCancelable(true).setItems((CharSequence[]) IntentPickerUtils.getLinksList(this.mDomainVerificationManager, this.mPackageName, 2).toArray(new String[0]), (DialogInterface.OnClickListener) null).setPositiveButton((int) C0444R.string.app_launch_dialog_ok, (DialogInterface.OnClickListener) null).create();
    }

    /* access modifiers changed from: package-private */
    public String getVerifiedLinksTitle(int i) {
        return getResources().getQuantityString(C0444R.plurals.app_launch_verified_links_title, i, new Object[]{Integer.valueOf(i)});
    }

    private String getVerifiedLinksMessage(int i) {
        return getResources().getQuantityString(C0444R.plurals.app_launch_verified_links_message, i, new Object[]{Integer.valueOf(i)});
    }
    ...
    private void initFooter() {
        CharSequence text = this.mContext.getText(C0444R.string.app_launch_footer);
        ...
        footerPreference.setLearnMoreContentDescription(this.mContext.getString(C0444R.string.footer_learn_more_content_description, new Object[]{getLabelName()}));
    }
    ...
    private String getLabelName() {
        return this.mContext.getString(C0444R.string.launch_by_default);
    }
