...
public class ProgressDialogFragment extends InstrumentedDialogFragment {
    ...
    private ProgressAlertDialog createProgressAlertDialog() {
        ...
        progressAlertDialog.setTitle(IntentPickerUtils.getCentralizedDialogTitle(activity.getResources().getString(C0444R.string.app_launch_checking_links_title)));
        progressAlertDialog.setButton(-2, activity.getText(C0444R.string.app_launch_dialog_cancel), ProgressDialogFragment$$ExternalSyntheticLambda0.INSTANCE);
    ...
    static class ProgressAlertDialog extends AlertDialog {
        ...
        private void init(Context context) {
            View inflate = LayoutInflater.from(context).inflate(C0444R.C0450layout.app_launch_progress, (ViewGroup) null);
            ProgressBar progressBar = (ProgressBar) inflate.findViewById(C0444R.C0448id.scan_links_progressbar);
