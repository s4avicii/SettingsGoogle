        ...
        if (this.mResetDialog == dialogInterface) {
            AsyncTask.execute(new Runnable() {
                public void run() {
                    ...
                    List asList = Arrays.asList(ResetAppsHelper.this.mContext.getResources().getStringArray(C0444R.array.config_skip_reset_apps_package_name));
