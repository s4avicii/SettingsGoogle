...
public class AppStoragePreferenceController extends AppInfoPreferenceControllerBase implements LoaderManager.LoaderCallbacks<StorageStatsSource.AppStorageStats>, LifecycleObserver, OnResume, OnPause {
    ...
    public CharSequence getStorageSummary(StorageStatsSource.AppStorageStats appStorageStats, boolean z) {
        if (appStorageStats == null) {
            return this.mContext.getText(C0444R.string.computing_size);
        }
        String string = this.mContext.getString(z ? C0444R.string.storage_type_external : C0444R.string.storage_type_internal);
        Context context = this.mContext;
        return context.getString(C0444R.string.storage_summary_format, new Object[]{Formatter.formatFileSize(context, appStorageStats.getTotalBytes()), string.toString()});
    }
