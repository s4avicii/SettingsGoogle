...
public class AppInstallerInfoPreferenceController extends AppInfoPreferenceControllerBase {
    ...
    public void updateState(Preference preference) {
        preference.setSummary((CharSequence) this.mContext.getString(AppUtils.isInstant(this.mParent.getPackageInfo().applicationInfo) ? C0444R.string.instant_app_details_summary : C0444R.string.app_install_details_summary, new Object[]{this.mInstallerLabel}));
