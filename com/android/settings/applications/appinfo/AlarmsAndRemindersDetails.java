...
public class AlarmsAndRemindersDetails extends AppInfoWithHeader implements Preference.OnPreferenceChangeListener {
    ...
    public static CharSequence getSummary(Context context, ApplicationsState.AppEntry appEntry) {
        ...
        return context.getString(appStateAlarmsAndRemindersBridge.createPermissionState(applicationInfo.packageName, applicationInfo.uid).isAllowed() ? C0444R.string.app_permission_summary_allowed : C0444R.string.app_permission_summary_not_allowed);
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.alarms_and_reminders);
