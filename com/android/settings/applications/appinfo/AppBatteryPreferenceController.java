...
public class AppBatteryPreferenceController extends BasePreferenceController implements LifecycleObserver, OnResume, OnPause {
    ...
    public int getAvailabilityStatus() {
        return this.mContext.getResources().getBoolean(C0444R.bool.config_show_app_info_settings_battery) ? 0 : 2;
    }
    ...
    public void updateBatteryWithDiffEntry() {
        if (this.mIsChartGraphEnabled) {
            ...
            if (batteryDiffEntry == null || batteryDiffEntry.mConsumePower <= 0.0d) {
                this.mPreference.setSummary((CharSequence) this.mContext.getString(C0444R.string.no_battery_summary_24hr));
            } else {
                ...
                this.mPreference.setSummary((CharSequence) this.mContext.getString(C0444R.string.battery_summary_24hr, new Object[]{formatPercentage}));
            }
        }
    ...
    public void updateBattery() {
        ...
        if (!this.mIsChartGraphEnabled) {
            if (isBatteryStatsAvailable()) {
                ...
                this.mBatteryPercent = formatPercentage;
                this.mPreference.setSummary((CharSequence) this.mContext.getString(C0444R.string.battery_summary, new Object[]{formatPercentage}));
                return;
            }
            this.mPreference.setSummary((CharSequence) this.mContext.getString(C0444R.string.no_battery_summary));
        }
    }
