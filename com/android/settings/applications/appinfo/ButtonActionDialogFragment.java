...
public class ButtonActionDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    private AlertDialog createDialog(int i) {
        ...
        if (i == 0 || i == 1) {
            return new AlertDialog.Builder(context).setMessage((int) C0444R.string.app_disable_dlg_text).setPositiveButton((int) C0444R.string.app_disable_dlg_positive, (DialogInterface.OnClickListener) this).setNegativeButton((int) C0444R.string.dlg_cancel, (DialogInterface.OnClickListener) null).create();
        }
        if (i != 2) {
            return null;
        }
        return new AlertDialog.Builder(context).setTitle((int) C0444R.string.force_stop_dlg_title).setMessage((int) C0444R.string.force_stop_dlg_text).setPositiveButton((int) C0444R.string.dlg_ok, (DialogInterface.OnClickListener) this).setNegativeButton((int) C0444R.string.dlg_cancel, (DialogInterface.OnClickListener) null).create();
    }
}
