...
public class InstantAppButtonDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    private AlertDialog createDialog() {
        return new AlertDialog.Builder(getContext()).setPositiveButton((int) C0444R.string.clear_instant_app_data, (DialogInterface.OnClickListener) this).setNegativeButton((int) C0444R.string.cancel, (DialogInterface.OnClickListener) null).setTitle((int) C0444R.string.clear_instant_app_data).setMessage((int) C0444R.string.clear_instant_app_confirmation).create();
    }
}
