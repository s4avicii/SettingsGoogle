...
public class AppNotificationPreferenceController extends AppInfoPreferenceControllerBase {
    ...
    public static CharSequence getNotificationSummary(NotificationBackend.AppRow appRow, Context context) {
        ...
        if (appRow.banned) {
            return context.getText(C0444R.string.notifications_disabled);
        }
        ...
        return context.getString(C0444R.string.notifications_enabled_with_info, new Object[]{NotificationBackend.getSentSummary(context, appRow.sentByApp, false), resources.getQuantityString(C0444R.plurals.notifications_categories_off, i3, new Object[]{Integer.valueOf(i3)})});
    }
}
