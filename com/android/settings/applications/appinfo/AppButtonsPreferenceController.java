...
public class AppButtonsPreferenceController extends BasePreferenceController implements PreferenceControllerMixin, LifecycleObserver, OnResume, OnDestroy, ApplicationsState.Callbacks {
    ...
    public boolean handleDisableable() {
        if (this.mHomePackages.contains(this.mAppEntry.info.packageName) || isSystemPackage(this.mActivity.getResources(), this.mPm, this.mPackageInfo)) {
            this.mButtonsPref.setButton2Text(C0444R.string.disable_text).setButton2Icon(C0444R.C0447drawable.ic_settings_disable);
            return false;
        } else if (!this.mAppEntry.info.enabled || isDisabledUntilUsed()) {
            this.mButtonsPref.setButton2Text(C0444R.string.enable_text).setButton2Icon(C0444R.C0447drawable.ic_settings_enable);
            return true;
        } else {
            this.mButtonsPref.setButton2Text(C0444R.string.disable_text).setButton2Icon(C0444R.C0447drawable.ic_settings_disable);
    ...
    private void initButtonPreference() {
        this.mButtonsPref = ((ActionButtonsPreference) this.mScreen.findPreference(KEY_ACTION_BUTTONS)).setButton1Text(C0444R.string.launch_instant_app).setButton1Icon(C0444R.C0447drawable.ic_settings_open).setButton1OnClickListener(new AppButtonsPreferenceController$$ExternalSyntheticLambda0(this)).setButton2Text(C0444R.string.uninstall_text).setButton2Icon(C0444R.C0447drawable.ic_settings_delete).setButton2OnClickListener(new UninstallAndDisableButtonListener()).setButton3Text(C0444R.string.force_stop).setButton3Icon(C0444R.C0447drawable.ic_settings_force_stop).setButton3OnClickListener(new ForceStopButtonListener()).setButton3Enabled(false);
    }
