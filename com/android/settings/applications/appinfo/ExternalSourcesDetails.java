...
public class ExternalSourcesDetails extends AppInfoWithHeader implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.external_sources_details);
    ...
    public static CharSequence getPreferenceSummary(Context context, ApplicationsState.AppEntry appEntry) {
        ...
        if ((userRestrictionSource & 1) != 0) {
            return context.getString(C0444R.string.disabled_by_admin);
        }
        if (userRestrictionSource != 0) {
            return context.getString(C0444R.string.disabled);
        }
        ...
        return context.getString(appStateInstallAppsBridge.createInstallAppsStateFor(applicationInfo.packageName, applicationInfo.uid).canInstallApps() ? C0444R.string.app_permission_summary_allowed : C0444R.string.app_permission_summary_not_allowed);
    }
    ...
    public boolean refreshUi() {
        ...
        if (this.mUserManager.hasBaseUserRestriction("no_install_unknown_sources", UserHandle.of(UserHandle.myUserId()))) {
            ...
            this.mSwitchPref.setSummary((int) C0444R.string.disabled);
