...
public class UsageAccessDetails extends AppInfoWithHeader implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.app_ops_permissions_details);
        ...
        getPreferenceScreen().setTitle((int) C0444R.string.usage_access);
        this.mSwitchPref.setTitle((int) C0444R.string.permit_usage_access);
        this.mUsageDesc.setTitle((int) C0444R.string.usage_access_description);
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        if (!(this.mUsageState == null || ((Boolean) obj).booleanValue() == this.mUsageState.isPermissible())) {
            if (this.mUsageState.isPermissible() && this.mDpm.isProfileOwnerApp(this.mPackageName)) {
                new AlertDialog.Builder(getContext()).setIcon(17302405).setTitle(17039380).setMessage((CharSequence) this.mDpm.getString("Settings.WORK_PROFILE_DISABLE_USAGE_ACCESS_WARNING", new UsageAccessDetails$$ExternalSyntheticLambda0(this))).setPositiveButton((int) C0444R.string.okay, (DialogInterface.OnClickListener) null).show();
            }
    ...
    public /* synthetic */ String lambda$onPreferenceChange$0() throws Exception {
        return getString(C0444R.string.work_profile_usage_access_warning);
    }
