...
public class AppStorageSettings extends AppInfoWithHeader implements View.OnClickListener, DialogInterface.OnClickListener, LoaderManager.LoaderCallbacks<StorageStatsSource.AppStorageStats> {
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.app_storage_settings);
        setupViews();
        initMoveDialog();
    }
    ...
    private void setupViews() {
        ...
        Button button2 = (Button) layoutPreference.findViewById(C0444R.C0448id.button);
        this.mClearUriButton = button2;
        button2.setText(C0444R.string.clear_uri_btn_text);
    ...
    private void initDataButtons() {
        ...
        if ((z2 || !z3) && z) {
            if (z2) {
                this.mButtonsPref.setButton1Text(C0444R.string.manage_space_text);
            } else {
                this.mButtonsPref.setButton1Text(C0444R.string.clear_user_data_text);
            }
            this.mButtonsPref.setButton1Icon(C0444R.C0447drawable.ic_settings_delete).setButton1OnClickListener(new AppStorageSettings$$ExternalSyntheticLambda0(this));
        } else {
            this.mButtonsPref.setButton1Text(C0444R.string.clear_user_data_text).setButton1Icon(C0444R.C0447drawable.ic_settings_delete).setButton1Enabled(false);
    ...
    private void initMoveDialog() {
        ...
        if (packageCandidateVolumes.size() > 1) {
            ...
            this.mDialogBuilder = new AlertDialog.Builder(getContext()).setTitle((int) C0444R.string.change_storage).setSingleChoiceItems(charSequenceArr, i, (DialogInterface.OnClickListener) this).setNegativeButton((int) C0444R.string.cancel, (DialogInterface.OnClickListener) null);
            return;
        }
    ...
    public void initiateClearUserData() {
        ...
        this.mButtonsPref.setButton1Text(C0444R.string.recompute_size);
    }
    ...
    public void processClearMsg(Message message) {
        int i = message.arg1;
        String str = this.mAppEntry.info.packageName;
        this.mButtonsPref.setButton1Text(C0444R.string.clear_user_data_text).setButton1Icon(C0444R.C0447drawable.ic_settings_delete);
        if (i == 1) {
            String str2 = TAG;
    ...
    private void refreshGrantedUriPermissions() {
        ...
        for (Map.Entry entry : treeMap.entrySet()) {
            ...
            preference.setSummary((CharSequence) getPrefContext().getResources().getQuantityString(C0444R.plurals.uri_permissions_text, i, new Object[]{Integer.valueOf(i)}));
            preference.setSelectable(false);
            preference.setLayoutResource(C0444R.C0450layout.horizontal_preference);
    ...
    public AlertDialog createDialog(int i, int i2) {
        if (i == 1) {
            return new AlertDialog.Builder(getActivity()).setTitle(getActivity().getText(C0444R.string.clear_data_dlg_title)).setMessage(getActivity().getText(C0444R.string.clear_data_dlg_text)).setPositiveButton((int) C0444R.string.dlg_ok, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                    AppStorageSettings.this.initiateClearUserData();
                }
            }).setNegativeButton((int) C0444R.string.dlg_cancel, (DialogInterface.OnClickListener) null).create();
        }
        if (i != 2) {
            return null;
        }
        return new AlertDialog.Builder(getActivity()).setTitle(getActivity().getText(C0444R.string.clear_user_data_text)).setMessage(getActivity().getText(C0444R.string.clear_failed_dlg_text)).setNeutralButton(C0444R.string.dlg_ok, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
