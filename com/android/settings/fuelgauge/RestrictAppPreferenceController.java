...
public class RestrictAppPreferenceController extends BasePreferenceController {
    ...
    public void updateState(Preference preference) {
        ...
        preference.setSummary((CharSequence) this.mContext.getResources().getQuantityString(C0444R.plurals.restricted_app_summary, size, new Object[]{Integer.valueOf(size)}));
    }
