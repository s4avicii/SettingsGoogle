...
public class BatterySaverController extends BasePreferenceController implements LifecycleObserver, OnStart, OnStop, BatterySaverReceiver.BatterySaverListener {
    ...
    public CharSequence getSummary() {
        if (this.mPowerManager.isPowerSaveMode()) {
            return this.mContext.getString(C0444R.string.battery_saver_on_summary);
        }
        ContentResolver contentResolver = this.mContext.getContentResolver();
        if (Settings.Global.getInt(contentResolver, "automatic_power_save_mode", 0) != 0) {
            return this.mContext.getString(C0444R.string.battery_saver_pref_auto_routine_summary);
        }
        int i = Settings.Global.getInt(contentResolver, "low_power_trigger_level", 0);
        if (i == 0) {
            return this.mContext.getString(C0444R.string.battery_saver_off_summary);
        }
        return this.mContext.getString(C0444R.string.battery_saver_off_scheduled_summary, new Object[]{Utils.formatPercentage(i)});
    }
