...
public class BatteryMeterView extends ImageView {
    ...
    public BatteryMeterView(Context context, AttributeSet attributeSet, int i) {
        ...
        int color = context.getColor(C0444R.C0446color.meter_background_color);
        this.mAccentColorFilter = Utils.getAlphaInvariantColorFilterForColor(Utils.getColorAttrDefaultColor(context, 16843829));
        this.mErrorColorFilter = Utils.getAlphaInvariantColorFilterForColor(context.getColor(C0444R.C0446color.battery_icon_color_error));
    ...
    public static class BatteryMeterDrawable extends ThemedBatteryDrawable {
        ...
        public BatteryMeterDrawable(Context context, int i) {
            super(context, i);
            this.mIntrinsicWidth = context.getResources().getDimensionPixelSize(C0444R.dimen.battery_meter_width);
            this.mIntrinsicHeight = context.getResources().getDimensionPixelSize(C0444R.dimen.battery_meter_height);
        }
