...
public class RestrictedAppDetails extends DashboardFragment implements BatteryTipPreferenceController.BatteryTipListener {
    ...
    public int getHelpResource() {
        return C0444R.string.help_uri_restricted_apps;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.restricted_apps_detail;
    }
    ...
    public static void startRestrictedAppDetails(InstrumentedPreferenceFragment instrumentedPreferenceFragment, List<AppInfo> list) {
        ...
        new SubSettingLauncher(instrumentedPreferenceFragment.getContext()).setDestination(RestrictedAppDetails.class.getName()).setArguments(bundle).setTitleRes(C0444R.string.restricted_app_title).setSourceMetricsCategory(instrumentedPreferenceFragment.getMetricsCategory()).launch();
    }
    ...
    public void refreshUi() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            try {
                ...
                if (j != -1) {
                    appCheckBoxPreference.setSummary((CharSequence) getString(C0444R.string.restricted_app_time_summary, StringUtil.formatRelativeTime(prefContext, (double) (currentTimeMillis - j), false)));
                }
