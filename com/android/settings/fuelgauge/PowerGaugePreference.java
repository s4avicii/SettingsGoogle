...
public class PowerGaugePreference extends AppPreference {
    ...
    private PowerGaugePreference(Context context, AttributeSet attributeSet, Drawable drawable, CharSequence charSequence, BatteryEntry batteryEntry) {
        ...
        setWidgetLayoutResource(C0444R.C0450layout.preference_widget_summary);
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        TextView textView = (TextView) preferenceViewHolder.findViewById(C0444R.C0448id.widget_summary);
        textView.setText(this.mProgress);
        if (this.mShowAnomalyIcon) {
            textView.setCompoundDrawablesRelativeWithIntrinsicBounds(C0444R.C0447drawable.ic_warning_24dp, 0, 0, 0);
        } else {
