...
public class PowerUsageSummary extends PowerUsageBase implements BatteryTipPreferenceController.BatteryTipListener {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.power_usage_summary);
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_battery;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.power_usage_summary;
    }
    ...
    public void initPreference() {
        ...
        if (this.mPowerFeatureProvider.isChartGraphEnabled(getContext())) {
            str = getString(C0444R.string.advanced_battery_preference_summary_with_hours);
        } else {
            str = getString(C0444R.string.advanced_battery_preference_summary);
        }
