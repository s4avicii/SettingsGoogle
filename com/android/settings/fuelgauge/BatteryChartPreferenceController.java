...
public class BatteryChartPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, LifecycleObserver, OnCreate, OnDestroy, OnSaveInstanceState, BatteryChartView.OnSelectListener, OnResume, ExpandDividerPreference.OnExpandListener {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mAppListPrefGroup.setTitle((CharSequence) this.mPrefContext.getString(C0444R.string.battery_app_usage_for_past_24));
    ...
    private String getSlotInformation(boolean z, String str) {
        if (str == null) {
            if (z) {
                return this.mPrefContext.getString(C0444R.string.battery_app_usage_for_past_24);
            }
            return this.mPrefContext.getString(C0444R.string.battery_system_usage_for_past_24);
        } else if (z) {
            return this.mPrefContext.getString(C0444R.string.battery_app_usage_for, new Object[]{str});
        } else {
            return this.mPrefContext.getString(C0444R.string.battery_system_usage_for, new Object[]{str});
        }
    }
    ...
    private String buildUsageTimeInfo(long j, boolean z) {
        if (j < 60000) {
            return this.mPrefContext.getString(z ? C0444R.string.battery_usage_background_less_than_one_minute : C0444R.string.battery_usage_total_less_than_one_minute);
        }
        return this.mPrefContext.getString(z ? C0444R.string.battery_usage_for_background_time : C0444R.string.battery_usage_for_total_time, new Object[]{StringUtil.formatElapsedTime(this.mPrefContext, (double) j, false, false)});
    }
    ...
    private void addFooterPreferenceIfNeeded(boolean z) {
        ...
        if (!this.mIsFooterPrefAdded && (footerPreference = this.mFooterPreference) != null) {
            ...
            footerPreference.setTitle((CharSequence) this.mPrefContext.getString(z ? C0444R.string.battery_usage_screen_footer : C0444R.string.battery_usage_screen_footer_empty));
    ...
    private final class LoadAllItemsInfoTask extends AsyncTask<Void, Void, Map<Integer, List<BatteryDiffEntry>>> {
        ...
        public Map<Integer, List<BatteryDiffEntry>> doInBackground(Void... voidArr) {
            ...
            for (List<BatteryDiffEntry> forEach : indexedUsageMap.values()) {
                forEach.forEach(C0924xd2dd8c4.INSTANCE);
            }
        ...
        public void onPostExecute(Map<Integer, List<BatteryDiffEntry>> map) {
            ...
            if (map != null) {
                BatteryChartPreferenceController.this.mHandler.post(new C0923xd2dd8c3(this, map));
            }
        }
