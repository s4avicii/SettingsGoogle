...
public class BatteryHistoryPreference extends Preference {
    ...
    public BatteryHistoryPreference(Context context, AttributeSet attributeSet) {
        ...
        setLayoutResource(this.mIsChartGraphEnabled ? C0444R.C0450layout.battery_chart_graph : C0444R.C0450layout.battery_usage_graph);
        setSelectable(false);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (this.mBatteryInfo != null) {
            if (this.mIsChartGraphEnabled) {
                BatteryChartView batteryChartView = (BatteryChartView) preferenceViewHolder.findViewById(C0444R.C0448id.battery_chart);
                this.mBatteryChartView = batteryChartView;
                batteryChartView.setCompanionTextView((TextView) preferenceViewHolder.findViewById(C0444R.C0448id.companion_text));
                ...
                ((TextView) preferenceViewHolder.findViewById(C0444R.C0448id.charge)).setText(this.mBatteryInfo.batteryPercentString);
                TextView textView = (TextView) preferenceViewHolder.findViewById(C0444R.C0448id.bottom_summary);
                ...
                UsageView usageView = (UsageView) preferenceViewHolder.findViewById(C0444R.C0448id.battery_usage);
                usageView.findViewById(C0444R.C0448id.label_group).setAlpha(0.7f);
