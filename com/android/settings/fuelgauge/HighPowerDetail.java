...
public class HighPowerDetail extends InstrumentedDialogFragment implements DialogInterface.OnClickListener, View.OnClickListener {
    ...
    public Checkable setup(View view, boolean z) {
        ((TextView) view.findViewById(16908310)).setText(z ? C0444R.string.ignore_optimizations_on : C0444R.string.ignore_optimizations_off);
        ((TextView) view.findViewById(16908304)).setText(z ? C0444R.string.ignore_optimizations_on_desc : C0444R.string.ignore_optimizations_off_desc);
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        AlertDialog.Builder view = new AlertDialog.Builder(getContext()).setTitle(this.mLabel).setNegativeButton((int) C0444R.string.cancel, (DialogInterface.OnClickListener) null).setView((int) C0444R.C0450layout.ignore_optimizations_content);
        if (!this.mBackend.isSysAllowlisted(this.mPackageName)) {
            view.setPositiveButton((int) C0444R.string.done, (DialogInterface.OnClickListener) this);
        }
        return view.create();
    }
    ...
    public void onStart() {
        super.onStart();
        this.mOptionOn = setup(getDialog().findViewById(C0444R.C0448id.ignore_on), true);
        this.mOptionOff = setup(getDialog().findViewById(C0444R.C0448id.ignore_off), false);
        updateViews();
    }
    ...
    static CharSequence getSummary(Context context, PowerAllowlistBackend powerAllowlistBackend, String str) {
        return context.getString((powerAllowlistBackend.isSysAllowlisted(str) || powerAllowlistBackend.isDefaultActiveApp(str)) ? C0444R.string.high_power_system : powerAllowlistBackend.isAllowlisted(str) ? C0444R.string.high_power_on : C0444R.string.high_power_off);
    }
