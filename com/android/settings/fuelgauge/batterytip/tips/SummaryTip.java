...
public class SummaryTip extends BatteryTip {
    ...
    public int getIconTintColorId() {
        return C0444R.C0446color.battery_good_color_light;
    }
    ...
    public CharSequence getTitle(Context context) {
        return context.getString(C0444R.string.battery_tip_summary_title);
    }

    public CharSequence getSummary(Context context) {
        return context.getString(C0444R.string.battery_tip_summary_summary);
    }
