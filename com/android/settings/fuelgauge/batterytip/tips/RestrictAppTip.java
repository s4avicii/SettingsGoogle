...
public class RestrictAppTip extends BatteryTip {
    ...
    public CharSequence getTitle(Context context) {
        ...
        if (this.mState == 1) {
            return resources.getQuantityString(C0444R.plurals.battery_tip_restrict_handled_title, size, new Object[]{applicationLabel, Integer.valueOf(size)});
        }
        return resources.getQuantityString(C0444R.plurals.battery_tip_restrict_title, size, new Object[]{Integer.valueOf(size)});
    }

    public CharSequence getSummary(Context context) {
        int size = this.mRestrictAppList.size();
        return context.getResources().getQuantityString(this.mState == 1 ? C0444R.plurals.battery_tip_restrict_handled_summary : C0444R.plurals.battery_tip_restrict_summary, size, new Object[]{size > 0 ? Utils.getApplicationLabel(context, this.mRestrictAppList.get(0).packageName) : "", Integer.valueOf(size)});
    }

    public int getIconId() {
        return this.mState == 1 ? C0444R.C0447drawable.ic_perm_device_information_green_24dp : C0444R.C0447drawable.ic_battery_alert_24dp;
    }
