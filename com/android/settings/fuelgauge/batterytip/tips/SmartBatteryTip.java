...
public class SmartBatteryTip extends BatteryTip {
    ...
    public int getIconId() {
        return C0444R.C0447drawable.ic_perm_device_information_red_24dp;
    }
    ...
    public CharSequence getTitle(Context context) {
        return context.getString(C0444R.string.battery_tip_smart_battery_title);
    }

    public CharSequence getSummary(Context context) {
        return context.getString(C0444R.string.battery_tip_smart_battery_summary);
    }
