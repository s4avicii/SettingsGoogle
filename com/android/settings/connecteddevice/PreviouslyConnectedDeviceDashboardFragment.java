...
public class PreviouslyConnectedDeviceDashboardFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.previously_connected_devices);
    BluetoothAdapter mBluetoothAdapter;

    public int getHelpResource() {
        return C0444R.string.help_url_previously_connected_devices;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.previously_connected_devices;
    }
