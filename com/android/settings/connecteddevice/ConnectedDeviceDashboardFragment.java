...
public class ConnectedDeviceDashboardFragment extends DashboardFragment {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.connected_devices);
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.connected_devices;
    }
    ...
    public void onAttach(Context context) {
        ...
        ((SlicePreferenceController) use(SlicePreferenceController.class)).setSliceUri(z2 ? Uri.parse(getString(C0444R.string.config_nearby_devices_slice_uri)) : null);
