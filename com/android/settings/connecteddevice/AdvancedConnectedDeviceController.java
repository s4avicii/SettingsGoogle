...
public class AdvancedConnectedDeviceController extends BasePreferenceController {
    ...
    static int getConnectedDevicesSummaryResourceId(NfcPreferenceController nfcPreferenceController, boolean z, boolean z2) {
        return z2 ? nfcPreferenceController.isAvailable() ? z ? C0444R.string.connected_devices_dashboard_android_auto_summary : C0444R.string.connected_devices_dashboard_android_auto_no_driving_mode_summary : z ? C0444R.string.connected_devices_dashboard_android_auto_no_nfc_summary : C0444R.string.connected_devices_dashboard_android_auto_no_nfc_no_driving_mode : nfcPreferenceController.isAvailable() ? z ? C0444R.string.connected_devices_dashboard_summary : C0444R.string.connected_devices_dashboard_no_driving_mode_summary : z ? C0444R.string.connected_devices_dashboard_no_nfc_summary : C0444R.string.connected_devices_dashboard_no_driving_mode_no_nfc_summary;
    }
}
