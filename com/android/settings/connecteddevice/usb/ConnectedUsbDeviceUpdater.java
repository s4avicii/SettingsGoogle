...
public class ConnectedUsbDeviceUpdater {
    ...
    public static int getSummary(long j, int i) {
        return i != 1 ? i != 2 ? C0444R.string.usb_summary_charging_only : j == 4 ? C0444R.string.usb_summary_file_transfers : j == 32 ? C0444R.string.usb_summary_tether : j == 16 ? C0444R.string.usb_summary_photo_transfers : j == 8 ? C0444R.string.usb_summary_MIDI : C0444R.string.usb_summary_charging_only : j == 4 ? C0444R.string.usb_summary_file_transfers_power : j == 32 ? C0444R.string.usb_summary_tether_power : j == 16 ? C0444R.string.usb_summary_photo_transfers_power : j == 8 ? C0444R.string.usb_summary_MIDI_power : C0444R.string.usb_summary_power_only;
    }
    ...
    public void initUsbPreference(Context context) {
        ...
        restrictedPreference.setTitle((int) C0444R.string.usb_pref);
        this.mUsbPreference.setIcon((int) C0444R.C0447drawable.ic_usb);
    ...
    public /* synthetic */ boolean lambda$initUsbPreference$1(Preference preference) {
        ...
        new SubSettingLauncher(this.mFragment.getContext()).setDestination(UsbDetailsFragment.class.getName()).setTitleRes(C0444R.string.usb_preference).setSourceMetricsCategory(this.mFragment.getMetricsCategory()).launch();
        return true;
    }
