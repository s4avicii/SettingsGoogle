...
public class UsbDefaultFragment extends RadioButtonPickerFragment {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.usb_default_fragment;
    }
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        getPreferenceScreen().addPreference(new FooterPreference.Builder(getActivity()).setTitle((int) C0444R.string.usb_default_info).build());
    }
