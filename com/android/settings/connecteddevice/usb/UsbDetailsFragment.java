...
public class UsbDetailsFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.usb_details_fragment) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.usb_details_fragment;
    }
