...
public class AdaptiveSleepBatterySaverPreferenceController {
    ...
    private void initializePreference() {
        if (this.mPreference == null) {
            ...
            bannerMessagePreference.setTitle((int) C0444R.string.ambient_camera_summary_battery_saver_on);
            this.mPreference.setPositiveButtonText((int) C0444R.string.disable_text);
            this.mPreference.setPositiveButtonOnClickListener(new C0869x9778124f(this));
        }
    }
