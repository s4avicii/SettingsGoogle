...
public class TwilightLocationPreferenceController extends BasePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        bannerMessagePreference.setPositiveButtonText((int) C0444R.string.twilight_mode_launch_location).setPositiveButtonOnClickListener(new TwilightLocationPreferenceController$$ExternalSyntheticLambda0(this, bannerMessagePreference));
    }
