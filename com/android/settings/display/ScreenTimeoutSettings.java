...
public class ScreenTimeoutSettings extends RadioButtonPickerFragment implements HelpResourceProvider {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.screen_timeout_settings) {
        public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean z) {
            ...
            searchIndexableRaw.title = resources.getString(C0444R.string.adaptive_sleep_title);
            searchIndexableRaw.key = "adaptive_sleep";
            searchIndexableRaw.keywords = resources.getString(C0444R.string.adaptive_sleep_title);
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_adaptive_sleep;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.screen_timeout_settings;
    }
    ...
    public void onAttach(Context context) {
        ...
        this.mInitialEntries = getResources().getStringArray(C0444R.array.screen_timeout_entries);
        this.mInitialValues = getResources().getStringArray(C0444R.array.screen_timeout_values);
        ...
        footerPreference.setIcon((int) C0444R.C0447drawable.ic_privacy_shield_24dp);
        this.mPrivacyPreference.setTitle((int) C0444R.string.adaptive_sleep_privacy);
        this.mPrivacyPreference.setSelectable(false);
        this.mPrivacyPreference.setLayoutResource(C0444R.C0450layout.preference_footer);
    ...
    public void setupDisabledFooterPreference() {
        String string = this.mDevicePolicyManager.getString("Settings.OTHER_OPTIONS_DISABLED_BY_ADMIN", new ScreenTimeoutSettings$$ExternalSyntheticLambda1(this));
        String string2 = getResources().getString(C0444R.string.admin_more_details);
        SpannableString spannableString = new SpannableString(string + System.lineSeparator() + System.lineSeparator() + string2);
        C08912 r3 = new ClickableSpan() {
        ...
        this.mDisableOptionsPreference.setIcon((int) C0444R.C0447drawable.ic_info_outline_24dp);
    ...
    public /* synthetic */ String lambda$setupDisabledFooterPreference$1() throws Exception {
        return getResources().getString(C0444R.string.admin_disabled_other_options);
    }
