...
public class SmartAutoRotatePreferenceFragment extends DashboardFragment {
    ...
    public static final Indexable$SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.auto_rotate_settings);
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.auto_rotate_settings;
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (findPreference != null) {
            findPreference.setTitle((CharSequence) Html.fromHtml(getString(C0444R.string.smart_rotate_text_headline), 63));
    ...
    public void createHeader(SettingsActivity settingsActivity) {
        if (SmartAutoRotateController.isRotationResolverServiceAvailable(settingsActivity)) {
            ...
            switchBar.setTitle(getContext().getString(C0444R.string.auto_rotate_settings_primary_switch_title));
            switchBar.show();
