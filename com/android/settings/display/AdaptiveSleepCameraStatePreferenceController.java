...
public class AdaptiveSleepCameraStatePreferenceController {
    ...
    public AdaptiveSleepCameraStatePreferenceController(Context context) {
        ...
        instance.addSensorPrivacyListener(2, new C0870x31edb191(this));
    ...
    private void initializePreference() {
        if (this.mPreference == null) {
            ...
            bannerMessagePreference.setTitle((int) C0444R.string.auto_rotate_camera_lock_title);
            this.mPreference.setSummary((int) C0444R.string.adaptive_sleep_camera_lock_summary);
            this.mPreference.setPositiveButtonText((int) C0444R.string.allow);
            this.mPreference.setPositiveButtonOnClickListener(new C0871x31edb192(this));
        }
    }
