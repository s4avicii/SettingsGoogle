...
public class NightDisplaySettings extends DashboardFragment implements NightDisplayListener.Callback {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.night_display_settings) {
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_night_display;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.night_display_settings;
    }
