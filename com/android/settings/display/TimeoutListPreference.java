...
public class TimeoutListPreference extends RestrictedListPreference {
    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder, DialogInterface.OnClickListener onClickListener) {
        ...
        if (this.mAdmin != null) {
            builder.setView((int) C0444R.C0450layout.admin_disabled_other_options_footer);
        } else {
    ...
    public void onDialogCreated(Dialog dialog) {
        ...
        dialog.create();
        if (this.mAdmin != null) {
            dialog.findViewById(C0444R.C0448id.admin_disabled_other_options).findViewById(C0444R.C0448id.admin_more_details_link).setOnClickListener(new View.OnClickListener() {
