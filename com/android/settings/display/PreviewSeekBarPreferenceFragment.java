...
public abstract class PreviewSeekBarPreferenceFragment extends SettingsPreferenceFragment {
    ...
    private class onPreviewSeekBarChangeListener implements SeekBar.OnSeekBarChangeListener {
        ...
        private onPreviewSeekBarChangeListener() {
            this.mCommit = new C0887x84d1f24b(this);
        }
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            ...
            if (this.mIsChanged) {
                if (PreviewSeekBarPreferenceFragment.this.mPreviewPagerAdapter.isAnimating()) {
                    PreviewSeekBarPreferenceFragment.this.mPreviewPagerAdapter.setAnimationEndAction(new C0888x84d1f24c(this));
                } else {
                    commitOnNextFrame();
                }
            }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mLabel = (TextView) inflate.findViewById(C0444R.C0448id.current_label);
        int max = Math.max(1, this.mEntries.length - 1);
        LabeledSeekBar labeledSeekBar = (LabeledSeekBar) inflate.findViewById(C0444R.C0448id.seek_bar);
        this.mSeekBar = labeledSeekBar;
        labeledSeekBar.setLabels(this.mEntries);
        this.mSeekBar.setMax(max);
        View findViewById = inflate.findViewById(C0444R.C0448id.smaller);
        ...
        View findViewById2 = inflate.findViewById(C0444R.C0448id.larger);
        ...
        this.mPreviewPager = (ViewPager) inflate.findViewById(C0444R.C0448id.preview_pager);
        ...
        DotsPageIndicator dotsPageIndicator = (DotsPageIndicator) inflate.findViewById(C0444R.C0448id.page_indicator);
    ...
    public void setPagerIndicatorContentDescription(int i) {
        this.mPageIndicator.setContentDescription(getString(C0444R.string.preview_page_indicator_content_description, Integer.valueOf(i + 1), Integer.valueOf(getPreviewSampleResIds().length)));
    }
}
