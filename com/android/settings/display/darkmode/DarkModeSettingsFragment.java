...
public class DarkModeSettingsFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.dark_mode_settings) {
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_dark_theme;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.dark_mode_settings;
    }
