...
public class SmartAutoRotateCameraStateController extends BasePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        ((BannerMessagePreference) findPreference).setPositiveButtonText((int) C0444R.string.allow).setPositiveButtonOnClickListener(new SmartAutoRotateCameraStateController$$ExternalSyntheticLambda1(this));
    }
