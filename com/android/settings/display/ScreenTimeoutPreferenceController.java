...
public class ScreenTimeoutPreferenceController extends BasePreferenceController {
    ...
    public ScreenTimeoutPreferenceController(Context context, String str) {
        super(context, str);
        this.mTimeoutEntries = context.getResources().getStringArray(C0444R.array.screen_timeout_entries);
        this.mTimeoutValues = context.getResources().getStringArray(C0444R.array.screen_timeout_values);
    }
    ...
    public void updateState(Preference preference) {
        ...
        if (preferenceDisablingAdmin != null) {
            ...
            preference.setSummary((CharSequence) ((DevicePolicyManager) this.mContext.getSystemService(DevicePolicyManager.class)).getString("Settings.DISABLED_BY_IT_ADMIN_TITLE", new ScreenTimeoutPreferenceController$$ExternalSyntheticLambda0(this)));
    ...
    private CharSequence getTimeoutSummary(long j) {
        ...
        return this.mContext.getString(C0444R.string.screen_timeout_summary, new Object[]{timeoutDescription});
    }
