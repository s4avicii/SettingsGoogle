...
public class ScreenZoomSettings extends PreviewSeekBarPreferenceFragment {
    ...
    public int getActivityLayoutResId() {
        return C0444R.C0450layout.screen_zoom_activity;
    }

    public int getHelpResource() {
        return C0444R.string.help_url_display_size;
    }
    ...
    public int[] getPreviewSampleResIds() {
        if (getContext().getResources().getBoolean(C0444R.bool.config_enable_extra_screen_zoom_preview)) {
            return new int[]{C0444R.C0450layout.screen_zoom_preview_1, C0444R.C0450layout.screen_zoom_preview_2, C0444R.C0450layout.screen_zoom_preview_settings};
        }
        return new int[]{C0444R.C0450layout.screen_zoom_preview_1};
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        getActivity().setTitle(C0444R.string.screen_zoom_title);
    }
