...
public class VrDisplayPreferencePicker extends RadioButtonPickerFragment {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.vr_display_settings;
    }
    ...
    public List<VrCandidateInfo> getCandidates() {
        ...
        arrayList.add(new VrCandidateInfo(context, 0, C0444R.string.display_vr_pref_low_persistence));
        arrayList.add(new VrCandidateInfo(context, 1, C0444R.string.display_vr_pref_off));
        return arrayList;
    }
