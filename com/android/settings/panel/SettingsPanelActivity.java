...
public class SettingsPanelActivity extends FragmentActivity {
    ...
    private void createOrUpdatePanel(boolean z) {
        ...
        Fragment findFragmentById = supportFragmentManager.findFragmentById(C0444R.C0448id.main_content);
        if (z || findFragmentById == null || !(findFragmentById instanceof PanelFragment)) {
            ...
            supportFragmentManager.beginTransaction().add((int) C0444R.C0448id.main_content, (Fragment) this.mPanelFragment).commit();
            return;
        }
