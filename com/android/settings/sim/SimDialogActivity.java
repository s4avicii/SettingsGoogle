...
public class SimDialogActivity extends FragmentActivity {
    ...
    private SimDialogFragment createFragment(int i) {
        ...
        if (i == 1) {
            return SimListDialogFragment.newInstance(i, C0444R.string.select_sim_for_calls, true, false);
        }
        if (i == 2) {
            return SimListDialogFragment.newInstance(i, C0444R.string.select_sim_for_sms, true, false);
        }
        if (i != 3) {
            if (i == 4) {
                return SimListDialogFragment.newInstance(i, C0444R.string.select_sim_for_sms, false, false);
            }
    ...
    private SimDialogFragment getDataPickDialogFramgent() {
        if (SubscriptionManager.getDefaultDataSubscriptionId() == -1) {
            return SimListDialogFragment.newInstance(0, C0444R.string.select_sim_for_data, false, true);
        }
    ...
    private void setDefaultDataSubId(int i) {
        ...
        if (i != -1) {
            ...
            Toast.makeText(this, C0444R.string.data_switch_started, 1).show();
        }
    }
