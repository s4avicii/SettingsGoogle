...
public class SmartForwardingFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, Instrumentable {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        setPreferencesFromResource(C0444R.xml.smart_forwarding_switch, str);
        getActivity().getActionBar().setTitle(getResources().getString(C0444R.string.smart_forwarding_title));
    ...
    private void switchToMDNFragment() {
        getActivity().getSupportFragmentManager().beginTransaction().replace(C0444R.C0448id.content_frame, new MDNHandlerFragment()).commit();
    }
