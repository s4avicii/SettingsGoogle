...
public class SmartForwardingActivity extends SettingsBaseActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        getSupportFragmentManager().beginTransaction().replace(C0444R.C0448id.content_frame, new SmartForwardingFragment()).commit();
    }
    ...
    public void enableSmartForwarding(String[] strArr) {
        ...
        progressDialog.setTitle(C0444R.string.smart_forwarding_ongoing_title);
        progressDialog.setIndeterminate(true);
        progressDialog.setMessage(getText(C0444R.string.smart_forwarding_ongoing_text));
        ...
        Futures.addCallback(this.service.submit(new EnableSmartForwardingTask(this, strArr)), new FutureCallback<EnableSmartForwardingTask.FeatureResult>() {
            public void onSuccess(EnableSmartForwardingTask.FeatureResult featureResult) {
                ...
                if (featureResult.getResult()) {
                    ...
                    SmartForwardingFragment smartForwardingFragment = (SmartForwardingFragment) SmartForwardingActivity.this.getSupportFragmentManager().findFragmentById(C0444R.C0448id.content_frame);
            ...
            public void onFailure(Throwable th) {
                ...
                progressDialog.dismiss();
                new AlertDialog.Builder(SmartForwardingActivity.this).setTitle(C0444R.string.smart_forwarding_failed_title).setMessage(C0444R.string.smart_forwarding_failed_text).setPositiveButton(C0444R.string.smart_forwarding_missing_alert_dialog_text, SmartForwardingActivity$1$$ExternalSyntheticLambda0.INSTANCE).create().show();
            }
