...
public class SwitchToEsimConfirmDialogActivity extends SubscriptionActionDialogActivity implements SidecarFragment.Listener, ConfirmDialogFragment.OnConfirmListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (subscriptionInfo == null) {
            ...
            ConfirmDialogFragment.show(this, ConfirmDialogFragment.OnConfirmListener.class, 1, getString(C0444R.string.switch_sim_dialog_title, new Object[]{subscriptionInfo.getDisplayName()}), getString(C0444R.string.switch_sim_dialog_text, new Object[]{this.mSubToEnabled.getDisplayName()}), getString(C0444R.string.okay), getString(C0444R.string.cancel));
        }
    }
    ...
    public void onConfirm(int i, boolean z, int i2) {
        if (!z) {
            AlertDialogFragment.show(this, getString(C0444R.string.switch_sim_dialog_no_switch_title), getString(C0444R.string.switch_sim_dialog_no_switch_text));
            return;
        }
        ...
        showProgressDialog(getString(C0444R.string.sim_action_switch_sub_dialog_progress, new Object[]{this.mSubToEnabled.getDisplayName()}));
    }
}
