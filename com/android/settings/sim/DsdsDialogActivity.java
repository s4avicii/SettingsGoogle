...
public class DsdsDialogActivity extends SubscriptionActionDialogActivity implements SidecarFragment.Listener, ConfirmDialogFragment.OnConfirmListener {
    ...
    private void showEnableDsdsConfirmDialog() {
        ConfirmDialogFragment.show(this, ConfirmDialogFragment.OnConfirmListener.class, 1, getString(C0444R.string.sim_action_enable_dsds_title), getString(C0444R.string.sim_action_enable_dsds_text), getString(C0444R.string.sim_action_yes), getString(C0444R.string.sim_action_no_thanks));
    }

    private void showRebootConfirmDialog() {
        ConfirmDialogFragment.show(this, ConfirmDialogFragment.OnConfirmListener.class, 2, getString(C0444R.string.sim_action_restart_title), getString(C0444R.string.sim_action_enable_dsds_text), getString(C0444R.string.sim_action_reboot), getString(C0444R.string.cancel));
    }
