...
public class TextToSpeechSettings extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, GearPreference.OnGearClickListener {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.tts_settings);
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.tts_settings);
    ...
    private void updateDefaultLocalePref(Intent intent) {
        ...
        charSequenceArr[0] = getActivity().getString(C0444R.string.tts_lang_use_system);
        charSequenceArr2[0] = "";
    ...
    private void setLocalePreference(int i) {
        if (i < 0) {
            ...
            this.mLocalePreference.setSummary((int) C0444R.string.tts_lang_not_selected);
            return;
        }
    ...
    private String getDefaultSampleString() {
        ...
        if (!(textToSpeech == null || textToSpeech.getLanguage() == null)) {
            try {
                ...
                String[] stringArray = getActivity().getResources().getStringArray(C0444R.array.tts_demo_strings);
                String[] stringArray2 = getActivity().getResources().getStringArray(C0444R.array.tts_demo_string_langs);
        ...
        return getString(C0444R.string.tts_default_sample_string);
    }
    ...
    private void displayNetworkAlert() {
        ...
        builder.setTitle(17039380).setMessage((CharSequence) getActivity().getString(C0444R.string.tts_engine_network_required)).setCancelable(false).setPositiveButton(17039370, (DialogInterface.OnClickListener) null);
        builder.create().show();
    }
