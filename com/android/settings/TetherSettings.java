...
public class TetherSettings extends RestrictedSettingsFragment implements DataSaverBackend.Listener {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        public List<SearchIndexableResource> getXmlResourcesToIndex(Context context, boolean z) {
            ...
            searchIndexableResource.xmlResId = C0444R.xml.tether_prefs;
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_tether;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.tether_prefs);
    ...
    public void setTopIntroPreferenceTitle() {
        ...
        if (((WifiManager) this.mContext.getSystemService(WifiManager.class)).isStaApConcurrencySupported()) {
            findPreference.setTitle((int) C0444R.string.tethering_footer_info_sta_ap_concurrency);
        } else {
            findPreference.setTitle((int) C0444R.string.tethering_footer_info);
        }
    }
    ...
    public void onStart() {
        ...
        if (this.mUnavailable) {
            if (!isUiRestrictedByOnlyAdmin()) {
                getEmptyTextView().setText(C0444R.string.tethering_settings_not_available);
            }
            getPreferenceScreen().removeAll();
            return;
        }
        ...
        this.mTm.registerTetheringEventCallback(new TetherSettings$$ExternalSyntheticLambda1(this), this.mTetheringEventCallback);
        ...
        if (ethernetManager != null) {
            ethernetManager.addListener(ethernetListener, new TetherSettings$$ExternalSyntheticLambda0(this));
        }
        updateUsbState();
