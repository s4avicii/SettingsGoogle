...
public abstract class SettingsPreferenceFragment extends InstrumentedPreferenceFragment implements DialogCreatable, HelpResourceProvider {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mPinnedHeaderFrameLayout = (ViewGroup) onCreateView.findViewById(C0444R.C0448id.pinned_header);
    ...
    public void setLoading(boolean z, boolean z2) {
        LoadingViewController.handleLoadingContainer(getView().findViewById(C0444R.C0448id.loading_container), getListView(), !z, z2);
    }
