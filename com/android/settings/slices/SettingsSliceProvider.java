...
public class SettingsSliceProvider extends SliceProvider {
    ...
    public Slice onBindSlice(Uri uri) {
        ...
        try {
            ...
            if (bool == null) {
                ...
                getContext().setTheme(C0444R.style.Theme_SettingsBase);
    ...
    static void grantAllowlistedPackagePermissions(Context context, List<Uri> list) {
        ...
        String[] stringArray = context.getResources().getStringArray(C0444R.array.slice_allowlist_package_names);
    ...
    public boolean isPrivateSlicesNeeded(Uri uri) {
        String string = getContext().getString(C0444R.string.config_non_public_slice_query_uri);
        ...
        if (!z || !TextUtils.equals(str, getContext().getString(C0444R.string.config_settingsintelligence_package_name))) {
            return false;
        }
        return true;
    }
