...
public class SliceBuilderUtils {
    ...
    private static SliceAction getCopyableAction(Context context, SliceData sliceData) {
        return SliceAction.create(getActionIntent(context, "com.android.settings.slice.action.COPY", sliceData), IconCompat.createWithResource(context, C0444R.C0447drawable.ic_content_copy_grey600_24dp), 0, sliceData.getTitle());
    }
    ...
    private static boolean isValidSummary(Context context, CharSequence charSequence) {
        ...
        CharSequence text = context.getText(C0444R.string.summary_placeholder);
        CharSequence text2 = context.getText(C0444R.string.summary_two_lines_placeholder);
    ...
    private static Slice buildUnavailableSlice(Context context, SliceData sliceData) {
        ...
        if (TextUtils.isEmpty(unavailableSliceSubtitle)) {
            unavailableSliceSubtitle = context.getText(C0444R.string.disabled_dependent_setting_summary);
        }
        IconCompat safeIcon = getSafeIcon(context, sliceData);
    ...
    static IconCompat getSafeIcon(Context context, SliceData sliceData) {
        ...
        if (iconResource == 0) {
            iconResource = C0444R.C0447drawable.ic_settings_accent;
        }
        try {
            ...
            return IconCompat.createWithResource(context, C0444R.C0447drawable.ic_settings_accent);
        }
    }
}
