...
public class RingVolumePreferenceController extends VolumeSeekBarPreferenceController {
    ...
    private void updatePreferenceIcon() {
        ...
        if (volumeSeekBarPreference != null) {
            ...
            if (i == 1) {
                this.mMuteIcon = C0444R.C0447drawable.ic_volume_ringer_vibrate;
                volumeSeekBarPreference.showIcon(C0444R.C0447drawable.ic_volume_ringer_vibrate);
            } else if (i == 0) {
                this.mMuteIcon = C0444R.C0447drawable.ic_notifications_off_24dp;
                volumeSeekBarPreference.showIcon(C0444R.C0447drawable.ic_notifications_off_24dp);
            } else {
                volumeSeekBarPreference.showIcon(C0444R.C0447drawable.ic_notifications);
            }
        }
    }

    /* renamed from: com.android.settings.notification.RingVolumePreferenceController$H */
    private final class C1073H extends Handler {
        private C1073H() {
