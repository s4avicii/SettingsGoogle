...
public class VolumeSeekBarPreference extends SeekBarPreference {
    ...
    public VolumeSeekBarPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        setLayoutResource(C0444R.C0450layout.preference_volume_slider);
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        this.mSuppressionTextView = (TextView) preferenceViewHolder.findViewById(C0444R.C0448id.suppression_text);
        init();
    }
    ...
    public void init() {
        if (this.mSeekBar != null) {
            C10841 r0 = new SeekBarVolumizer.Callback() {
    ...
    private Uri getMediaVolumeUri() {
        return Uri.parse("android.resource://" + getContext().getPackageName() + "/" + C0444R.raw.media_volume);
    }
