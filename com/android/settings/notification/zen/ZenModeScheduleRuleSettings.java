...
public class ZenModeScheduleRuleSettings extends ZenModeRuleSettingsBase {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.zen_mode_schedule_rule_settings;
    }
    ...
    public void onCreateInternal() {
        ...
        this.mStart.setTitle((int) C0444R.string.zen_mode_start_time);
        ...
        this.mEnd.setTitle((int) C0444R.string.zen_mode_end_time);
    ...
    public void updateDays() {
        ...
        this.mDays.setSummary((int) C0444R.string.zen_mode_schedule_rule_days_none);
    ...
    private void updateEndSummary() {
        ...
        int i3 = 0;
        if (i >= i2) {
            i3 = C0444R.string.zen_mode_end_time_next_day_summary_format;
        }
    ...
    public void showDaysDialog() {
        this.mDayDialog = new AlertDialog.Builder(this.mContext).setTitle((int) C0444R.string.zen_mode_schedule_rule_days).setView((View) new ZenModeScheduleDaysSelection(this.mContext, this.mSchedule.days) {
            /* access modifiers changed from: protected */
        ...
        }).setPositiveButton((int) C0444R.string.done_button, (DialogInterface.OnClickListener) null).show();
    }
