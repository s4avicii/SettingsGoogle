...
public class ZenModeEventRuleSettings extends ZenModeRuleSettingsBase {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.zen_mode_event_rule_settings;
    }
    ...
    private void reloadCalendar() {
        ...
        arrayList.add(getString(C0444R.string.zen_mode_event_rule_calendar_any));
        String str = null;
    ...
    public void onCreateInternal() {
        ...
        dropDownPreference2.setEntries(new CharSequence[]{getString(C0444R.string.zen_mode_event_rule_reply_any_except_no), getString(C0444R.string.zen_mode_event_rule_reply_yes_or_maybe), getString(C0444R.string.zen_mode_event_rule_reply_yes)});
