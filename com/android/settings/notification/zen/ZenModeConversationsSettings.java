...
public class ZenModeConversationsSettings extends ZenModeSettingsBase {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.zen_mode_conversations_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.zen_mode_conversations_settings;
    }
