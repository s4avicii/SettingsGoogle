...
public class ZenCustomRuleCallsSettings extends ZenCustomRuleSettingsBase {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.zen_mode_custom_rule_calls_settings;
    }
    ...
    public List<AbstractPreferenceController> createPreferenceControllers(Context context) {
        ...
        this.mControllers.add(new ZenRuleRepeatCallersPreferenceController(context, "zen_mode_repeat_callers", getSettingsLifecycle(), context.getResources().getInteger(17694964)));
    ...
    public void updatePreferences() {
        ...
        getPreferenceScreen().findPreference("footer_preference").setTitle((CharSequence) this.mContext.getResources().getString(C0444R.string.zen_mode_custom_calls_footer, new Object[]{this.mRule.getName()}));
    }
}
