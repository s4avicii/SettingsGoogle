...
public class ZenOnboardingActivity extends Activity {
    ...
    /* access modifiers changed from: protected */
    public void setupUI() {
        setContentView(C0444R.C0450layout.zen_onboarding);
        this.mNewSetting = findViewById(C0444R.C0448id.zen_onboarding_new_setting);
        this.mKeepCurrentSetting = findViewById(C0444R.C0448id.zen_onboarding_current_setting);
        this.mNewSettingButton = (RadioButton) findViewById(C0444R.C0448id.zen_onboarding_new_setting_button);
        this.mKeepCurrentSettingButton = (RadioButton) findViewById(C0444R.C0448id.zen_onboarding_current_setting_button);
        C11561 r0 = new View.OnClickListener() {
        ...
        C11572 r1 = new View.OnClickListener() {
            public void onClick(View view) {
