...
public class ZenModeRestrictNotificationsSettings extends ZenModeSettingsBase {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.zen_mode_restrict_notifications_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.zen_mode_restrict_notifications_settings;
    }
