...
public class ZenModeBypassingAppsSettings extends ZenModeSettingsBase {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.zen_mode_bypassing_apps) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.zen_mode_bypassing_apps;
    }
