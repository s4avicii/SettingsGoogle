...
public class ZenModeSliceBuilder {
    ...
    public static Slice getSlice(Context context) {
        ...
        CharSequence text = context.getText(C0444R.string.zen_mode_settings_title);
        CharSequence text2 = context.getText(C0444R.string.zen_mode_slice_subtitle);
