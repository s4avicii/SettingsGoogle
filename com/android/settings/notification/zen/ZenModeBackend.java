...
public class ZenModeBackend {
    ...
    public int getAlarmsTotalSilencePeopleSummary(int i) {
        return i == 4 ? C0444R.string.zen_mode_none_messages : i == 8 ? C0444R.string.zen_mode_none_calls : C0444R.string.zen_mode_from_no_conversations;
    }
    ...
    public int getConversationSummary() {
        ...
        if (priorityConversationSenders != 1) {
            return priorityConversationSenders != 2 ? C0444R.string.zen_mode_from_no_conversations : C0444R.string.zen_mode_from_important_conversations;
        }
        return C0444R.string.zen_mode_from_all_conversations;
    }
    ...
    public int getContactsCallsSummary(ZenPolicy zenPolicy) {
        ...
        if (priorityCallSenders == 1) {
            return C0444R.string.zen_mode_from_anyone;
        }
        if (priorityCallSenders != 2) {
            return priorityCallSenders != 3 ? C0444R.string.zen_mode_none_calls : C0444R.string.zen_mode_from_starred;
        }
        return C0444R.string.zen_mode_from_contacts;
    }
    ...
    public int getContactsMessagesSummary(ZenPolicy zenPolicy) {
        ...
        if (priorityMessageSenders != 2) {
            return priorityMessageSenders != 3 ? C0444R.string.zen_mode_none_messages : C0444R.string.zen_mode_from_starred;
        }
        return C0444R.string.zen_mode_from_contacts;
    }
    ...
    public List<String> getStarredContacts(Cursor cursor) {
        ...
        do {
            ...
            if (string == null) {
                string = this.mContext.getString(C0444R.string.zen_mode_starred_contacts_empty_name);
            }
    ...
    public String getStarredContactsSummary(Context context) {
        ...
        MessageFormat messageFormat = new MessageFormat(this.mContext.getString(C0444R.string.zen_mode_starred_contacts_summary_contacts), Locale.getDefault());
    ...
    public String getContactsNumberSummary(Context context) {
        MessageFormat messageFormat = new MessageFormat(this.mContext.getString(C0444R.string.zen_mode_contacts_count), Locale.getDefault());
        HashMap hashMap = new HashMap();
