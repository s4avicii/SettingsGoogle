...
public class ZenAccessSettings extends EmptyTextSettings implements ZenAccessSettingObserverMixin.Listener {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.zen_access_settings);
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.zen_access_settings;
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        setEmptyText(C0444R.string.zen_access_empty_text);
    }
    ...
    private void reloadList() {
        ...
        while (it.hasNext()) {
            ...
            if (arraySet.contains(str)) {
                ...
                appPreference.setSummary((CharSequence) getString(C0444R.string.zen_access_disabled_package_warning));
            } else {
    ...
    public /* synthetic */ boolean lambda$reloadList$0(String str, ApplicationInfo applicationInfo, Preference preference) {
        AppInfoBase.startAppInfoFragment(ZenAccessDetails.class, getString(C0444R.string.manage_zen_access_title), str, applicationInfo.uid, this, -1, getMetricsCategory());
        return true;
    }

    private int getPreferenceSummary(String str) {
        return ZenAccessController.hasAccess(getContext(), str) ? C0444R.string.app_permission_summary_allowed : C0444R.string.app_permission_summary_not_allowed;
    }
}
