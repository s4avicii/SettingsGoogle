...
public class ZenModeButtonPreferenceController extends AbstractZenModePreferenceController {
    ...
    public void updateState(Preference preference) {
        ...
        if (this.mZenButtonOn == null) {
            this.mZenButtonOn = (Button) ((LayoutPreference) preference).findViewById(C0444R.C0448id.zen_mode_settings_turn_on_button);
            updateZenButtonOnClickListener(preference);
        }
        if (this.mZenButtonOff == null) {
            Button button = (Button) ((LayoutPreference) preference).findViewById(C0444R.C0448id.zen_mode_settings_turn_off_button);
