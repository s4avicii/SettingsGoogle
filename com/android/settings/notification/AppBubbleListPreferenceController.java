...
public class AppBubbleListPreferenceController extends AppConversationListPreferenceController {
    ...
    public int getTitleResId() {
        return this.mAppRow.bubblePreference == 2 ? C0444R.string.bubble_app_setting_selected_conversation_title : C0444R.string.bubble_app_setting_excluded_conversation_title;
    }
    ...
    public static class ConversationPreference extends Preference implements View.OnClickListener {
        ...
        ConversationPreference(Context context) {
            super(context);
            setWidgetLayoutResource(C0444R.C0450layout.bubble_conversation_remove_button);
        }

        public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
            String str;
            super.onBindViewHolder(preferenceViewHolder);
            ImageView imageView = (ImageView) preferenceViewHolder.itemView.findViewById(C0444R.C0448id.button);
            if (this.mOnClickBubbles) {
                str = getContext().getString(C0444R.string.bubble_app_setting_bubble_conversation);
            } else {
                str = getContext().getString(C0444R.string.bubble_app_setting_unbubble_conversation);
            }
