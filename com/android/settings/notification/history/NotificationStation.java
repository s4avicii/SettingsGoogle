...
public class NotificationStation extends SettingsPreferenceFragment {
    ...
    private CharSequence generateRankingExtraText(HistoricalNotificationInfo historicalNotificationInfo) {
        ...
        String string = getString(C0444R.string.notification_log_details_delimiter);
        NotificationListenerService.Ranking ranking = new NotificationListenerService.Ranking();
        NotificationListenerService.RankingMap rankingMap = this.mRanking;
        if (rankingMap != null && rankingMap.getRanking(historicalNotificationInfo.key, ranking)) {
            if (historicalNotificationInfo.active && historicalNotificationInfo.alerted) {
                spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_alerted)));
            }
            spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_channel))).append(string).append(historicalNotificationInfo.channel.toString());
            ...
            if (historicalNotificationInfo.active) {
                spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_importance))).append(string).append(NotificationListenerService.Ranking.importanceToString(ranking.getImportance()));
                if (ranking.getImportanceExplanation() != null) {
                    spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_explanation))).append(string).append(ranking.getImportanceExplanation());
                }
                spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_badge))).append(string).append(Boolean.toString(ranking.canShowBadge()));
            }
        } else if (this.mRanking == null) {
            spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_ranking_null)));
        } else {
            spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_ranking_none)));
        }
    ...
    private CharSequence generateExtraText(StatusBarNotification statusBarNotification, HistoricalNotificationInfo historicalNotificationInfo) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        String string = getString(C0444R.string.notification_log_details_delimiter);
        spannableStringBuilder.append(bold(getString(C0444R.string.notification_log_details_package))).append(string).append(historicalNotificationInfo.pkg).append("\n").append(bold(getString(C0444R.string.notification_log_details_key))).append(string).append(statusBarNotification.getKey());
        spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_icon))).append(string).append(String.valueOf(notification.getSmallIcon()));
        ...
        if (statusBarNotification.isGroup()) {
            spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_group))).append(string).append(String.valueOf(statusBarNotification.getGroupKey()));
            if (notification.isGroupSummary()) {
                spannableStringBuilder.append(bold(getString(C0444R.string.notification_log_details_group_summary)));
            }
        }
        if (notification.publicVersion != null) {
            spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_public_version))).append(string).append(getTitleString(notification.publicVersion));
        }
        if (notification.contentIntent != null) {
            spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_content_intent))).append(string).append(formatPendingIntent(notification.contentIntent));
        }
        if (notification.deleteIntent != null) {
            spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_delete_intent))).append(string).append(formatPendingIntent(notification.deleteIntent));
        }
        if (notification.fullScreenIntent != null) {
            spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_full_screen_intent))).append(string).append(formatPendingIntent(notification.fullScreenIntent));
        }
        Notification.Action[] actionArr = notification.actions;
        if (actionArr != null && actionArr.length > 0) {
            spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_actions)));
            int i = 0;
            while (true) {
                ...
                spannableStringBuilder.append("\n  ").append(String.valueOf(i)).append(' ').append(bold(getString(C0444R.string.notification_log_details_title))).append(string).append(action.title);
                if (action.actionIntent != null) {
                    spannableStringBuilder.append("\n    ").append(bold(getString(C0444R.string.notification_log_details_content_intent))).append(string).append(formatPendingIntent(action.actionIntent));
                }
                if (action.getRemoteInputs() != null) {
                    spannableStringBuilder.append("\n    ").append(bold(getString(C0444R.string.notification_log_details_remoteinput))).append(string).append(String.valueOf(action.getRemoteInputs().length));
                }
                i++;
            }
        }
        if (notification.contentView != null) {
            spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_content_view))).append(string).append(notification.contentView.toString());
        }
        ...
        if (bundle != null && bundle.size() > 0) {
            spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_extras)));
        ...
        spannableStringBuilder.append("\n").append(bold(getString(C0444R.string.notification_log_details_parcel))).append(string).append(String.valueOf(obtain.dataPosition())).append(' ').append(bold(getString(C0444R.string.notification_log_details_ashmem))).append(string).append(String.valueOf(obtain.getOpenAshmemSize())).append("\n");
        return spannableStringBuilder;
    }
    ...
    private static class HistoricalNotificationPreference extends Preference {
        ...
        public HistoricalNotificationPreference(Context context, HistoricalNotificationInfo historicalNotificationInfo, int i) {
            super(context);
            setLayoutResource(C0444R.C0450layout.notification_log_row);
            setOrder(i);
        ...
        public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
            ...
            preferenceViewHolder.findViewById(C0444R.C0448id.timestamp).setOnLongClickListener(new C1108xd404025a(this, preferenceViewHolder));
        }

        /* access modifiers changed from: private */
        public /* synthetic */ boolean lambda$onBindViewHolder$0(PreferenceViewHolder preferenceViewHolder, View view) {
            View findViewById = preferenceViewHolder.findViewById(C0444R.C0448id.extra);
        ...
        public void updatePreference(HistoricalNotificationInfo historicalNotificationInfo) {
            ...
            if (viewGroup != null) {
                if (historicalNotificationInfo.icon != null) {
                    ((ImageView) viewGroup.findViewById(C0444R.C0448id.icon)).setImageDrawable(this.mInfo.icon);
                }
                ((TextView) this.mItemView.findViewById(C0444R.C0448id.pkgname)).setText(this.mInfo.pkgname);
                this.mItemView.findViewById(C0444R.C0448id.timestamp).setTime(historicalNotificationInfo.timestamp);
                int i = 0;
                if (!TextUtils.isEmpty(historicalNotificationInfo.title)) {
                    ((TextView) this.mItemView.findViewById(C0444R.C0448id.title)).setText(historicalNotificationInfo.title);
                    this.mItemView.findViewById(C0444R.C0448id.title).setVisibility(0);
                } else {
                    this.mItemView.findViewById(C0444R.C0448id.title).setVisibility(8);
                }
                if (!TextUtils.isEmpty(historicalNotificationInfo.text)) {
                    ((TextView) this.mItemView.findViewById(C0444R.C0448id.text)).setText(historicalNotificationInfo.text);
                    this.mItemView.findViewById(C0444R.C0448id.text).setVisibility(0);
                } else {
                    this.mItemView.findViewById(C0444R.C0448id.text).setVisibility(8);
                }
                if (historicalNotificationInfo.icon != null) {
                    ((ImageView) this.mItemView.findViewById(C0444R.C0448id.icon)).setImageDrawable(historicalNotificationInfo.icon);
                }
                ImageView imageView = (ImageView) this.mItemView.findViewById(C0444R.C0448id.profile_badge);
                ...
                this.mItemView.findViewById(C0444R.C0448id.timestamp).setTime(this.mInfo.timestamp);
                ((TextView) this.mItemView.findViewById(C0444R.C0448id.notification_extra)).setText(this.mInfo.notificationExtra);
                ((TextView) this.mItemView.findViewById(C0444R.C0448id.ranking_extra)).setText(this.mInfo.rankingExtra);
                this.mItemView.findViewById(C0444R.C0448id.extra).setVisibility(this.mInfo.timestamp == sLastExpandedTimestamp ? 0 : 8);
                this.mItemView.setAlpha(this.mInfo.active ? 1.0f : 0.5f);
                View findViewById = this.mItemView.findViewById(C0444R.C0448id.alerted_icon);
