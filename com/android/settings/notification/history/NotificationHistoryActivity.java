...
public class NotificationHistoryActivity extends CollapsingToolbarBaseActivity {
    ...
    private final NotificationListenerService mListener = new NotificationListenerService() {
        ...
        public void onListenerConnected() {
            ...
            L_0x0028:
                ...
                r4 = 2131559435(0x7f0d040b, float:1.8744214E38)
            ...
            L_0x00f8:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settings.notification.history.NotificationHistoryActivity.C11042.onListenerConnected():void");
        }
    ...
    public /* synthetic */ void lambda$new$2(List list) {
        ...
        int i = 8;
        boolean z = false;
        findViewById(C0444R.C0448id.today_list).setVisibility(list.isEmpty() ? 8 : 0);
        this.mCountdownLatch.countDown();
        this.mTodayView.findViewById(C0444R.C0448id.apps).setClipToOutline(true);
        ...
        while (i2 < size) {
            ...
            View inflate = LayoutInflater.from(this).inflate(C0444R.C0450layout.notification_history_app_layout, (ViewGroup) null);
            View findViewById = inflate.findViewById(C0444R.C0448id.notification_list_wrapper);
            findViewById.setVisibility(i);
            View findViewById2 = inflate.findViewById(C0444R.C0448id.app_header);
            NotificationExpandButton findViewById3 = inflate.findViewById(16908980);
            ...
            if (findViewById.getVisibility() == 0) {
                str = getString(C0444R.string.condition_expand_hide);
            } else {
                str = getString(C0444R.string.condition_expand_show);
            }
            ...
            TextView textView = (TextView) inflate.findViewById(C0444R.C0448id.label);
            ...
            ((ImageView) inflate.findViewById(C0444R.C0448id.icon)).setImageDrawable(notificationHistoryPackage.icon);
            TextView textView2 = (TextView) inflate.findViewById(C0444R.C0448id.count);
            textView2.setText(getResources().getQuantityString(C0444R.plurals.notification_history_count, notificationHistoryPackage.notifications.size(), new Object[]{Integer.valueOf(notificationHistoryPackage.notifications.size())}));
            NotificationHistoryRecyclerView notificationHistoryRecyclerView = (NotificationHistoryRecyclerView) inflate.findViewById(C0444R.C0448id.notification_list);
    ...
    public /* synthetic */ void lambda$new$1(TextView textView, View view, int i) {
        textView.setText(getResources().getQuantityString(C0444R.plurals.notification_history_count, i, new Object[]{Integer.valueOf(i)}));
        if (i == 0) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setTitle((int) C0444R.string.notification_history);
        setContentView((int) C0444R.C0450layout.notification_history);
        this.mTodayView = (ViewGroup) findViewById(C0444R.C0448id.apps);
        this.mSnoozeView = (ViewGroup) findViewById(C0444R.C0448id.snoozed_list);
        ViewGroup viewGroup = (ViewGroup) findViewById(C0444R.C0448id.recently_dismissed_list);
        this.mDismissView = viewGroup;
        configureNotificationList(viewGroup.findViewById(C0444R.C0448id.notification_list));
        configureNotificationList(this.mSnoozeView.findViewById(C0444R.C0448id.notification_list));
        this.mHistoryOff = (ViewGroup) findViewById(C0444R.C0448id.history_off);
        this.mHistoryOn = (ViewGroup) findViewById(C0444R.C0448id.history_on);
        this.mHistoryEmpty = (ViewGroup) findViewById(C0444R.C0448id.history_on_empty);
        this.mSwitchBar = (MainSwitchBar) findViewById(C0444R.C0448id.main_switch_bar);
    ...
    public /* synthetic */ void lambda$onResume$3() {
        if (this.mSwitchBar.isChecked() && findViewById(C0444R.C0448id.today_list).getVisibility() == 8 && this.mSnoozeView.getVisibility() == 8 && this.mDismissView.getVisibility() == 8) {
    ...
    private void bindSwitch() {
        ...
        if (mainSwitchBar != null) {
            mainSwitchBar.show();
            this.mSwitchBar.setTitle(getString(C0444R.string.notification_history_toggle));
            try {
