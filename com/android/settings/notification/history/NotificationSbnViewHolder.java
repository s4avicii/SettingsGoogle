...
public class NotificationSbnViewHolder extends RecyclerView.ViewHolder {
    ...
    NotificationSbnViewHolder(View view) {
        super(view);
        this.mPkgName = (TextView) view.findViewById(C0444R.C0448id.pkgname);
        this.mIcon = (ImageView) view.findViewById(C0444R.C0448id.icon);
        ...
        this.mProfileBadge = (ImageView) view.findViewById(C0444R.C0448id.profile_badge);
        this.mDivider = view.findViewById(C0444R.C0448id.divider);
    }
        ...
        if (z3 || launchIntentForPackage != null) {
            ...
            ViewCompat.setAccessibilityDelegate(this.itemView, new AccessibilityDelegateCompat() {
                public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                    ...
                    accessibilityNodeInfoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(16, view.getResources().getText(C0444R.string.notification_history_open_notification)));
                }
            });
        }
    }
