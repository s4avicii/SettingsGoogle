...
public class SoundWorkSettings extends DashboardFragment implements OnActivityResultListener {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.sound_work_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.sound_work_settings;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        replaceEnterpriseStringTitle("work_use_personal_sounds", "Settings.WORK_PROFILE_USE_PERSONAL_SOUNDS_TITLE", C0444R.string.work_use_personal_sounds_title);
        replaceEnterpriseStringSummary("work_use_personal_sounds", "Settings.WORK_PROFILE_USE_PERSONAL_SOUNDS_SUMMARY", C0444R.string.work_use_personal_sounds_summary);
        replaceEnterpriseStringTitle("work_ringtone", "Settings.WORK_PROFILE_RINGTONE_TITLE", C0444R.string.work_ringtone_title);
        replaceEnterpriseStringTitle("work_alarm_ringtone", "Settings.WORK_PROFILE_ALARM_RINGTONE_TITLE", C0444R.string.work_alarm_ringtone_title);
        replaceEnterpriseStringTitle("work_notification", "Settings.WORK_PROFILE_NOTIFICATION_RINGTONE_TITLE", C0444R.string.work_notification_ringtone_title);
    }
