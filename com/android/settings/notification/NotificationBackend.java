...
public class NotificationBackend {
    ...
    public static CharSequence getSentSummary(Context context, NotificationsSentState notificationsSentState, boolean z) {
        ...
        if (z) {
            ...
            return resources.getQuantityString(C0444R.plurals.notifications_sent_daily, i, new Object[]{Integer.valueOf(i)});
        } else {
            Resources resources2 = context.getResources();
            int i2 = notificationsSentState.avgSentWeekly;
            return resources2.getQuantityString(C0444R.plurals.notifications_sent_weekly, i2, new Object[]{Integer.valueOf(i2)});
        }
    }
    ...
    public Drawable getConversationDrawable(Context context, ShortcutInfo shortcutInfo, String str, int i, boolean z) {
        ...
        return new ConversationIconFactory(context, (LauncherApps) context.getSystemService(LauncherApps.class), context.getPackageManager(), IconDrawableFactory.newInstance(context, false), context.getResources().getDimensionPixelSize(C0444R.dimen.conversation_icon_size)).getConversationDrawable(shortcutInfo, str, i, z);
    }
