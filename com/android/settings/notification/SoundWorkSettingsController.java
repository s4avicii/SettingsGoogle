...
public class SoundWorkSettingsController extends AbstractPreferenceController implements Preference.OnPreferenceChangeListener, LifecycleObserver, OnResume, OnPause {
    ...
    private void enableWorkSyncSettings() {
        ...
        String string = ((DevicePolicyManager) this.mContext.getSystemService(DevicePolicyManager.class)).getString("Settings.WORK_PROFILE_SYNC_WITH_PERSONAL_SOUNDS_ACTIVE_SUMMARY", new SoundWorkSettingsController$$ExternalSyntheticLambda1(this));
    ...
    public /* synthetic */ String lambda$enableWorkSyncSettings$1() throws Exception {
        return this.mContext.getString(C0444R.string.work_sound_same_as_personal);
    }
    ...
    public static class UnifyWorkDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            return new AlertDialog.Builder(getActivity()).setTitle((CharSequence) devicePolicyManager.getString("Settings.ENABLE_WORK_PROFILE_SYNC_WITH_PERSONAL_SOUNDS_DIALOG_TITLE", new C1081xf34bd177(applicationContext))).setMessage((CharSequence) devicePolicyManager.getString("Settings.ENABLE_WORK_PROFILE_SYNC_WITH_PERSONAL_SOUNDS_DIALOG_MESSAGE", new C1080xf34bd176(applicationContext))).setPositiveButton((int) C0444R.string.work_sync_dialog_yes, (DialogInterface.OnClickListener) this).setNegativeButton(17039369, (DialogInterface.OnClickListener) null).create();
        }
