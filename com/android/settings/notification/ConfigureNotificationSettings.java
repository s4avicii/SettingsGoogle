...
public class ConfigureNotificationSettings extends DashboardFragment implements OnActivityResultListener {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.configure_notification_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.configure_notification_settings;
    }

    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        replaceEnterpriseStringTitle("lock_screen_work_redact", "Settings.WORK_PROFILE_LOCK_SCREEN_REDACT_NOTIFICATION_TITLE", C0444R.string.lock_screen_notifs_redact_work);
        replaceEnterpriseStringSummary("lock_screen_work_redact", "Settings.WORK_PROFILE_LOCK_SCREEN_REDACT_NOTIFICATION_SUMMARY", C0444R.string.lock_screen_notifs_redact_work_summary);
    }
