        ...
        new AsyncTask<Object, Void, CharSequence>() {
            ...
            public CharSequence doInBackground(Object... objArr) {
                ...
                if (RingtoneManager.isDefault(uri)) {
                    return NotificationSoundPreference.this.getContext().getString(C0444R.string.notification_sound_default);
                }
                if ("android.resource".equals(uri.getScheme())) {
                    return NotificationSoundPreference.this.getContext().getString(C0444R.string.notification_unknown_sound_title);
                }
