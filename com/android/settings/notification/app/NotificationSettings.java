...
public abstract class NotificationSettings extends DashboardFragment {
    ...
    public void animatePanel() {
        if (this.mPreferenceFilter != null) {
            ViewGroup viewGroup = (ViewGroup) getActivity().findViewById(C0444R.C0448id.main_content);
    ...
    public void toastAndFinish() {
        Toast.makeText(this.mContext, C0444R.string.app_not_found_dlg_text, 0).show();
        getActivity().finish();
    }
