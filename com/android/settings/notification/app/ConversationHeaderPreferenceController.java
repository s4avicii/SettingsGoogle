...
public class ConversationHeaderPreferenceController extends NotificationPreferenceController implements PreferenceControllerMixin, LifecycleObserver {
    ...
    public void updateState(Preference preference) {
        ...
        if (this.mAppRow != null && (dashboardFragment = this.mFragment) != null) {
            ...
            if (activity != null) {
                EntityHeaderController newInstance = EntityHeaderController.newInstance(activity, this.mFragment, ((LayoutPreference) preference).findViewById(C0444R.C0448id.entity_header));
                ...
                done.findViewById(C0444R.C0448id.entity_header).setVisibility(0);
                done.findViewById(C0444R.C0448id.entity_header).setBackground((Drawable) null);
            }
        }
    }
    ...
    public CharSequence getSummary() {
        ...
        spannableStringBuilder.append(instance.unicodeWrap(this.mContext.getText(C0444R.string.notification_header_divider_symbol_with_spaces)));
