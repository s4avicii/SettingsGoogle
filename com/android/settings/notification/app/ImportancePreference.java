...
public class ImportancePreference extends Preference {
    ...
    private void init(Context context) {
        ...
        this.selectedBackground = context.getDrawable(C0444R.C0447drawable.button_border_selected);
        this.unselectedBackground = this.mContext.getDrawable(C0444R.C0447drawable.button_border_unselected);
        setLayoutResource(C0444R.C0450layout.notif_importance_preference);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        this.mSilenceButton = preferenceViewHolder.findViewById(C0444R.C0448id.silence);
        this.mAlertButton = preferenceViewHolder.findViewById(C0444R.C0448id.alert);
    ...
    public void setImportanceSummary(ViewGroup viewGroup, int i, boolean z) {
        ...
        if (i >= 3) {
            viewGroup.findViewById(C0444R.C0448id.silence_summary).setVisibility(8);
            ((ImageView) viewGroup.findViewById(C0444R.C0448id.silence_icon)).setImageTintList(regularTint);
            ((TextView) viewGroup.findViewById(C0444R.C0448id.silence_label)).setTextColor(regularTint);
            ((ImageView) viewGroup.findViewById(C0444R.C0448id.alert_icon)).setImageTintList(accentTint);
            ((TextView) viewGroup.findViewById(C0444R.C0448id.alert_label)).setTextColor(accentTint);
            viewGroup.findViewById(C0444R.C0448id.alert_summary).setVisibility(0);
            return;
        }
        viewGroup.findViewById(C0444R.C0448id.alert_summary).setVisibility(8);
        ((ImageView) viewGroup.findViewById(C0444R.C0448id.alert_icon)).setImageTintList(regularTint);
        ((TextView) viewGroup.findViewById(C0444R.C0448id.alert_label)).setTextColor(regularTint);
        ((ImageView) viewGroup.findViewById(C0444R.C0448id.silence_icon)).setImageTintList(accentTint);
        ((TextView) viewGroup.findViewById(C0444R.C0448id.silence_label)).setTextColor(accentTint);
        viewGroup.findViewById(C0444R.C0448id.silence_summary).setVisibility(0);
    }
}
