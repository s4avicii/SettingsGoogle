...
public class ConversationPriorityPreference extends Preference {
    ...
    private void init(Context context) {
        ...
        setLayoutResource(C0444R.C0450layout.notif_priority_conversation_preference);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        this.mPriorityButton = preferenceViewHolder.findViewById(C0444R.C0448id.priority_group);
    ...
    public void setSelected(View view, boolean z) {
        ...
        ImageView imageView = (ImageView) view.findViewById(C0444R.C0448id.icon);
        TextView textView = (TextView) view.findViewById(C0444R.C0448id.label);
        ...
        view.setBackground(this.mContext.getDrawable(z ? C0444R.C0447drawable.button_border_selected : C0444R.C0447drawable.button_border_unselected));
