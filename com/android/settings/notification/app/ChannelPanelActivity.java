...
public class ChannelPanelActivity extends FragmentActivity {
    ...
    private void createOrUpdatePanel() {
        ...
        setContentView((int) C0444R.C0450layout.notification_channel_panel);
        Window window = getWindow();
        window.setGravity(80);
        window.setLayout(-1, -2);
        findViewById(C0444R.C0448id.done).setOnClickListener(new ChannelPanelActivity$$ExternalSyntheticLambda1(this));
        findViewById(C0444R.C0448id.see_more).setOnClickListener(new ChannelPanelActivity$$ExternalSyntheticLambda0(this));
