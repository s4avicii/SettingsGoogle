...
public class RecentConversationsPreferenceController extends AbstractPreferenceController {
    ...
    public LayoutPreference getClearAll(PreferenceGroup preferenceGroup) {
        LayoutPreference layoutPreference = new LayoutPreference(this.mContext, (int) C0444R.C0450layout.conversations_clear_recents);
        layoutPreference.setOrder(1);
        Button button = (Button) layoutPreference.findViewById(C0444R.C0448id.conversation_settings_clear_recents);
        button.setOnClickListener(new C1100x815781db(this, preferenceGroup, button));
    ...
    public /* synthetic */ void lambda$getClearAll$0(PreferenceGroup preferenceGroup, Button button, View view) {
        try {
            ...
            button.announceForAccessibility(this.mContext.getString(C0444R.string.recent_convos_removed));
    ...
    public RecentConversationPreference createConversationPref(PreferenceGroup preferenceGroup, ConversationChannel conversationChannel, int i) {
        ...
        if (!conversationChannel.hasActiveNotifications()) {
            recentConversationPreference.setOnClearClickListener(new C1102x815781dd(this, str, uid, id, recentConversationPreference, preferenceGroup));
        }
        ...
        recentConversationPreference.setOnPreferenceClickListener(new C1101x815781dc(this, str, uid, conversationChannel, id, recentConversationPreference));
    ...
    public /* synthetic */ void lambda$createConversationPref$1(String str, int i, String str2, RecentConversationPreference recentConversationPreference, PreferenceGroup preferenceGroup) {
        try {
            ...
            recentConversationPreference.getClearView().announceForAccessibility(this.mContext.getString(C0444R.string.recent_convo_removed));
    ...
    public CharSequence getSummary(ConversationChannel conversationChannel) {
        ...
        return this.mContext.getString(C0444R.string.notification_conversation_summary, new Object[]{conversationChannel.getNotificationChannel().getName(), conversationChannel.getNotificationChannelGroup().getName()});
    }
