...
public class PrivacySettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.privacy_settings) {
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_backup_reset;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.privacy_settings;
    }
