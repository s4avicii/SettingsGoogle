...
public class UserBackupSettingsActivity extends FragmentActivity {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean z) {
            ...
            searchIndexableRaw.title = context.getString(C0444R.string.privacy_settings_title);
            searchIndexableRaw.screenTitle = context.getString(C0444R.string.privacy_settings_title);
            searchIndexableRaw.keywords = context.getString(C0444R.string.keywords_backup);
