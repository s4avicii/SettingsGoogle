...
public class UnrestrictedDataAccess extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.unrestricted_data_access_settings);
    private ApplicationsState.AppFilter mFilter;
    private boolean mShowSystem;

    public int getHelpResource() {
        return C0444R.string.help_url_unrestricted_data_access;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.unrestricted_data_access_settings;
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        menu.add(0, 43, 0, this.mShowSystem ? C0444R.string.menu_hide_system : C0444R.string.menu_show_system);
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        if (menuItem.getItemId() == 43) {
            ...
            this.mShowSystem = z;
            menuItem.setTitle(z ? C0444R.string.menu_hide_system : C0444R.string.menu_show_system);
            if (this.mShowSystem) {
