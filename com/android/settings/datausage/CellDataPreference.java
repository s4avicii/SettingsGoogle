...
public class CellDataPreference extends CustomDialogPreferenceCompat implements TemplatePreference, MobileDataEnabledListener.Client {
    ...
    public CellDataPreference(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, TypedArrayUtils.getAttr(context, C0444R.attr.switchPreferenceStyle, 16843629));
    ...
    private void showDisableDialog(AlertDialog.Builder builder, DialogInterface.OnClickListener onClickListener) {
        builder.setTitle((CharSequence) null).setMessage((int) C0444R.string.data_usage_disable_mobile).setPositiveButton(17039370, onClickListener).setNegativeButton(17039360, (DialogInterface.OnClickListener) null);
    }
    ...
    private void showMultiSimDialog(AlertDialog.Builder builder, DialogInterface.OnClickListener onClickListener) {
        ...
        if (activeSubscriptionInfo2 == null) {
            str = getContext().getResources().getString(C0444R.string.sim_selection_required_pref);
        } else {
            str = SubscriptionUtil.getUniqueSubscriptionDisplayName(activeSubscriptionInfo2, getContext()).toString();
        }
        builder.setTitle((int) C0444R.string.sim_change_data_title);
        Context context = getContext();
        ...
        objArr[1] = str;
        builder.setMessage((CharSequence) context.getString(C0444R.string.sim_change_data_message, objArr));
        builder.setPositiveButton((int) C0444R.string.okay, onClickListener);
