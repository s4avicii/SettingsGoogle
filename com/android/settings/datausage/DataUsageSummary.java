...
public class DataUsageSummary extends DataUsageBaseFragment implements DataUsageEditController {
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_data_usage;
    }
    ...
    private void addMobileSection(int i, SubscriptionInfo subscriptionInfo) {
        TemplatePreferenceCategory templatePreferenceCategory = (TemplatePreferenceCategory) inflatePreferences(C0444R.xml.data_usage_cellular);
    ...
    public void addWifiSection() {
        ((TemplatePreferenceCategory) inflatePreferences(C0444R.xml.data_usage_wifi)).setTemplate(new NetworkTemplate.Builder(4).build(), 0, this.services);
    }

    private void addEthernetSection() {
        ((TemplatePreferenceCategory) inflatePreferences(C0444R.xml.data_usage_ethernet)).setTemplate(new NetworkTemplate.Builder(5).build(), 0, this.services);
    }
    ...
    static CharSequence formatUsage(Context context, String str, long j, float f, float f2) {
        ...
        CharSequence expandTemplate = TextUtils.expandTemplate(new SpannableString(context.getString(17040306).replace("%1$s", "^1").replace("%2$s", "^2")), new CharSequence[]{spannableString, formatBytes.units});
