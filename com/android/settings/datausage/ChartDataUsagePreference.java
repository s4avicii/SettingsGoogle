...
public class ChartDataUsagePreference extends Preference {
    ...
    public ChartDataUsagePreference(Context context, AttributeSet attributeSet) {
        ...
        setLayoutResource(C0444R.C0450layout.data_usage_graph);
    }

    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        super.onBindViewHolder(preferenceViewHolder);
        UsageView usageView = (UsageView) preferenceViewHolder.findViewById(C0444R.C0448id.data_usage);
    ...
    private void setupContentDescription(UsageView usageView, List<NetworkCycleData> list) {
        ...
        sb.append(this.mResources.getString(C0444R.string.data_usage_chart_brief_content_description, new Object[]{formatDateTime, formatDateTime2}));
        if (list == null || list.isEmpty()) {
            sb.append(this.mResources.getString(C0444R.string.data_usage_chart_no_data_content_description));
    ...
    private void bindNetworkPolicy(UsageView usageView, NetworkPolicy networkPolicy, int i) {
        ...
        if (networkPolicy != null) {
            ...
            if (j != -1) {
                i2 = this.mLimitColor;
                charSequenceArr[2] = getLabel(j, C0444R.string.data_usage_sweep_limit, i2);
            } else {
                i2 = 0;
            }
            ...
            if (j2 != -1) {
                ...
                charSequenceArr[1] = getLabel(networkPolicy.warningBytes, C0444R.string.data_usage_sweep_warning, i3);
            }
