...
public class DataSaverSummary extends SettingsPreferenceFragment implements OnMainSwitchChangeListener, DataSaverBackend.Listener, AppStateBaseBridge.Callback, ApplicationsState.Callbacks {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.data_saver) {
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_data_saver;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.data_saver);
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        switchBar.setTitle(getContext().getString(C0444R.string.data_saver_switch_title));
    ...
    public void onExtraInfoUpdated() {
        ...
        if (isAdded()) {
            ...
            this.mUnrestrictedAccess.setSummary((CharSequence) getResources().getQuantityString(C0444R.plurals.data_saver_unrestricted_summary, i, new Object[]{Integer.valueOf(i)}));
        }
    }
}
