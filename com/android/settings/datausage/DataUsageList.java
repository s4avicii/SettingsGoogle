...
public class DataUsageList extends DataUsageBaseFragment implements MobileDataEnabledListener.Client {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.data_usage_list;
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        View pinnedHeaderView = setPinnedHeaderView((int) C0444R.C0450layout.apps_filter_spinner);
        this.mHeader = pinnedHeaderView;
        pinnedHeaderView.findViewById(C0444R.C0448id.filter_settings).setOnClickListener(new DataUsageList$$ExternalSyntheticLambda0(this));
        Spinner spinner = (Spinner) this.mHeader.findViewById(C0444R.C0448id.filter_spinner);
        ...
        LoadingViewController loadingViewController = new LoadingViewController(getView().findViewById(C0444R.C0448id.loading_container), getListView());
    ...
    public /* synthetic */ void lambda$onViewCreated$0(View view) {
        ...
        new SubSettingLauncher(getContext()).setDestination(BillingCycleSettings.class.getName()).setTitleRes(C0444R.string.billing_cycle).setSourceMetricsCategory(getMetricsCategory()).setArguments(bundle).launch();
    }
    ...
    private void updateBody() {
        ...
        if (isAdded()) {
            ...
            int color = activity.getColor(C0444R.C0446color.sim_noitification);
    ...
    public void updatePolicy() {
        ...
        View findViewById = this.mHeader.findViewById(C0444R.C0448id.filter_settings);
    ...
    public void updateDetailData() {
        ...
        this.mUsageAmount.setTitle((CharSequence) getString(C0444R.string.data_used_template, DataUsageUtils.formatDataUsage(getActivity(), (list == null || list.isEmpty()) ? 0 : this.mCycleData.get(this.mCycleSpinner.getSelectedItemPosition()).getTotalUsage())));
    }
    ...
    public void startAppDataUsage(AppItem appItem) {
        ...
        new SubSettingLauncher(getContext()).setDestination(AppDataUsage.class.getName()).setTitleRes(C0444R.string.data_usage_app_summary_title).setArguments(bundle).setSourceMetricsCategory(getMetricsCategory()).launch();
    }
