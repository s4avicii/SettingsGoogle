...
public class DataUsageSummaryPreference extends Preference {
    ...
    public DataUsageSummaryPreference(Context context, AttributeSet attributeSet) {
        ...
        setLayoutResource(C0444R.C0450layout.data_usage_summary_preference);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (z && this.mSingleWifi) {
            ...
            usageTitle.setText(C0444R.string.data_usage_wifi_title);
            ...
            launchButton.setText(C0444R.string.launch_wifi_text);
    ...
    static void launchWifiDataUsage(Context context) {
        ...
        sourceMetricsCategory.setTitleRes(C0444R.string.wifi_data_usage);
    ...
    private void updateDataUsageLabels(PreferenceViewHolder preferenceViewHolder) {
        ...
        spannableString.setSpan(new AbsoluteSizeSpan(getContext().getResources().getDimensionPixelSize(C0444R.dimen.usage_number_text_size)), 0, spannableString.length(), 33);
        dataUsed.setText(TextUtils.expandTemplate(getContext().getText(C0444R.string.data_used_formatted), new CharSequence[]{spannableString, formatBytes.units}));
        ...
        if (j >= 0) {
            dataRemaining.setText(TextUtils.expandTemplate(getContext().getText(C0444R.string.data_remaining), new CharSequence[]{DataUsageUtils.formatDataUsage(getContext(), j)}));
            dataRemaining.setTextColor(Utils.getColorAttr(getContext(), 16843829));
        } else {
            dataRemaining.setText(TextUtils.expandTemplate(getContext().getText(C0444R.string.data_overusage), new CharSequence[]{DataUsageUtils.formatDataUsage(getContext(), -j)}));
    ...
    private void updateCycleTimeText(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (currentTimeMillis <= 0) {
            cycleTime.setText(getContext().getString(C0444R.string.billing_cycle_none_left));
            return;
        }
        int i = (int) (currentTimeMillis / MILLIS_IN_A_DAY);
        if (i < 1) {
            str = getContext().getString(C0444R.string.billing_cycle_less_than_one_day_left);
        } else {
            str = getContext().getResources().getQuantityString(C0444R.plurals.billing_cycle_days_left, i, new Object[]{Integer.valueOf(i)});
        }
    ...
    private void updateCarrierInfo(TextView textView) {
        ...
        if (calculateTruncatedUpdateAge == 0) {
            i = this.mCarrierName != null ? C0444R.string.carrier_and_update_now_text : C0444R.string.no_carrier_update_now_text;
        } else {
            i = this.mCarrierName != null ? C0444R.string.carrier_and_update_text : C0444R.string.no_carrier_update_text;
    ...
    public TextView getUsageTitle(PreferenceViewHolder preferenceViewHolder) {
        return (TextView) preferenceViewHolder.findViewById(C0444R.C0448id.usage_title);
    }

    /* access modifiers changed from: protected */
    public TextView getCycleTime(PreferenceViewHolder preferenceViewHolder) {
        return (TextView) preferenceViewHolder.findViewById(C0444R.C0448id.cycle_left_time);
    }

    /* access modifiers changed from: protected */
    public TextView getCarrierInfo(PreferenceViewHolder preferenceViewHolder) {
        return (TextView) preferenceViewHolder.findViewById(C0444R.C0448id.carrier_and_update);
    }

    /* access modifiers changed from: protected */
    public TextView getDataLimits(PreferenceViewHolder preferenceViewHolder) {
        return (TextView) preferenceViewHolder.findViewById(C0444R.C0448id.data_limits);
    }

    /* access modifiers changed from: protected */
    public TextView getDataUsed(PreferenceViewHolder preferenceViewHolder) {
        return (TextView) preferenceViewHolder.findViewById(C0444R.C0448id.data_usage_view);
    }

    /* access modifiers changed from: protected */
    public TextView getDataRemaining(PreferenceViewHolder preferenceViewHolder) {
        return (TextView) preferenceViewHolder.findViewById(C0444R.C0448id.data_remaining_view);
    }

    /* access modifiers changed from: protected */
    public Button getLaunchButton(PreferenceViewHolder preferenceViewHolder) {
        return (Button) preferenceViewHolder.findViewById(C0444R.C0448id.launch_mdp_app_button);
    }

    /* access modifiers changed from: protected */
    public LinearLayout getLabelBar(PreferenceViewHolder preferenceViewHolder) {
        return (LinearLayout) preferenceViewHolder.findViewById(C0444R.C0448id.label_bar);
    }
    ...
    public ProgressBar getProgressBar(PreferenceViewHolder preferenceViewHolder) {
        return (ProgressBar) preferenceViewHolder.findViewById(C0444R.C0448id.determinateBar);
    }

    /* access modifiers changed from: protected */
    public MeasurableLinearLayout getLayout(PreferenceViewHolder preferenceViewHolder) {
        return (MeasurableLinearLayout) preferenceViewHolder.findViewById(C0444R.C0448id.usage_layout);
    }
}
