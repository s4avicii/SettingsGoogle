...
public class SubscriptionUtil {
    ...
    public static Map<Integer, CharSequence> getUniqueSubscriptionDisplayNames(Context context) {
        SubscriptionUtil$$ExternalSyntheticLambda15 subscriptionUtil$$ExternalSyntheticLambda15 = new SubscriptionUtil$$ExternalSyntheticLambda15(context);
        HashSet hashSet = new HashSet();
        SubscriptionUtil$$ExternalSyntheticLambda16 subscriptionUtil$$ExternalSyntheticLambda16 = new SubscriptionUtil$$ExternalSyntheticLambda16(subscriptionUtil$$ExternalSyntheticLambda15, (Set) ((Stream) subscriptionUtil$$ExternalSyntheticLambda15.get()).filter(new SubscriptionUtil$$ExternalSyntheticLambda11(hashSet)).map(SubscriptionUtil$$ExternalSyntheticLambda6.INSTANCE).collect(Collectors.toSet()), context);
        hashSet.clear();
        return (Map) ((Stream) subscriptionUtil$$ExternalSyntheticLambda16.get()).map(new SubscriptionUtil$$ExternalSyntheticLambda1((Set) ((Stream) subscriptionUtil$$ExternalSyntheticLambda16.get()).filter(new SubscriptionUtil$$ExternalSyntheticLambda12(hashSet)).map(SubscriptionUtil$$ExternalSyntheticLambda5.INSTANCE).collect(Collectors.toSet()))).collect(Collectors.toMap(SubscriptionUtil$$ExternalSyntheticLambda4.INSTANCE, SubscriptionUtil$$ExternalSyntheticLambda3.INSTANCE));
    }
    ...
    public static /* synthetic */ AnonymousClass1DisplayInfo lambda$getUniqueSubscriptionDisplayNames$1(Context context, SubscriptionInfo subscriptionInfo) {
        ...
        if (TextUtils.equals(charSequence, "CARD")) {
            str = context.getResources().getString(C0444R.string.sim_card);
        } else {
    ...
    public static SubscriptionInfo getSubById(SubscriptionManager subscriptionManager, int i) {
        ...
        return (SubscriptionInfo) subscriptionManager.getAllSubscriptionInfoList().stream().filter(new SubscriptionUtil$$ExternalSyntheticLambda8(i)).findFirst().get();
    }
    ...
    public static List<SubscriptionInfo> findAllSubscriptionsInGroup(SubscriptionManager subscriptionManager, int i) {
        ...
        return (availableSubscriptionInfoList == null || availableSubscriptionInfoList.isEmpty() || groupUuid == null) ? Collections.singletonList(subById) : (List) availableSubscriptionInfoList.stream().filter(new SubscriptionUtil$$ExternalSyntheticLambda10(groupUuid)).collect(Collectors.toList());
    }
    ...
    public static CharSequence getDefaultSimConfig(Context context, int i) {
        ...
        if (z3) {
            sb.append(getResForDefaultConfig(context, C0444R.string.default_active_sim_mobile_data));
            sb.append(", ");
        }
        if (z) {
            sb.append(getResForDefaultConfig(context, C0444R.string.default_active_sim_calls));
            sb.append(", ");
        }
        if (z2) {
            sb.append(getResForDefaultConfig(context, C0444R.string.default_active_sim_sms));
            sb.append(", ");
        }
        sb.setLength(sb.length() - 2);
        return context.getResources().getString(C0444R.string.sim_category_default_active_sim, new Object[]{sb});
    }
    ...
    public static SubscriptionAnnotation getDefaultSubscriptionSelection(List<SubscriptionAnnotation> list) {
        ...
        return (SubscriptionAnnotation) list.stream().filter(MobileNetworkSummaryStatus$$ExternalSyntheticLambda3.INSTANCE).filter(SubscriptionUtil$$ExternalSyntheticLambda14.INSTANCE).findFirst().orElse((Object) null);
    }
    ...
    private static SubscriptionInfo getSubscription(Context context, int i, Function<List<SubscriptionAnnotation>, SubscriptionAnnotation> function) {
        ...
        SubscriptionAnnotation subscriptionAnnotation = (SubscriptionAnnotation) call.stream().filter(MobileNetworkSummaryStatus$$ExternalSyntheticLambda3.INSTANCE).filter(new SubscriptionUtil$$ExternalSyntheticLambda9(i)).findFirst().orElse((Object) null);
