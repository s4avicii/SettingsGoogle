...
public class MobileNetworkSummaryController extends AbstractPreferenceController implements SubscriptionsChangeListener.SubscriptionsChangeListenerClient, LifecycleObserver, PreferenceControllerMixin {
    ...
    public CharSequence getSummary() {
        ...
        if (subscriptionList.isEmpty()) {
            return this.mStatusCache.isEuiccConfigSupport() ? this.mContext.getResources().getString(C0444R.string.mobile_network_summary_add_a_network) : "";
        }
        if (subscriptionList.size() != 1) {
            return (CharSequence) subscriptionList.stream().mapToInt(MobileNetworkSummaryController$$ExternalSyntheticLambda7.INSTANCE).mapToObj(new MobileNetworkSummaryController$$ExternalSyntheticLambda6(this)).collect(Collectors.joining(", "));
        }
        ...
        return this.mContext.getString(C0444R.string.mobile_network_tap_to_activate, new Object[]{displayName});
    }
