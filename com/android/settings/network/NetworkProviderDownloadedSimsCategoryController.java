...
public class NetworkProviderDownloadedSimsCategoryController extends PreferenceCategoryController implements LifecycleObserver {
    ...
    public void updateState(Preference preference) {
        ...
        this.mPreferenceCategory.setTitle((CharSequence) this.mContext.getString(preferenceCategory.getPreferenceCount() > 1 ? C0444R.string.downloaded_sims_category_title : C0444R.string.downloaded_sim_category_title));
    }
}
