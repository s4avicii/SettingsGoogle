...
public class PrivateDnsModeDialogPreference extends CustomDialogPreferenceCompat implements DialogInterface.OnClickListener, RadioGroup.OnCheckedChangeListener, TextWatcher {
    ...
    static {
        ...
        hashMap.put(1, Integer.valueOf(C0444R.C0448id.private_dns_mode_off));
        hashMap.put(2, Integer.valueOf(C0444R.C0448id.private_dns_mode_opportunistic));
        hashMap.put(3, Integer.valueOf(C0444R.C0448id.private_dns_mode_provider));
    }
    ...
    public static /* synthetic */ void lambda$new$0(View view) {
        ...
        Intent helpIntent = HelpUtils.getHelpIntent(context, context.getString(C0444R.string.help_uri_private_dns), context.getClass().getName());
        if (helpIntent != null) {
            try {
    ...
    public void onBindDialogView(View view) {
        ...
        EditText editText = (EditText) view.findViewById(C0444R.C0448id.private_dns_mode_provider_hostname);
        this.mEditText = editText;
        editText.addTextChangedListener(this);
        this.mEditText.setText(getHostnameFromSettings(contentResolver));
        RadioGroup radioGroup = (RadioGroup) view.findViewById(C0444R.C0448id.private_dns_radio_group);
        this.mRadioGroup = radioGroup;
        radioGroup.setOnCheckedChangeListener(this);
        this.mRadioGroup.check(PRIVATE_DNS_MAP.getOrDefault(Integer.valueOf(this.mMode), Integer.valueOf(C0444R.C0448id.private_dns_mode_opportunistic)).intValue());
        ((RadioButton) view.findViewById(C0444R.C0448id.private_dns_mode_off)).setText(C0444R.string.private_dns_mode_off);
        ((RadioButton) view.findViewById(C0444R.C0448id.private_dns_mode_opportunistic)).setText(C0444R.string.private_dns_mode_opportunistic);
        ((RadioButton) view.findViewById(C0444R.C0448id.private_dns_mode_provider)).setText(C0444R.string.private_dns_mode_provider);
        TextView textView = (TextView) view.findViewById(C0444R.C0448id.private_dns_help_info);
        textView.setMovementMethod(LinkMovementMethod.getInstance());
        AnnotationSpan.LinkInfo linkInfo = new AnnotationSpan.LinkInfo(context, "url", HelpUtils.getHelpIntent(context, context.getString(C0444R.string.help_uri_private_dns), context.getClass().getName()));
        if (linkInfo.isActionable()) {
            textView.setText(AnnotationSpan.linkify(context.getText(C0444R.string.private_dns_help_message), linkInfo));
            return;
        }
        textView.setText("");
    }
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int i) {
        if (i == C0444R.C0448id.private_dns_mode_off) {
            this.mMode = 1;
        } else if (i == C0444R.C0448id.private_dns_mode_opportunistic) {
            this.mMode = 2;
        } else if (i == C0444R.C0448id.private_dns_mode_provider) {
            this.mMode = 3;
        }
        updateDialogInfo();
    }
