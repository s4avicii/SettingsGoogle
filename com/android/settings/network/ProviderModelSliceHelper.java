...
public class ProviderModelSliceHelper {
    ...
    private String getMobileSummary(String str) {
        ...
        if (!isDataStateInService()) {
            return this.mContext.getString(C0444R.string.mobile_data_no_connection);
        }
        if (!isDataSimActive()) {
            return str;
        }
        Context context = this.mContext;
        return context.getString(C0444R.string.preference_summary_default_combination, new Object[]{context.getString(C0444R.string.mobile_data_connection_active), str});
    }
    ...
    private Set<String> getKeywords() {
        return (Set) Arrays.stream(TextUtils.split(this.mContext.getString(C0444R.string.keywords_internet), ",")).map(ProviderModelSliceHelper$$ExternalSyntheticLambda1.INSTANCE).collect(Collectors.toSet());
    }
}
