...
public class NetworkProviderCallsSmsFragment extends DashboardFragment {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.network_provider_calls_sms) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.network_provider_calls_sms;
    }
