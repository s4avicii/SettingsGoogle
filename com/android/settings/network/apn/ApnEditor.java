...
public class ApnEditor extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, View.OnKeyListener {
    ...
    public void fillUI(boolean z) {
        ...
        if (value != null) {
            ...
            this.mAuthType.setSummary(getResources().getStringArray(C0444R.array.apn_auth_entries)[parseInt]);
        } else {
        ...
        if (getResources().getBoolean(C0444R.bool.config_allow_edit_carrier_enabled)) {
    ...
    private String protocolDescription(String str, ListPreference listPreference) {
        ...
        try {
            return getResources().getStringArray(C0444R.array.apn_protocol_entries)[findIndexOfValue];
    ...
    private String bearerMultiDescription(Set<String> set) {
        String[] stringArray = getResources().getStringArray(C0444R.array.bearer_entries);
    ...
    private java.lang.String mvnoDescription(java.lang.String r9) {
        ...
        L_0x0011:
            ...
            r4 = 2130772129(0x7f0100a1, float:1.7147368E38)
        ...
        L_0x00e1:
            ...
            r8.setText(r1)
        L_0x00e6:
            r8 = r3[r0]     // Catch:{ ArrayIndexOutOfBoundsException -> 0x00e9 }
            return r8
        L_0x00e9:
            return r2
        */
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        ...
        if (!this.mNewApn && !this.mReadOnlyApn) {
            menu.add(0, 1, 0, C0444R.string.menu_delete).setIcon(C0444R.C0447drawable.ic_delete);
        }
        if (!this.mReadOnlyApn) {
            menu.add(0, 2, 0, C0444R.string.menu_save).setIcon(17301582);
        }
        menu.add(0, 3, 0, C0444R.string.menu_cancel).setIcon(17301560);
    }
    ...
    /* access modifiers changed from: package-private */
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x01b2, code lost:
    ...
    public String validateApnData() {
        ...
        if (TextUtils.isEmpty(checkNotSet)) {
            str = getResources().getString(C0444R.string.error_name_empty);
        } else if (TextUtils.isEmpty(checkNotSet2)) {
            str = getResources().getString(C0444R.string.error_apn_empty);
        } else if (checkNotSet3 == null || checkNotSet3.length() != 3) {
            str = getResources().getString(C0444R.string.error_mcc_not3);
        } else if (checkNotSet4 == null || (checkNotSet4.length() & 65534) != 2) {
            str = getResources().getString(C0444R.string.error_mnc_not23);
        } else {
            str = null;
        }
        ...
        return String.format(getResources().getString(C0444R.string.error_adding_apn_type), new Object[]{sb});
    }
    ...
    private String checkNullforMvnoValue(String str) {
        return TextUtils.isEmpty(str) ? getResources().getString(C0444R.string.apn_not_set_for_mvno) : str;
    }
    ...
    private void initApnEditorUi() {
        addPreferencesFromResource(C0444R.xml.apn_editor);
        sNotSet = getResources().getString(C0444R.string.apn_not_set);
    ...
    public static class ErrorDialog extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            return new AlertDialog.Builder(getContext()).setTitle((int) C0444R.string.error_title).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).setMessage((CharSequence) ((ApnEditor) getTargetFragment()).validateApnData()).create();
        }
    }
