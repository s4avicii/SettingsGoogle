...
public class ApnPreference extends Preference implements CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    public ApnPreference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0444R.attr.apnPreferenceStyle);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        ((RelativeLayout) preferenceViewHolder.findViewById(C0444R.C0448id.text_layout)).setOnClickListener(this);
        View findViewById = preferenceViewHolder.findViewById(C0444R.C0448id.apn_radiobutton);
    ...
    public void onClick(View view) {
        ...
        if (context == null) {
            ...
            Toast.makeText(context, context.getString(C0444R.string.cannot_change_apn_toast), 1).show();
        } else {
