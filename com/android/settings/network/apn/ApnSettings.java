...
public class ApnSettings extends RestrictedSettingsFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        getEmptyTextView().setText(C0444R.string.apn_settings_not_available);
        boolean isUiRestricted = isUiRestricted();
        this.mUnavailable = isUiRestricted;
        setHasOptionsMenu(!isUiRestricted);
        if (this.mUnavailable) {
            addPreferencesFromResource(C0444R.xml.placeholder_prefs);
        } else {
            addPreferencesFromResource(C0444R.xml.apn_settings);
        }
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        if (!this.mUnavailable) {
            if (this.mAllowAddingApns) {
                menu.add(0, 1, 0, getResources().getString(C0444R.string.menu_new)).setIcon(C0444R.C0447drawable.ic_add_24dp).setShowAsAction(1);
            }
            menu.add(0, 2, 0, getResources().getString(C0444R.string.menu_restore)).setIcon(17301589);
        }
    ...
    private class RestoreApnUiHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            if (message.what == 2) {
                ...
                Toast.makeText(activity, ApnSettings.this.getResources().getString(C0444R.string.restore_default_apn_completed), 1).show();
            }
        }
    }
    ...
    public Dialog onCreateDialog(int i) {
        ...
        C10403 r2 = new ProgressDialog(getActivity()) {
            public boolean onTouchEvent(MotionEvent motionEvent) {
                return true;
            }
        };
        r2.setMessage(getResources().getString(C0444R.string.restore_default_apn));
