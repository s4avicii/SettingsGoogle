...
public class ContactDiscoveryDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        if (!TextUtils.isEmpty(this.mCarrierName)) {
            str2 = getContext().getString(C0444R.string.contact_discovery_opt_in_dialog_title, new Object[]{this.mCarrierName});
            str = getContext().getString(C0444R.string.contact_discovery_opt_in_dialog_message, new Object[]{this.mCarrierName});
        } else {
            str2 = getContext().getString(C0444R.string.contact_discovery_opt_in_dialog_title_no_carrier_defined);
            str = getContext().getString(C0444R.string.contact_discovery_opt_in_dialog_message_no_carrier_defined);
        }
        builder.setMessage(str).setTitle(str2).setIconAttribute(16843605).setPositiveButton(C0444R.string.confirmation_turn_on, this).setNegativeButton(17039360, this);
