...
public class NetworkSelectSettings extends DashboardFragment {
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 1) {
                ...
                if (networkOperatorPreference != null) {
                    networkOperatorPreference.setSummary(booleanValue ? C0444R.string.network_connected : C0444R.string.network_could_not_connect);
                } else {
                ...
                if (NetworkSelectSettings.this.mRequestIdManualNetworkScan >= NetworkSelectSettings.this.mRequestIdManualNetworkSelect) {
                    ...
                    NetworkSelectSettings.this.addMessagePreference(C0444R.string.network_query_error);
                }
            } else if (i == 4) {
                NetworkSelectSettings.this.stopNetworkQuery();
                ...
                if (NetworkSelectSettings.this.mRequestIdManualNetworkScan >= NetworkSelectSettings.this.mRequestIdManualNetworkSelect) {
                    ...
                    if (networkSelectSettings.mCellInfoList == null) {
                        networkSelectSettings.addMessagePreference(C0444R.string.empty_networks_list);
                    }
                }
            }
        }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.choose_network;
    }
    ...
    public boolean enableAggregation(Context context) {
        return context.getResources().getBoolean(C0444R.bool.config_network_selection_list_aggregation_enabled);
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (getActivity() != null) {
            this.mProgressHeader = setPinnedHeaderView((int) C0444R.C0450layout.progress_header).findViewById(C0444R.C0448id.progress_bar_animation);
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference != this.mSelectedPreference) {
            ...
            if (networkOperatorPreference != null) {
                networkOperatorPreference.setSummary((int) C0444R.string.network_disconnected);
            }
            ...
            networkOperatorPreference2.setSummary((int) C0444R.string.network_connecting);
    ...
    public List<CellInfo> doAggregation(List<CellInfo> list) {
        ...
        for (CellInfo next : list) {
            Optional findFirst = arrayList.stream().filter(new NetworkSelectSettings$$ExternalSyntheticLambda1(CellInfoUtil.getNetworkTitle(next.getCellIdentity(), CellInfoUtil.getCellIdentityMccMnc(next.getCellIdentity())), next.getClass())).findFirst();
    ...
    public void scanResultHandler(List<CellInfo> list) {
        ...
        if (list2 != null && list2.size() != 0) {
            ...
            if (updateAllPreferenceCategory != null) {
                ...
                this.mSelectedPreference.setSummary((int) C0444R.string.network_connecting);
            }
            enablePreferenceScreen(true);
        } else if (isPreferenceScreenEnabled()) {
            addMessagePreference(C0444R.string.empty_networks_list);
            setProgressBarVisible(true);
        }
    }
            ...
            for (NetworkRegistrationInfo cellIdentity : networkRegistrationInfoListForTransportType) {
                ...
                if (cellIdentity2 != null) {
                    ...
                    if (!networkOperatorPreference.isForbiddenNetwork()) {
                        networkOperatorPreference.setSummary((int) C0444R.string.network_connected);
