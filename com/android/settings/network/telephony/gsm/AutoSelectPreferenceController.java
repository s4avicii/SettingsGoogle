...
public class AutoSelectPreferenceController extends TelephonyTogglePreferenceController implements LifecycleObserver {
    ...
    public void updateState(Preference preference) {
        ...
        if (serviceState == null) {
            ...
            if (this.mOnlyAutoSelectInHome) {
                preference.setSummary((CharSequence) this.mContext.getString(C0444R.string.manual_mode_disallowed_summary, new Object[]{this.mTelephonyManager.getSimOperatorName()}));
            }
        }
    }
    ...
    private void showAutoSelectProgressBar() {
        if (this.mProgressDialog == null) {
            ...
            progressDialog.setMessage(this.mContext.getResources().getString(C0444R.string.register_automatically));
