...
public class MobileDataSlice implements CustomSliceable {
    ...
    public Slice getSlice() {
        IconCompat createWithResource = IconCompat.createWithResource(this.mContext, C0444R.C0447drawable.ic_network_cell);
        String charSequence = this.mContext.getText(C0444R.string.mobile_data_settings_title).toString();
