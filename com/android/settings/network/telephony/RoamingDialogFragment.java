...
public class RoamingDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        builder.setMessage(getResources().getString((configForSubId == null || !configForSubId.getBoolean("check_pricing_with_carrier_data_roaming_bool")) ? C0444R.string.roaming_warning : C0444R.string.roaming_check_price_warning)).setTitle(C0444R.string.roaming_alert_title).setIconAttribute(16843605).setPositiveButton(17039379, this).setNegativeButton(17039369, this);
