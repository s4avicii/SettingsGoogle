...
public class NetworkScanHelper {
    ...
    public NetworkScanRequest createNetworkScanForPreferredAccessNetworks() {
        ...
        return new NetworkScanRequest(0, (RadioAccessSpecifier[]) arrayList.toArray(new RadioAccessSpecifier[arrayList.size()]), 5, MAX_SEARCH_TIME_SEC, true, 3, (ArrayList) null);
    }
