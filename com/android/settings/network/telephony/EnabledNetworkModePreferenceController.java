...
public class EnabledNetworkModePreferenceController extends TelephonyBasePreferenceController implements Preference.OnPreferenceChangeListener, LifecycleObserver, SubscriptionsChangeListener.SubscriptionsChangeListenerClient {
    ...
    private final class PreferenceEntriesBuilder {
        ...
        public void setPreferenceEntries() {
            clearAllEntries();
            switch (C10431.f161xa7d3c794[getEnabledNetworkType().ordinal()]) {
                case 1:
                    int[] array = Stream.of(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getStringArray(C0444R.array.enabled_networks_cdma_values)).mapToInt(C1047x7d702dd5.INSTANCE).toArray();
                    if (array.length >= 4) {
                ...
                case 2:
                    int[] array2 = Stream.of(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getStringArray(C0444R.array.enabled_networks_cdma_no_lte_values)).mapToInt(C1047x7d702dd5.INSTANCE).toArray();
                    if (array2.length >= 2) {
                        add3gEntry(array2[0]);
                        add1xEntry(array2[1]);
                        return;
                ...
                case 3:
                    int[] array3 = Stream.of(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getStringArray(C0444R.array.enabled_networks_cdma_only_lte_values)).mapToInt(C1047x7d702dd5.INSTANCE).toArray();
                    if (array3.length >= 2) {
                ...
                case 4:
                    int[] array4 = Stream.of(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getStringArray(C0444R.array.enabled_networks_tdscdma_values)).mapToInt(C1047x7d702dd5.INSTANCE).toArray();
                    if (array4.length >= 3) {
                ...
                case 5:
                    int[] array5 = Stream.of(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getStringArray(C0444R.array.enabled_networks_except_gsm_lte_values)).mapToInt(C1047x7d702dd5.INSTANCE).toArray();
                    if (array5.length >= 1) {
                        add3gEntry(array5[0]);
                        return;
                    }
                ...
                case 6:
                    int[] array6 = Stream.of(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getStringArray(C0444R.array.enabled_networks_except_gsm_values)).mapToInt(C1047x7d702dd5.INSTANCE).toArray();
                    if (array6.length >= 2) {
                ...
                case 7:
                    int[] array7 = Stream.of(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getStringArray(C0444R.array.enabled_networks_except_gsm_values)).mapToInt(C1047x7d702dd5.INSTANCE).toArray();
                    if (array7.length >= 2) {
                ...
                case 8:
                    int[] array8 = Stream.of(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getStringArray(C0444R.array.enabled_networks_except_lte_values)).mapToInt(C1047x7d702dd5.INSTANCE).toArray();
                    if (array8.length >= 2) {
                        add3gEntry(array8[0]);
                        add2gEntry(array8[1]);
                        return;
                ...
                case 9:
                    int[] array9 = Stream.of(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getStringArray(C0444R.array.enabled_networks_values)).mapToInt(C1047x7d702dd5.INSTANCE).toArray();
                    if (array9.length >= 3) {
                ...
                case 10:
                    int[] array10 = Stream.of(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getStringArray(C0444R.array.enabled_networks_values)).mapToInt(C1047x7d702dd5.INSTANCE).toArray();
                    if (array10.length >= 3) {
                ...
                case 11:
                    int[] array11 = Stream.of(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getStringArray(C0444R.array.preferred_network_mode_values_world_mode)).mapToInt(C1047x7d702dd5.INSTANCE).toArray();
                    if (array11.length >= 3) {
                        addGlobalEntry(array11[0]);
                        addCustomEntry(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.network_world_mode_cdma_lte), array11[1]);
                        addCustomEntry(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.network_world_mode_gsm_lte), array11[2]);
                        return;
                    }
        ...
        public void setPreferenceValueAndSummary(int i) {
            setSelectedEntry(i);
            int i2 = C0444R.string.network_4G_pure;
            int i3 = C0444R.string.network_4G;
            int i4 = C0444R.string.network_lte_pure;
            switch (i) {
                case 0:
                case 2:
                case 3:
                    if (!this.mIsGlobalCdma) {
                        setSelectedEntry(0);
                        setSummary((int) C0444R.string.network_3G);
                        return;
                    }
                    setSelectedEntry(10);
                    setSummary((int) C0444R.string.network_global);
                    return;
                case 1:
                    if (!this.mIsGlobalCdma) {
                        setSelectedEntry(1);
                        setSummary((int) C0444R.string.network_2G);
                        return;
                    }
                    setSelectedEntry(10);
                    setSummary((int) C0444R.string.network_global);
                ...
                case 5:
                    setSelectedEntry(5);
                    setSummary((int) C0444R.string.network_1x);
                    return;
                case 8:
                    if (MobileNetworkUtils.isWorldMode(this.mContext, this.mSubId)) {
                        setSummary((int) C0444R.string.preferred_network_mode_lte_cdma_summary);
                        return;
                    }
                    setSelectedEntry(8);
                    if (!is5gEntryDisplayed()) {
                        i4 = C0444R.string.network_lte;
                    }
                    setSummary(i4);
                    return;
                case 9:
                    if (MobileNetworkUtils.isWorldMode(this.mContext, this.mSubId)) {
                        setSummary((int) C0444R.string.preferred_network_mode_lte_gsm_umts_summary);
                        return;
                    }
                    break;
                case 10:
                ...
                case 22:
                    ...
                    if (this.mTelephonyManager.getPhoneType() == 2 || this.mIsGlobalCdma || MobileNetworkUtils.isWorldMode(this.mContext, this.mSubId)) {
                        ...
                        if (!this.mShow4gForLTE) {
                            i2 = C0444R.string.network_lte_pure;
                        }
                        setSummary(i2);
                        return;
                    } else {
                        if (!this.mShow4gForLTE) {
                            i3 = C0444R.string.network_lte;
                        }
                        setSummary(i3);
                        return;
                    }
                ...
                case 28:
                    setSelectedEntry(26);
                    setSummary(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.network_5G_recommended));
                    return;
                case 25:
                    setSelectedEntry(25);
                    setSummary(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.network_5G_recommended));
                ...
                case 33:
                    ...
                    return;
                default:
                    setSummary(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.mobile_network_mode_error, new Object[]{Integer.valueOf(i)}));
                    return;
            }
            if (!this.mIsGlobalCdma) {
                setSelectedEntry(9);
        ...
        private void add5gEntry(int i) {
            ...
            this.mEntries.add(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.network_5G_recommended));
        ...
        private void addGlobalEntry(int i) {
            ...
            this.mEntries.add(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.network_global));
            if (showNrList()) {
        ...
        private void addLteEntry(int i) {
            if (showNrList()) {
                this.mEntries.add(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.network_lte_pure));
            } else {
                this.mEntries.add(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.network_lte));
            }
            this.mEntriesValue.add(Integer.valueOf(i));
        }
        ...
        private void add4gEntry(int i) {
            if (showNrList()) {
                this.mEntries.add(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.network_4G_pure));
            } else {
                this.mEntries.add(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.network_4G));
            }
            this.mEntriesValue.add(Integer.valueOf(i));
        }

        private void add3gEntry(int i) {
            this.mEntries.add(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.network_3G));
            this.mEntriesValue.add(Integer.valueOf(i));
        }

        private void add2gEntry(int i) {
            this.mEntries.add(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.network_2G));
            this.mEntriesValue.add(Integer.valueOf(i));
        }

        private void add1xEntry(int i) {
            this.mEntries.add(EnabledNetworkModePreferenceController.this.getResourcesForSubId().getString(C0444R.string.network_1x));
            this.mEntriesValue.add(Integer.valueOf(i));
        }
        ...
        public String[] getEntryValues() {
            return (String[]) Arrays.stream((Integer[]) this.mEntriesValue.toArray(new Integer[0])).map(C1044x7d702dd2.INSTANCE).toArray(C1045x7d702dd3.INSTANCE);
        }
        ...
        private void setSelectedEntry(int i) {
            if (this.mEntriesValue.stream().anyMatch(new C1046x7d702dd4(i))) {
    ...
    static /* synthetic */ class C10431 {
        ...
        static final /* synthetic */ int[] f161xa7d3c794;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f161xa7d3c794     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f161xa7d3c794     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f161xa7d3c794     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f161xa7d3c794     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f161xa7d3c794     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f161xa7d3c794     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f161xa7d3c794     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f161xa7d3c794     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f161xa7d3c794     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f161xa7d3c794     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settings.network.telephony.EnabledNetworkModePreferenceController.C10431.<clinit>():void");
        }
    }
