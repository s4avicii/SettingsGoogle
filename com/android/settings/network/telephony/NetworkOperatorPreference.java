...
public class NetworkOperatorPreference extends Preference {
    ...
    public void refresh() {
        ...
        if (isForbiddenNetwork()) {
            operatorName = operatorName + " " + getContext().getResources().getString(C0444R.string.forbidden_network);
        }
    ...
    private int getIconIdForCell(CellInfo cellInfo) {
        if (cellInfo instanceof CellInfoGsm) {
            return C0444R.C0447drawable.signal_strength_g;
        }
        if (cellInfo instanceof CellInfoCdma) {
            return C0444R.C0447drawable.signal_strength_1x;
        }
        if ((cellInfo instanceof CellInfoWcdma) || (cellInfo instanceof CellInfoTdscdma)) {
            return C0444R.C0447drawable.signal_strength_3g;
        }
        if (cellInfo instanceof CellInfoLte) {
            return this.mShow4GForLTE ? C0444R.C0447drawable.ic_signal_strength_4g : C0444R.C0447drawable.signal_strength_lte;
        }
        if (cellInfo instanceof CellInfoNr) {
            return C0444R.C0447drawable.signal_strength_5g;
        }
        return 0;
    }
