...
public class WifiCallingPreferenceController extends TelephonyBasePreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    public void updateState(Preference preference) {
        ...
        if (phoneAccountHandle != null) {
            ...
            preference.setTitle((CharSequence) SubscriptionManager.getResourcesForSubId(this.mContext, this.mSubId).getString(C0444R.string.wifi_calling_settings_title));
