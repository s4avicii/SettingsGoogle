...
public class ProviderModelSlice extends WifiSlice {
    ...
    public Slice getSlice() {
        ...
        for (WifiSliceItem wifiSliceItemRow : (List) results.stream().filter(ProviderModelSlice$$ExternalSyntheticLambda2.INSTANCE).limit((long) (i2 + -1)).collect(Collectors.toList())) {
            ...
            if (defaultSubscriptionIsUsable(defaultDataSubscriptionId)) {
                ...
                if (hasExtra) {
                    if (booleanExtra || (sharedPreferences = this.mSharedPref) == null || !sharedPreferences.getBoolean("PrefHasTurnedOffMobileData", true)) {
                        ...
                        if (mobileTitle.equals(this.mContext.getString(C0444R.string.mobile_data_settings_title))) {
                            mobileTitle = this.mContext.getString(C0444R.string.mobile_data_disable_message_default_carrier);
                        }
    ...
    public AlertDialog getMobileDataDisableDialog(int i, String str) {
        return new AlertDialog.Builder(this.mContext).setTitle(C0444R.string.mobile_data_disable_title).setMessage(this.mContext.getString(C0444R.string.mobile_data_disable_message, new Object[]{str})).setNegativeButton(17039360, new ProviderModelSlice$$ExternalSyntheticLambda0(this)).setPositiveButton(17039652, new ProviderModelSlice$$ExternalSyntheticLambda1(this, i)).create();
    }
    ...
    public Intent getIntent() {
        return SliceBuilderUtils.buildSearchResultPageIntent(this.mContext, NetworkProviderSettings.class.getName(), "", this.mContext.getText(C0444R.string.provider_internet_settings).toString(), 1401, (CustomSliceable) this).setClassName(this.mContext.getPackageName(), SubSettings.class.getName()).setData(getUri());
    }
    ...
    public ListBuilder.RowBuilder createEthernetRow() {
        ...
        Drawable drawable = this.mContext.getDrawable(C0444R.C0447drawable.ic_settings_ethernet);
        if (drawable != null) {
    ...
    public IconCompat getSeeAllIcon() {
        Drawable drawable = this.mContext.getDrawable(C0444R.C0447drawable.ic_arrow_forward);
        if (drawable == null) {
