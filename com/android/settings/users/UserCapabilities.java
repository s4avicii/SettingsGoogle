...
public class UserCapabilities {
    ...
    public static UserCapabilities create(Context context) {
        ...
        if (context.getResources().getBoolean(C0444R.bool.config_offer_restricted_profiles) && !devicePolicyManager.isDeviceManaged() && userManager.isUserTypeEnabled("android.os.usertype.full.RESTRICTED")) {
            z = true;
        }
