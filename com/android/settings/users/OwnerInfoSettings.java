...
public class OwnerInfoSettings extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        this.mView = LayoutInflater.from(getActivity()).inflate(C0444R.C0450layout.ownerinfo, (ViewGroup) null);
        initView();
        return new AlertDialog.Builder(getActivity()).setTitle((int) C0444R.string.owner_info_settings_title).setView(this.mView).setPositiveButton((int) C0444R.string.save, (DialogInterface.OnClickListener) this).setNegativeButton((int) C0444R.string.cancel, (DialogInterface.OnClickListener) this).show();
    }

    private void initView() {
        String ownerInfo = this.mLockPatternUtils.getOwnerInfo(this.mUserId);
        this.mOwnerInfo = (EditText) this.mView.findViewById(C0444R.C0448id.owner_info_edit_text);
