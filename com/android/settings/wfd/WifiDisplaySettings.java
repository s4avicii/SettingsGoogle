...
public final class WifiDisplaySettings extends SettingsPreferenceFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.wifi_display_settings);
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_remote_display;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C0444R.xml.wifi_display_settings);
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        textView.setText(C0444R.string.wifi_display_no_devices_found);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        ...
        if (!(wifiDisplayStatus == null || wifiDisplayStatus.getFeatureState() == 0)) {
            MenuItem add = menu.add(0, 1, 0, C0444R.string.wifi_display_enable_menu_item);
    ...
    private void buildCertificationMenu(PreferenceScreen preferenceScreen) {
        ...
        if (preferenceGroup == null) {
            ...
            preferenceCategory.setTitle((int) C0444R.string.wifi_display_certification_heading);
        ...
        if (!this.mWifiDisplayStatus.getSessionInfo().getGroupId().isEmpty()) {
            ...
            preference.setTitle((int) C0444R.string.wifi_display_session_info);
            ...
            if (this.mWifiDisplayStatus.getSessionInfo().getSessionId() != 0) {
                this.mCertCategory.addPreference(new Preference(getPrefContext()) {
                    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
                        ...
                        Button button = (Button) preferenceViewHolder.findViewById(C0444R.C0448id.left_button);
                        button.setText(C0444R.string.wifi_display_pause);
                        button.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View view) {
                                WifiDisplaySettings.this.mDisplayManager.pauseWifiDisplay();
                            }
                        });
                        Button button2 = (Button) preferenceViewHolder.findViewById(C0444R.C0448id.right_button);
                        button2.setText(C0444R.string.wifi_display_resume);
                ...
                this.mCertCategory.setLayoutResource(C0444R.C0450layout.two_buttons_panel);
            }
        }
        C13182 r11 = new SwitchPreference(getPrefContext()) {
        ...
        r11.setTitle((int) C0444R.string.wifi_display_listen_mode);
        r11.setChecked(this.mListen);
        this.mCertCategory.addPreference(r11);
        C13193 r112 = new SwitchPreference(getPrefContext()) {
            /* access modifiers changed from: protected */
            public void onClick() {
                WifiDisplaySettings wifiDisplaySettings = WifiDisplaySettings.this;
        ...
        r112.setTitle((int) C0444R.string.wifi_display_autonomous_go);
        ...
        listPreference.setTitle((int) C0444R.string.wifi_display_wps_config);
        ...
        listPreference2.setTitle((int) C0444R.string.wifi_display_listen_channel);
        ...
        listPreference3.setTitle((int) C0444R.string.wifi_display_operating_channel);
    ...
    public void setListenMode(final boolean z) {
        C13259 r0 = new WifiP2pManager.ActionListener() {
            public void onSuccess() {
            }
    ...
    public void showWifiDisplayOptionsDialog(final WifiDisplay wifiDisplay) {
        View inflate = getActivity().getLayoutInflater().inflate(C0444R.C0450layout.wifi_display_options, (ViewGroup) null);
        final EditText editText = (EditText) inflate.findViewById(C0444R.C0448id.name);
        editText.setText(wifiDisplay.getFriendlyDisplayName());
        C131211 r2 = new DialogInterface.OnClickListener() {
        ...
        new AlertDialog.Builder(getActivity()).setCancelable(true).setTitle((int) C0444R.string.wifi_display_options_title).setView(inflate).setPositiveButton((int) C0444R.string.wifi_display_options_done, (DialogInterface.OnClickListener) r2).setNegativeButton((int) C0444R.string.wifi_display_options_forget, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
        ...
        public RoutePreference(Context context, MediaRouter.RouteInfo routeInfo) {
            ...
            if (routeInfo.isSelected()) {
                ...
                if (routeInfo.isConnecting()) {
                    setSummary((int) C0444R.string.wifi_display_status_connecting);
                } else {
                    setSummary((int) C0444R.string.wifi_display_status_connected);
                }
            } else if (isEnabled()) {
                setOrder(3);
            } else {
                ...
                if (routeInfo.getStatusCode() == 5) {
                    setSummary((int) C0444R.string.wifi_display_status_in_use);
                } else {
                    setSummary((int) C0444R.string.wifi_display_status_not_available);
                }
            }
    ...
    private class WifiDisplayRoutePreference extends RoutePreference implements View.OnClickListener {
        ...
        public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
            super.onBindViewHolder(preferenceViewHolder);
            ImageView imageView = (ImageView) preferenceViewHolder.findViewById(C0444R.C0448id.settings_button);
            if (imageView != null) {
