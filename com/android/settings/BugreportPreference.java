...
public class BugreportPreference extends CustomDialogPreferenceCompat {
    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder, DialogInterface.OnClickListener onClickListener) {
        ...
        View inflate = View.inflate(getContext(), C0444R.C0450layout.bugreport_options_dialog, (ViewGroup) null);
        this.mInteractiveTitle = (CheckedTextView) inflate.findViewById(C0444R.C0448id.bugreport_option_interactive_title);
        this.mInteractiveSummary = (TextView) inflate.findViewById(C0444R.C0448id.bugreport_option_interactive_summary);
        this.mFullTitle = (CheckedTextView) inflate.findViewById(C0444R.C0448id.bugreport_option_full_title);
        this.mFullSummary = (TextView) inflate.findViewById(C0444R.C0448id.bugreport_option_full_summary);
        C05081 r1 = new View.OnClickListener() {
