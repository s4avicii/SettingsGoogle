...
public class ConfirmLockdownFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        return new AlertDialog.Builder(getActivity()).setTitle(z3 ? C0444R.string.vpn_require_connection_title : z ? C0444R.string.vpn_replace_vpn_title : C0444R.string.vpn_set_vpn_title).setMessage(z3 ? z ? C0444R.string.vpn_replace_always_on_vpn_enable_message : C0444R.string.vpn_first_always_on_vpn_message : z2 ? C0444R.string.vpn_replace_always_on_vpn_disable_message : C0444R.string.vpn_replace_vpn_message).setNegativeButton((int) C0444R.string.cancel, (DialogInterface.OnClickListener) null).setPositiveButton(z ? C0444R.string.vpn_replace : z3 ? C0444R.string.vpn_turn_on : C0444R.string.okay, (DialogInterface.OnClickListener) this).create();
    }
