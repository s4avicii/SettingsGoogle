...
public final class Utils extends com.android.settingslib.Utils {
    ...
    public static boolean isSettingsIntelligence(Context context) {
        return TextUtils.equals(context.getPackageManager().getPackagesForUid(Binder.getCallingUid())[0], context.getString(C0444R.string.config_settingsintelligence_package_name));
    }
