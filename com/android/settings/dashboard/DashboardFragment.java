...
public abstract class DashboardFragment extends SettingsPreferenceFragment implements CategoryMixin.CategoryListener, PreferenceGroup.OnExpandButtonClickListener, BasePreferenceController.UiBlockListener {
    ...
    public void onAttach(Context context) {
        ...
        this.mSuppressInjectedTileKeys = Arrays.asList(context.getResources().getStringArray(C0444R.array.config_suppress_injected_tile_keys));
        ...
        filterControllers.forEach(new DashboardFragment$$ExternalSyntheticLambda10(getSettingsLifecycle()));
        this.mControllers.forEach(new DashboardFragment$$ExternalSyntheticLambda3(getMetricsCategory()));
    ...
    public void checkUiBlocker(List<AbstractPreferenceController> list) {
        ...
        list.forEach(new DashboardFragment$$ExternalSyntheticLambda9(this, arrayList));
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        this.mControllers.stream().map(new DashboardFragment$$ExternalSyntheticLambda11(this)).filter(DashboardFragment$$ExternalSyntheticLambda13.INSTANCE).forEach(new DashboardFragment$$ExternalSyntheticLambda5(this));
    }
    ...
    public void onStart() {
        ...
        if (this.mDashboardFeatureProvider.getTilesForCategory(getCategoryKey()) != null) {
            ...
            this.mDashboardTilePrefKeys.values().stream().filter(DashboardFragment$$ExternalSyntheticLambda14.INSTANCE).flatMap(DashboardFragment$$ExternalSyntheticLambda12.INSTANCE).forEach(new DashboardFragment$$ExternalSyntheticLambda6(this, getContentResolver()));
        }
    }
    ...
    public void displayResourceTilesToScreen(PreferenceScreen preferenceScreen) {
        this.mPreferenceControllers.values().stream().flatMap(DashboardFragment$$ExternalSyntheticLambda12.INSTANCE).forEach(new DashboardFragment$$ExternalSyntheticLambda4(preferenceScreen));
    }
        ...
        for (Tile next : tiles) {
            ...
            if (TextUtils.isEmpty(dashboardKeyForTile)) {
                ...
                if (this.mDashboardTilePrefKeys.containsKey(dashboardKeyForTile)) {
                    ...
                    this.mDashboardFeatureProvider.bindPreferenceToTileAndGetObservers(getActivity(), this, shouldForceRoundedIcon, findPreference, next, dashboardKeyForTile, this.mPlaceholderPreferenceController.getOrder());
                } else {
                    Preference createPreference = createPreference(next);
                    List<DynamicDataObserver> bindPreferenceToTileAndGetObservers = this.mDashboardFeatureProvider.bindPreferenceToTileAndGetObservers(getActivity(), this, shouldForceRoundedIcon, createPreference, next, dashboardKeyForTile, this.mPlaceholderPreferenceController.getOrder());
    ...
    public void registerDynamicDataObservers(List<DynamicDataObserver> list) {
        if (list != null && !list.isEmpty()) {
            list.forEach(new DashboardFragment$$ExternalSyntheticLambda8(this, getContentResolver()));
        }
    }
    ...
    private void unregisterDynamicDataObservers(List<DynamicDataObserver> list) {
        if (list != null && !list.isEmpty()) {
            list.forEach(new DashboardFragment$$ExternalSyntheticLambda7(this, getContentResolver()));
        }
    }
    ...
    public void replaceEnterpriseStringTitle(String str, String str2, int i) {
        ...
        findPreference.setTitle((CharSequence) this.mDevicePolicyManager.getString(str2, new DashboardFragment$$ExternalSyntheticLambda1(this, i)));
    }
    ...
    public void replaceEnterpriseStringSummary(String str, String str2, int i) {
        ...
        findPreference.setSummary((CharSequence) this.mDevicePolicyManager.getString(str2, new DashboardFragment$$ExternalSyntheticLambda2(this, i)));
    }
