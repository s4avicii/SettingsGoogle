...
public class SummaryProvider extends ContentProvider {
    ...
    public Bundle call(String str, String str2, Bundle bundle) {
        ...
        if (str.equals("backup")) {
            ...
            bundle2.putString("com.android.settings.summary", context.getString(C0444R.string.users_summary, new Object[]{((UserManager) context.getSystemService(UserManager.class)).getUserInfo(UserHandle.myUserId()).name}));
        } else {
