...
public class ContextualCardLookupTable {
    static final Set<ControllerRendererMapping> LOOKUP_TABLE = new TreeSet<ControllerRendererMapping>() {
        {
            ...
            add(new ControllerRendererMapping(3, C0444R.C0450layout.conditional_card_half_tile, cls4, cls));
            add(new ControllerRendererMapping(3, C0444R.C0450layout.conditional_card_full_tile, cls4, cls));
            add(new ControllerRendererMapping(2, C0444R.C0450layout.legacy_suggestion_tile, LegacySuggestionContextualCardController.class, LegacySuggestionContextualCardRenderer.class));
            add(new ControllerRendererMapping(1, C0444R.C0450layout.contextual_slice_full_tile, cls3, cls2));
            add(new ControllerRendererMapping(1, C0444R.C0450layout.contextual_slice_half_tile, cls3, cls2));
            add(new ControllerRendererMapping(1, C0444R.C0450layout.contextual_slice_sticky_tile, cls3, cls2));
            add(new ControllerRendererMapping(5, C0444R.C0450layout.conditional_card_footer, cls4, ConditionFooterContextualCardRenderer.class));
            add(new ControllerRendererMapping(4, C0444R.C0450layout.conditional_card_header, cls4, ConditionHeaderContextualCardRenderer.class));
        }
    };
    ...
    static class ControllerRendererMapping implements Comparable<ControllerRendererMapping> {
        ...
        public int compareTo(ControllerRendererMapping controllerRendererMapping) {
            return Comparator.comparingInt(C0960xd5f016ad.INSTANCE).thenComparingInt(C0961xd5f016ae.INSTANCE).compare(this, controllerRendererMapping);
        }
    }
