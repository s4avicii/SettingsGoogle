...
public class SliceContextualCardRenderer implements ContextualCardRenderer, LifecycleObserver {
    ...
    public RecyclerView.ViewHolder createViewHolder(View view, int i) {
        if (i == C0444R.C0450layout.contextual_slice_half_tile) {
    ...
    public void bindView(RecyclerView.ViewHolder viewHolder, ContextualCard contextualCard) {
        ...
        if (viewHolder.getItemViewType() != C0444R.C0450layout.contextual_slice_half_tile) {
        ...
        View findViewById = viewHolder.itemView.findViewById(C0444R.C0448id.dismissal_swipe_background);
        ...
        if (viewHolder.getItemViewType() != C0444R.C0450layout.contextual_slice_sticky_tile) {
    ...
    private void initDismissalActions(RecyclerView.ViewHolder viewHolder, final ContextualCard contextualCard) {
        ((Button) viewHolder.itemView.findViewById(C0444R.C0448id.keep)).setOnClickListener(new SliceContextualCardRenderer$$ExternalSyntheticLambda0(this, viewHolder));
        ((Button) viewHolder.itemView.findViewById(C0444R.C0448id.remove)).setOnClickListener(new SliceContextualCardRenderer$$ExternalSyntheticLambda1(this, contextualCard, viewHolder));
    ...
    public void lambda$onStop$5(RecyclerView.ViewHolder viewHolder) {
        viewHolder.itemView.findViewById(C0444R.C0448id.dismissal_view).setVisibility(8);
        getInitialView(viewHolder).setVisibility(0);
    }

    private void showDismissalView(RecyclerView.ViewHolder viewHolder) {
        viewHolder.itemView.findViewById(C0444R.C0448id.dismissal_view).setVisibility(0);
