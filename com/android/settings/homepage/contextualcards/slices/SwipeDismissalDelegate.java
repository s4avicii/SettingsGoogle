...
public class SwipeDismissalDelegate extends ItemTouchHelper.Callback {
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        if ((viewHolder.getItemViewType() == C0444R.C0450layout.contextual_slice_full_tile || viewHolder.getItemViewType() == C0444R.C0450layout.contextual_slice_half_tile) && viewHolder.itemView.findViewById(C0444R.C0448id.dismissal_view).getVisibility() != 0) {
    ...
    public void onChildDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float f, float f2, int i, boolean z) {
        ...
        View findViewById = viewHolder.itemView.findViewById(C0444R.C0448id.dismissal_icon_start);
        View findViewById2 = viewHolder.itemView.findViewById(C0444R.C0448id.dismissal_icon_end);
        if (f > 0.0f) {
