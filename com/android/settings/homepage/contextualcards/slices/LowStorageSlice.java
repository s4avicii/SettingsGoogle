...
public class LowStorageSlice implements CustomSliceable {
    ...
    public int getSliceHighlightMenuRes() {
        return C0444R.string.menu_key_storage;
    }
    ...
    public Slice getSlice() {
        ...
        IconCompat createWithResource = IconCompat.createWithResource(this.mContext, C0444R.C0447drawable.ic_storage);
        if (d < 0.85d) {
            return accentColor.addRow(buildRowBuilder(this.mContext.getText(C0444R.string.storage_settings), this.mContext.getString(C0444R.string.storage_summary, new Object[]{format, formatFileSize}), createWithResource)).setIsError(true).build();
        }
        return accentColor.addRow(buildRowBuilder(this.mContext.getText(C0444R.string.storage_menu_free), this.mContext.getString(C0444R.string.low_storage_summary, new Object[]{format, formatFileSize}), createWithResource)).build();
    }
    ...
    public Intent getIntent() {
        return SliceBuilderUtils.buildSearchResultPageIntent(this.mContext, StorageDashboardFragment.class.getName(), "", this.mContext.getText(C0444R.string.storage_label).toString(), 1401, (CustomSliceable) this).setClassName(this.mContext.getPackageName(), SubSettings.class.getName()).setData(CustomSliceRegistry.LOW_STORAGE_SLICE_URI);
    }
