...
public class BatteryFixSlice implements CustomSliceable {
    ...
    public Intent getIntent() {
        String charSequence = this.mContext.getText(C0444R.string.power_usage_summary_title).toString();
    ...
    private Slice buildBatteryGoodSlice(ListBuilder listBuilder, boolean z) {
        IconCompat createWithResource = IconCompat.createWithResource(this.mContext, C0444R.C0447drawable.ic_battery_status_good_24dp);
        String string = this.mContext.getString(C0444R.string.power_usage_summary_title);
