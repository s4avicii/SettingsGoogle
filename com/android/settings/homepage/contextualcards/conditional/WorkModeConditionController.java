...
public class WorkModeConditionController implements ConditionalCardController {
    ...
    /* renamed from: ID */
    static final int f158ID = Objects.hash(new Object[]{"WorkModeConditionController"});
    ...
    public ContextualCard buildContextualCard() {
        String string = this.mDpm.getString("Settings.WORK_PROFILE_OFF_CONDITION_TITLE", new WorkModeConditionController$$ExternalSyntheticLambda0(this));
        ConditionalContextualCard.Builder actionText = new ConditionalContextualCard.Builder().setConditionId((long) f158ID).setMetricsConstant(383).setActionText(this.mAppContext.getText(C0444R.string.condition_turn_on));
        return actionText.setName(this.mAppContext.getPackageName() + "/" + string).setTitleText(string).setSummaryText(this.mAppContext.getText(C0444R.string.condition_work_summary).toString()).setIconDrawable(this.mAppContext.getDrawable(C0444R.C0447drawable.ic_signal_workmode_enable)).setViewType(C0444R.C0450layout.conditional_card_half_tile).build();
    }

    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$buildContextualCard$0() throws Exception {
        return this.mAppContext.getString(C0444R.string.condition_work_title);
    }
