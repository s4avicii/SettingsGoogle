...
public class GrayscaleConditionController implements ConditionalCardController {
    ...
    /* renamed from: ID */
    static final int f153ID = Objects.hash(new Object[]{"GrayscaleConditionController"});
    ...
    public boolean isDisplayable() {
        try {
            this.mIntent = Intent.parseUri(this.mAppContext.getString(C0444R.string.config_grayscale_settings_intent), 1);
    ...
    public ContextualCard buildContextualCard() {
        ConditionalContextualCard.Builder actionText = new ConditionalContextualCard.Builder().setConditionId((long) f153ID).setMetricsConstant(1683).setActionText(this.mAppContext.getText(C0444R.string.condition_turn_off));
        return actionText.setName(this.mAppContext.getPackageName() + "/" + this.mAppContext.getText(C0444R.string.condition_grayscale_title)).setTitleText(this.mAppContext.getText(C0444R.string.condition_grayscale_title).toString()).setSummaryText(this.mAppContext.getText(C0444R.string.condition_grayscale_summary).toString()).setIconDrawable(this.mAppContext.getDrawable(C0444R.C0447drawable.ic_gray_scale_24dp)).setViewType(C0444R.C0450layout.conditional_card_half_tile).build();
    }
