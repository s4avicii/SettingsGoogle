...
public class HotspotConditionController implements ConditionalCardController {
    ...
    /* renamed from: ID */
    static final int f154ID = Objects.hash(new Object[]{"HotspotConditionController"});
    ...
    public void onPrimaryClick(Context context) {
        new SubSettingLauncher(context).setDestination(TetherSettings.class.getName()).setSourceMetricsCategory(35).setTitleRes(C0444R.string.tether_settings_title_all).launch();
    }
    ...
    public ContextualCard buildContextualCard() {
        ConditionalContextualCard.Builder actionText = new ConditionalContextualCard.Builder().setConditionId((long) f154ID).setMetricsConstant(382).setActionText(this.mAppContext.getText(C0444R.string.condition_turn_off));
        return actionText.setName(this.mAppContext.getPackageName() + "/" + this.mAppContext.getText(C0444R.string.condition_hotspot_title)).setTitleText(this.mAppContext.getText(C0444R.string.condition_hotspot_title).toString()).setSummaryText(getSsid().toString()).setIconDrawable(this.mAppContext.getDrawable(C0444R.C0447drawable.ic_hotspot)).setViewType(C0444R.C0450layout.conditional_card_half_tile).build();
    }
