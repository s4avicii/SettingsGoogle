...
public class ConditionHeaderContextualCardRenderer implements ContextualCardRenderer {
    ...
    public /* synthetic */ void lambda$bindView$0(ConditionHeaderCardHolder conditionHeaderCardHolder, ContextualCard contextualCard) {
        ImageView imageView = (ImageView) LayoutInflater.from(this.mContext).inflate(C0444R.C0450layout.conditional_card_header_icon, conditionHeaderCardHolder.icons, false);
    ...
    public static class ConditionHeaderCardHolder extends RecyclerView.ViewHolder {
        ...
        public ConditionHeaderCardHolder(View view) {
            super(view);
            this.icons = (LinearLayout) view.findViewById(C0444R.C0448id.header_icons_container);
            this.expandIndicator = (ImageView) view.findViewById(C0444R.C0448id.expand_indicator);
        }
    }
}
