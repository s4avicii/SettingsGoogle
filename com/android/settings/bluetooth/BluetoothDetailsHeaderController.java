...
public class BluetoothDetailsHeaderController extends BluetoothDetailsController {
    ...
    public void init(PreferenceScreen preferenceScreen) {
        ...
        this.mHeaderController = EntityHeaderController.newInstance(this.mFragment.getActivity(), this.mFragment, layoutPreference.findViewById(C0444R.C0448id.entity_header));
