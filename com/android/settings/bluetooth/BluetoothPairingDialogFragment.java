...
public class BluetoothPairingDialogFragment extends InstrumentedDialogFragment implements TextWatcher, DialogInterface.OnClickListener {
    ...
    private AlertDialog createUserEntryDialog() {
        this.mBuilder.setTitle((CharSequence) getString(C0444R.string.bluetooth_pairing_request, this.mPairingController.getDeviceName()));
    ...
    private View createPinEntryView() {
        View inflate = getActivity().getLayoutInflater().inflate(C0444R.C0450layout.bluetooth_pin_entry, (ViewGroup) null);
        TextView textView = (TextView) inflate.findViewById(C0444R.C0448id.pin_values_hint);
        TextView textView2 = (TextView) inflate.findViewById(C0444R.C0448id.message_below_pin);
        CheckBox checkBox = (CheckBox) inflate.findViewById(C0444R.C0448id.alphanumeric_pin);
        CheckBox checkBox2 = (CheckBox) inflate.findViewById(C0444R.C0448id.phonebook_sharing_message_entry_pin);
        checkBox2.setText(getString(C0444R.string.bluetooth_pairing_shares_phonebook, this.mPairingController.getDeviceName()));
        EditText editText = (EditText) inflate.findViewById(C0444R.C0448id.text);
    ...
    private AlertDialog createConfirmationDialog() {
        ...
        this.mBuilder.setPositiveButton((CharSequence) getString(C0444R.string.bluetooth_pairing_accept), (DialogInterface.OnClickListener) this);
        this.mBuilder.setNegativeButton((CharSequence) getString(C0444R.string.bluetooth_pairing_decline), (DialogInterface.OnClickListener) this);
    ...
    private View createView() {
        View inflate = getActivity().getLayoutInflater().inflate(C0444R.C0450layout.bluetooth_pin_confirm, (ViewGroup) null);
        TextView textView = (TextView) inflate.findViewById(C0444R.C0448id.pairing_caption);
        TextView textView2 = (TextView) inflate.findViewById(C0444R.C0448id.pairing_subhead);
        TextView textView3 = (TextView) inflate.findViewById(C0444R.C0448id.pairing_code_message);
        CheckBox checkBox = (CheckBox) inflate.findViewById(C0444R.C0448id.phonebook_sharing_message_confirm_pin);
        int i = 0;
        checkBox.setText(getString(C0444R.string.bluetooth_pairing_shares_phonebook, this.mPairingController.getDeviceName()));
        ...
        TextView textView4 = (TextView) inflate.findViewById(C0444R.C0448id.pairing_group_message);
