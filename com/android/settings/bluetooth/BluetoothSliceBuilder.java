...
public class BluetoothSliceBuilder {
    ...
    public static Slice getSlice(Context context) {
        ...
        CharSequence text = context.getText(C0444R.string.bluetooth_settings);
    ...
    public static Intent getIntent(Context context) {
        String charSequence = context.getText(C0444R.string.bluetooth_settings_title).toString();
        return SliceBuilderUtils.buildSearchResultPageIntent(context, BluetoothDashboardFragment.class.getName(), (String) null, charSequence, 747, (int) C0444R.string.menu_key_connected_devices).setClassName(context.getPackageName(), SubSettings.class.getName()).setData(new Uri.Builder().appendPath("bluetooth").build());
    }
