...
public class AndroidBeam extends InstrumentedFragment implements OnMainSwitchChangeListener {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        ...
        HelpUtils.prepareHelpMenuItem((Activity) getActivity(), menu, (int) C0444R.string.help_uri_beam, getClass().getName());
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (hasBaseUserRestriction || checkIfRestrictionEnforced == null) {
            View inflate = layoutInflater.inflate(C0444R.C0450layout.preference_footer, viewGroup, false);
            this.mView = inflate;
            ((ImageView) inflate.findViewById(16908294)).setImageResource(C0444R.C0447drawable.ic_info_outline_24dp);
            ((TextView) this.mView.findViewById(16908310)).setText(C0444R.string.android_beam_explained);
            return this.mView;
        }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        settingsActivity.setTitle((int) C0444R.string.android_beam_settings_title);
    }
