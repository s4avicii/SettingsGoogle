...
public class DoubleTapScreenSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.double_tap_screen_settings);

    public int getHelpResource() {
        return C0444R.string.help_url_double_tap_screen;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.double_tap_screen_settings;
    }
