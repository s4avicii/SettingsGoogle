...
public class SwipeToNotificationSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.swipe_to_notification_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.swipe_to_notification_settings;
    }
