...
public class TapScreenGestureSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.tap_screen_gesture_settings);
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.tap_screen_gesture_settings;
    }
