...
public class SystemNavigationGestureSettings extends RadioButtonPickerFragment implements HelpResourceProvider {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.system_navigation_gesture_settings) {
    ...
    public int getHelpResource() {
        return C0444R.string.help_uri_default;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.system_navigation_gesture_settings;
    }
    ...
    public void bindPreferenceExtra(SelectorWithWidgetPreference selectorWithWidgetPreference, String str, CandidateInfo candidateInfo, String str2, String str3) {
        if (candidateInfo instanceof CandidateInfoExtra) {
            ...
            if (KEY_SYSTEM_NAV_GESTURAL.equals(candidateInfo.getKey())) {
                selectorWithWidgetPreference.setExtraWidgetOnClickListener(new SystemNavigationGestureSettings$$ExternalSyntheticLambda3(this));
            }
    ...
    public List<? extends CandidateInfo> getCandidates() {
        ...
        if (SystemNavigationPreferenceController.isOverlayPackageAvailable(context, "com.android.internal.systemui.navbar.gestural")) {
            arrayList.add(new CandidateInfoExtra(context.getText(C0444R.string.edge_to_edge_navigation_title), context.getText(C0444R.string.edge_to_edge_navigation_summary), KEY_SYSTEM_NAV_GESTURAL, true));
        }
        if (SystemNavigationPreferenceController.isOverlayPackageAvailable(context, "com.android.internal.systemui.navbar.twobutton")) {
            arrayList.add(new CandidateInfoExtra(context.getText(C0444R.string.swipe_up_to_switch_apps_title), context.getText(C0444R.string.swipe_up_to_switch_apps_summary), KEY_SYSTEM_NAV_2BUTTONS, true));
        }
        if (SystemNavigationPreferenceController.isOverlayPackageAvailable(context, "com.android.internal.systemui.navbar.threebutton")) {
            arrayList.add(new CandidateInfoExtra(context.getText(C0444R.string.legacy_navigation_title), context.getText(C0444R.string.legacy_navigation_summary), KEY_SYSTEM_NAV_3BUTTONS, true));
        }
        return arrayList;
    }
    ...
    private static void setIllustrationVideo(IllustrationPreference illustrationPreference, String str) {
        ...
        switch (c) {
            case 0:
                illustrationPreference.setLottieAnimationResId(C0444R.raw.lottie_system_nav_2_button);
                return;
            case 1:
                illustrationPreference.setLottieAnimationResId(C0444R.raw.lottie_system_nav_fully_gestural);
                return;
            case 2:
                illustrationPreference.setLottieAnimationResId(C0444R.raw.lottie_system_nav_3_button);
                return;
            default:
                return;
        }
    ...
    private void setGestureNavigationTutorialDialog(String str) {
        ...
        AccessibilityGestureNavigationTutorial.showGestureNavigationTutorialDialog(getContext(), new SystemNavigationGestureSettings$$ExternalSyntheticLambda1(this));
    }
