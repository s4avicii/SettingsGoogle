...
public class PreventRingingGestureSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.prevent_ringing_gesture_settings) {
    ...
    public int getHelpResource() {
        return C0444R.string.help_uri_prevent_ringing_gesture;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.prevent_ringing_gesture_settings;
    }
