...
public class GestureNavigationSettingsFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.gesture_navigation_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.gesture_navigation_settings;
    }
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        this.mDefaultBackGestureInset = (float) resources.getDimensionPixelSize(17105062);
