...
public class SwitchBar extends LinearLayout implements CompoundButton.OnCheckedChangeListener {
    private static final int[] XML_ATTRIBUTES = {C0444R.attr.switchBarMarginStart, C0444R.attr.switchBarMarginEnd, C0444R.attr.switchBarBackgroundColor, C0444R.attr.switchBarBackgroundActivatedColor, C0444R.attr.switchBarRestrictionIcon};
    ...
    public SwitchBar(final Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        LayoutInflater.from(context).inflate(C0444R.C0450layout.switch_bar, this);
        setFocusable(true);
        setClickable(true);
        ...
        this.mTextView = (TextView) findViewById(C0444R.C0448id.switch_text);
        this.mSummarySpan = new TextAppearanceSpan(this.mContext, C0444R.style.TextAppearance_Small_SwitchBar);
        ...
        ToggleSwitch toggleSwitch = (ToggleSwitch) findViewById(C0444R.C0448id.switch_widget);
        ...
        setSwitchBarText(C0444R.string.switch_on_text, C0444R.string.switch_off_text);
        addOnSwitchChangeListener(new SwitchBar$$ExternalSyntheticLambda0(this));
        ImageView imageView = (ImageView) findViewById(C0444R.C0448id.restricted_icon);
