...
public class LabeledSeekBarPreference extends SeekBarPreference {
    ...
    public LabeledSeekBarPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        setLayoutResource(C0444R.C0450layout.preference_labeled_slider);
    ...
    public LabeledSeekBarPreference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, TypedArrayUtils.getAttr(context, C0444R.attr.seekBarPreferenceStyle, 17957081), 0);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        preferenceViewHolder.findViewById(C0444R.C0448id.label_frame).setVisibility(this.mTextStartId > 0 || this.mTextEndId > 0 ? 0 : 8);
        ...
        updateIconStartIfNeeded((ViewGroup) preferenceViewHolder.findViewById(C0444R.C0448id.icon_start_frame), (ImageView) preferenceViewHolder.findViewById(C0444R.C0448id.icon_start), seekBar);
        updateIconEndIfNeeded((ViewGroup) preferenceViewHolder.findViewById(C0444R.C0448id.icon_end_frame), (ImageView) preferenceViewHolder.findViewById(C0444R.C0448id.icon_end), seekBar);
    }
