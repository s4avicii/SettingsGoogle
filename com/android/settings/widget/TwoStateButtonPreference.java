...
public class TwoStateButtonPreference extends LayoutPreference implements View.OnClickListener {
    ...
    public TwoStateButtonPreference(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, TypedArrayUtils.getAttr(context, C0444R.attr.twoStateButtonPreferenceStyle, 16842894));
        ...
        int resourceId = obtainStyledAttributes.getResourceId(1, C0444R.string.summary_placeholder);
        int resourceId2 = obtainStyledAttributes.getResourceId(0, C0444R.string.summary_placeholder);
        obtainStyledAttributes.recycle();
        Button button = (Button) findViewById(C0444R.C0448id.state_on_button);
        this.mButtonOn = button;
        button.setText(resourceId);
        button.setOnClickListener(this);
        Button button2 = (Button) findViewById(C0444R.C0448id.state_off_button);
    ...
    public void onClick(View view) {
        boolean z = view.getId() == C0444R.C0448id.state_on_button;
        setChecked(z);
