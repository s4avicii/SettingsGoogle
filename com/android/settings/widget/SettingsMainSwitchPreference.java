...
public class SettingsMainSwitchPreference extends TwoStatePreference implements OnMainSwitchChangeListener {
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        this.mMainSwitchBar = (SettingsMainSwitchBar) preferenceViewHolder.findViewById(C0444R.C0448id.main_switch_bar);
        initMainSwitchBar();
        if (isVisible()) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        setLayoutResource(C0444R.C0450layout.preference_widget_main_switch);
