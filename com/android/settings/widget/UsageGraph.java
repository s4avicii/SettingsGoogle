...
public class UsageGraph extends View {
    ...
    public UsageGraph(Context context, AttributeSet attributeSet) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0444R.dimen.usage_graph_line_corner_radius);
        this.mCornerRadius = dimensionPixelSize;
        paint.setPathEffect(new CornerPathEffect((float) dimensionPixelSize));
        paint.setStrokeWidth((float) resources.getDimensionPixelSize(C0444R.dimen.usage_graph_line_width));
        ...
        float dimensionPixelSize2 = (float) resources.getDimensionPixelSize(C0444R.dimen.usage_graph_dot_size);
        paint3.setStrokeWidth(3.0f * dimensionPixelSize2);
        paint3.setPathEffect(new DashPathEffect(new float[]{dimensionPixelSize2, (float) resources.getDimensionPixelSize(C0444R.dimen.usage_graph_dot_interval)}, 0.0f));
        paint3.setColor(context.getColor(C0444R.C0446color.usage_graph_dots));
        ...
        this.mDividerSize = resources.getDimensionPixelSize(C0444R.dimen.usage_graph_divider_size);
    }
