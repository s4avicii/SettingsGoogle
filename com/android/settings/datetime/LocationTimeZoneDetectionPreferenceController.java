...
public class LocationTimeZoneDetectionPreferenceController extends TogglePreferenceController implements LifecycleObserver, OnStart, OnStop, TimeManager.TimeZoneDetectorListener {
    ...
    public CharSequence getSummary() {
        ...
        if (configureGeoDetectionEnabledCapability == 10) {
            i = C0444R.string.location_time_zone_detection_not_supported;
        } else if (configureGeoDetectionEnabledCapability == 20) {
            i = C0444R.string.location_time_zone_detection_not_allowed;
        } else if (configureGeoDetectionEnabledCapability == 30) {
            i = !this.mLocationManager.isLocationEnabled() ? C0444R.string.location_app_permission_summary_location_off : !configuration.isAutoDetectionEnabled() ? C0444R.string.location_time_zone_detection_auto_is_off : C0444R.string.location_time_zone_detection_not_applicable;
