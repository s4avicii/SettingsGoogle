...
public class ResetNetworkConfirm extends InstrumentedFragment {
    ...
    private class ResetNetworkTask extends AsyncTask<Void, Void, Boolean> {
        ...
        public void onPostExecute(Boolean bool) {
            ...
            if (bool.booleanValue()) {
                Toast.makeText(this.mContext, C0444R.string.reset_network_complete_toast, 0).show();
            } else {
                ResetNetworkConfirm.this.mAlertDialog = new AlertDialog.Builder(this.mContext).setTitle((int) C0444R.string.reset_esim_error_title).setMessage((int) C0444R.string.reset_esim_error_msg).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).show();
            }
        }
    }
    ...
    public ProgressDialog getProgressDialog(Context context) {
        ...
        progressDialog.setMessage(context.getString(C0444R.string.main_clear_progress_text));
    ...
    private void establishFinalConfirmationState() {
        this.mContentView.findViewById(C0444R.C0448id.execute_reset_network).setOnClickListener(this.mFinalClickListener);
    }

    /* access modifiers changed from: package-private */
    public void setSubtitle() {
        if (this.mEraseEsim) {
            ((TextView) this.mContentView.findViewById(C0444R.C0448id.reset_network_confirm)).setText(C0444R.string.reset_network_final_desc_esim);
        }
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mContentView = layoutInflater.inflate(C0444R.C0450layout.reset_network_confirm, (ViewGroup) null);
