...
public class AutomaticStorageManagerSettings extends DashboardFragment implements Preference.OnPreferenceChangeListener {
    ...
    public int getHelpResource() {
        return C0444R.string.help_uri_storage;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.automatic_storage_management_settings;
    }
    ...
    private void initializeDaysToRetainPreference() {
        ...
        String[] stringArray = getResources().getStringArray(C0444R.array.automatic_storage_management_days_values);
    ...
    private void initializeSwitchBar() {
        ...
        switchBar.setTitle(getContext().getString(C0444R.string.automatic_storage_manager_primary_switch_title));
