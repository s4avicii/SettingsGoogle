...
public class InstallCertificateFromStorage extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.install_certificate_from_storage) {
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_install_certificate;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.install_certificate_from_storage;
    }
