...
public class ScreenLockSettings extends DashboardFragment implements OwnerInfoPreferenceController.OwnerInfoCallback {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.screen_lock_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.screen_lock_settings;
    }
