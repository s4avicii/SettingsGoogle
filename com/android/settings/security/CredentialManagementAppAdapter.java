...
public class CredentialManagementAppAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View view) {
            super(view);
            this.mAppIconView = (ImageView) view.findViewById(C0444R.C0448id.credential_management_app_icon);
            this.mTitleView = (TextView) view.findViewById(C0444R.C0448id.credential_management_app_title);
        }
        ...
        public void bindView() {
            try {
                ...
                this.mTitleView.setText(TextUtils.expandTemplate(CredentialManagementAppAdapter.this.mContext.getText(C0444R.string.request_manage_credentials_title), new CharSequence[]{applicationInfo.loadLabel(CredentialManagementAppAdapter.this.mPackageManager)}));
            } catch (PackageManager.NameNotFoundException unused) {
                this.mAppIconView.setImageDrawable((Drawable) null);
                this.mTitleView.setText(TextUtils.expandTemplate(CredentialManagementAppAdapter.this.mContext.getText(C0444R.string.request_manage_credentials_title), new CharSequence[]{CredentialManagementAppAdapter.this.mCredentialManagerPackage}));
            }
        }
    }
    ...
    public class AppAuthenticationViewHolder extends RecyclerView.ViewHolder {
        ...
        public AppAuthenticationViewHolder(View view) {
            super(view);
            this.mAppIconView = (ImageView) view.findViewById(C0444R.C0448id.app_icon);
            this.mAppNameView = (TextView) view.findViewById(C0444R.C0448id.app_name);
            this.mNumberOfUrisView = (TextView) view.findViewById(C0444R.C0448id.number_of_uris);
            ImageView imageView = (ImageView) view.findViewById(C0444R.C0448id.expand);
            this.mExpanderIconView = imageView;
            this.mChildRecyclerView = (RecyclerView) view.findViewById(C0444R.C0448id.uris);
            if (CredentialManagementAppAdapter.this.mIsLayoutRtl) {
                RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) ((RelativeLayout) view.findViewById(C0444R.C0448id.app_details)).getLayoutParams();
                layoutParams.addRule(0, C0444R.C0448id.app_icon);
                layoutParams.addRule(1, C0444R.C0448id.expand);
                view.setLayoutParams(layoutParams);
            }
            imageView.setOnClickListener(new C1241xabc7f6bd(this));
        }
        ...
        private void bindPolicyView(String str) {
            if (CredentialManagementAppAdapter.this.mIncludeExpander) {
                ...
                if (this.mExpandedApps.contains(str)) {
                    ...
                    this.mExpanderIconView.setImageResource(C0444R.C0447drawable.ic_expand_less);
        ...
        private String getNumberOfUrlsText(Map<Uri, String> map) {
            return CredentialManagementAppAdapter.this.mContext.getResources().getQuantityString(C0444R.plurals.number_of_urls, map.size(), new Object[]{Integer.valueOf(map.size())});
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (i != 1) {
            return new AppAuthenticationViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C0444R.C0450layout.app_authentication_item, viewGroup, false));
        }
        View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(C0444R.C0450layout.request_manage_credentials_header, viewGroup, false);
