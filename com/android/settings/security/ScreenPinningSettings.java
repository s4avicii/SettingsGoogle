...
public class ScreenPinningSettings extends SettingsPreferenceFragment implements OnMainSwitchChangeListener, DialogInterface.OnClickListener {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        public List<SearchIndexableResource> getXmlResourcesToIndex(Context context, boolean z) {
            ...
            searchIndexableResource.xmlResId = C0444R.xml.screen_pinning_settings;
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_screen_pinning;
    }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        settingsActivity.setTitle((int) C0444R.string.screen_pinning_title);
        ...
        addPreferencesFromResource(C0444R.xml.screen_pinning_settings);
        ...
        switchBar.setTitle(getContext().getString(C0444R.string.app_pinning_main_switch_title));
    ...
    private int getCurrentSecurityTitle() {
        ...
        if (keyguardStoredPasswordQuality == 65536) {
            return this.mLockPatternUtils.isLockPatternEnabled(UserHandle.myUserId()) ? C0444R.string.screen_pinning_unlock_pattern : C0444R.string.screen_pinning_unlock_none;
        }
        if (keyguardStoredPasswordQuality == 131072 || keyguardStoredPasswordQuality == 196608) {
            return C0444R.string.screen_pinning_unlock_pin;
        }
        return (keyguardStoredPasswordQuality == 262144 || keyguardStoredPasswordQuality == 327680 || keyguardStoredPasswordQuality == 393216 || keyguardStoredPasswordQuality == 524288) ? C0444R.string.screen_pinning_unlock_password : C0444R.string.screen_pinning_unlock_none;
    }

    public void onSwitchChanged(Switch switchR, boolean z) {
        if (z) {
            new AlertDialog.Builder(getContext()).setMessage((int) C0444R.string.screen_pinning_dialog_message).setPositiveButton((int) C0444R.string.dlg_ok, (DialogInterface.OnClickListener) this).setNegativeButton((int) C0444R.string.dlg_cancel, (DialogInterface.OnClickListener) this).setCancelable(false).show();
            return;
        }
    ...
    private CharSequence getAppPinningContent() {
        if (isGuestModeSupported()) {
            return getActivity().getText(C0444R.string.screen_pinning_guest_user_description);
        }
        return getActivity().getText(C0444R.string.screen_pinning_description);
    }
}
