...
public class LockscreenDashboardFragment extends DashboardFragment implements OwnerInfoPreferenceController.OwnerInfoCallback {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.security_lockscreen_settings) {
    ...
    public int getHelpResource() {
        return C0444R.string.help_url_lockscreen;
    }
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.security_lockscreen_settings;
    }

    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        replaceEnterpriseStringTitle(KEY_LOCK_SCREEN_NOTIFICATON_WORK_PROFILE, "Settings.WORK_PROFILE_LOCKED_NOTIFICATION_TITLE", C0444R.string.locked_work_profile_notification_title);
        replaceEnterpriseStringTitle(KEY_LOCK_SCREEN_NOTIFICATON_WORK_PROFILE_HEADER, "Settings.WORK_PROFILE_NOTIFICATIONS_SECTION_HEADER", C0444R.string.profile_section_header);
    }
