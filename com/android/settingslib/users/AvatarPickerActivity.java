...
public class AvatarPickerActivity extends Activity {
    ...
    private void setUpButtons() {
        ...
        FooterButton build = new FooterButton.Builder(this).setText("Cancel").setListener(new AvatarPickerActivity$$ExternalSyntheticLambda1(this)).build();
        FooterButton build2 = new FooterButton.Builder(this).setText("Done").setListener(new AvatarPickerActivity$$ExternalSyntheticLambda0(this)).build();
