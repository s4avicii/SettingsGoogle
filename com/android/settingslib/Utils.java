...
public class Utils {
    ...
    public static String getUserLabel(Context context, UserInfo userInfo) {
        ...
        if (userInfo.isManagedProfile()) {
            return ((DevicePolicyManager) context.getSystemService(DevicePolicyManager.class)).getString("Settings.WORK_PROFILE_USER_LABEL", new Utils$$ExternalSyntheticLambda0(context));
        }
        if (userInfo.isGuest()) {
