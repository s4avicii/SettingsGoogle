...
public class UserIconDrawable extends Drawable implements Drawable.Callback {
    ...
    private static Drawable getUpdatableManagedUserDrawable(Context context) {
        return ((DevicePolicyManager) context.getSystemService(DevicePolicyManager.class)).getDrawableForDensity("WORK_PROFILE_USER_ICON", "SOLID_COLORED", context.getResources().getDisplayMetrics().densityDpi, new UserIconDrawable$$ExternalSyntheticLambda0(context));
    }
