...
public class ZenDurationDialog {
    ...
    public void setupRadioButtons(int i) {
        ...
        getConditionTagAt(i2).f186rb.setChecked(true);
    }
    ...
    private void bindTag(int i, View view, int i2) {
        ...
        if (conditionTag.f186rb == null) {
            conditionTag.f186rb = (RadioButton) this.mZenRadioGroup.getChildAt(i2);
        }
        if (i <= 0) {
        ...
        conditionTag.f186rb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                if (z) {
                    conditionTag.f186rb.setChecked(true);
                }
            }
        });
