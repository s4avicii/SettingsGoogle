...
import com.android.settings.network.telephony.C1044x7d702dd2;
...
public class DreamBackend {
    ...
    public DreamBackend(Context context) {
        ...
        Set<Integer> set = (Set) Arrays.stream(resources.getIntArray(17236126)).boxed().collect(Collectors.toSet());
    ...
    private static String convertToString(Set<Integer> set) {
        return (String) set.stream().map(C1044x7d702dd2.INSTANCE).collect(Collectors.joining(","));
    }
