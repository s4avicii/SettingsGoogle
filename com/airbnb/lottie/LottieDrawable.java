...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public LottieDrawable() {
        ...
        C04711 r3 = new ValueAnimator.AnimatorUpdateListener() {
    ...
    public void draw(Canvas canvas) {
        this.isDirty = false;
        C0457L.beginSection("Drawable#draw");
        if (this.safeMode) {
            try {
                drawInternal(canvas);
            } catch (Throwable th) {
        ...
        C0457L.endSection("Drawable#draw");
    }
