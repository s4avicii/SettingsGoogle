...
public abstract class CharMatcher {
    ...
    /* renamed from: or */
    public CharMatcher mo22114or(CharMatcher charMatcher) {
        return new C1854Or(this, charMatcher);
    }
    ...
    private static final class C1854Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;

        C1854Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
    ...
    private static final class C1853Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo22114or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : CharMatcher.super.mo22114or(charMatcher);
        }
