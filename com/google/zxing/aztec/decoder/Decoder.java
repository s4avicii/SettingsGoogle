...
public final class Decoder {
    ...
    private static int totalBitsInLayer(int i, boolean z) {
        return ((z ? 88 : C0444R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) + (i * 16)) * i;
    }
    ...
    static /* synthetic */ class C19221 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.aztec.decoder.Decoder.C19221.<clinit>():void");
        }
    }

    private static String getCharacter(Table table, int i) {
        int i2 = C19221.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table[table.ordinal()];
        if (i2 == 1) {
