        ...
        try {
            ...
            if (call != null) {
                if (call.getBoolean("success")) {
                    ...
                    String readableDuration = getReadableDuration(Long.valueOf(bundle2.getLong("total_time_millis")), MeasureFormat.FormatWidth.NARROW, C0444R.string.duration_less_than_one_minute, false);
                    return this.mContext.getString(C0444R.string.screen_time_summary_usage_today, new Object[]{readableDuration});
                }
            }
            if (DEBUG) {
