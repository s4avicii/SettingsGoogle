...
public class ReverseChargingSeekBarPreference extends SeekBarPreference {
    ...
    public ReverseChargingSeekBarPreference(Context context, AttributeSet attributeSet) {
        ...
        setLayoutResource(C0444R.C0450layout.preference_reverse_charging_slider);
    }

    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        super.onBindViewHolder(preferenceViewHolder);
        this.mPercentage = (TextView) preferenceViewHolder.findViewById(C0444R.C0448id.percentage_number);
        ((ImageView) preferenceViewHolder.findViewById(16908294)).setImageResource(C0444R.C0447drawable.ic_reverse_charging);
