...
public class NightDisplaySetting implements Queryable {
    ...
    public Cursor getAccessCursor(Context context, SliceData sliceData) {
        ...
        String intentString = getIntentString(context, "night_display", NightDisplaySettings.class, getScreenTitle(context), C0444R.string.menu_key_display);
    ...
    private String getScreenTitle(Context context) {
        return context.getString(C0444R.string.night_display_title);
    }
}
