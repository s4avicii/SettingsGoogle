...
public class DataSaverSetting implements Queryable {
    private int getIconResource() {
        return C0444R.C0447drawable.ic_settings_data_usage;
    }
    ...
    public Cursor getAccessCursor(Context context, SliceData sliceData) {
        ...
        String intentString = getIntentString(context, "data_saver", DataUsageSummary.class, getScreenTitle(context), C0444R.string.menu_key_network);
