...
public class MobileDataSetting implements Queryable {
    ...
    /* renamed from: ON */
    private final int f199ON = 1;

    private int getIconResource() {
        return C0444R.C0447drawable.ic_network_cell;
    }
    ...
    public Cursor getAccessCursor(Context context, SliceData sliceData) {
        ...
        String intentString = getIntentString(context, "mobile_data", DataUsageSummary.class, getScreenTitle(context), C0444R.string.menu_key_network);
    ...
    private String getScreenTitle(Context context) {
        return context.getString(C0444R.string.data_usage_summary_title);
    }
}
