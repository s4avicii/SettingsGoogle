...
public class LocationSetting implements Queryable {
    ...
    public Cursor getAccessCursor(Context context, SliceData sliceData) {
        ...
        String intentString = getIntentString(context, "location", LocationSettings.class, getScreenTitle(context), C0444R.string.menu_key_location);
    ...
    private String getScreenTitle(Context context) {
        return context.getString(C0444R.string.location_settings_title);
    }
