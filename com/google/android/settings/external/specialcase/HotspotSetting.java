...
public class HotspotSetting implements Queryable {
    private int getIconResource() {
        return C0444R.C0447drawable.ic_hotspot;
    }

    public Cursor getAccessCursor(Context context, SliceData sliceData) {
        return createQueryCursor(getCurrentValue((WifiManager) context.getSystemService("wifi")), getAvailability(context, (ConnectivityManager) context.getSystemService("connectivity")), getIntentString(context, "enable_wifi_ap", TetherSettings.class, getScreenTitle(context), C0444R.string.menu_key_network), getIconResource());
    }
    ...
    public Cursor getUpdateCursor(Context context, SliceData sliceData, int i) {
        ...
        String intentString = getIntentString(context, "enable_wifi_ap", TetherSettings.class, getScreenTitle(context), C0444R.string.menu_key_network);
    ...
    private String getScreenTitle(Context context) {
        return context.getString(C0444R.string.network_dashboard_title);
    }
}
