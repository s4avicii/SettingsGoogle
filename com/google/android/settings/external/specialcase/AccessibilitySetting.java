...
public class AccessibilitySetting implements Queryable {
    ...
    public Cursor getAccessCursor(Context context, SliceData sliceData) {
        ...
        String intentString = getIntentString(context, this.mServiceName, AccessibilitySettings.class, getScreenTitle(context), C0444R.string.menu_key_accessibility);
    ...
    private String getScreenTitle(Context context) {
        return context.getString(C0444R.string.accessibility_settings);
    }
}
