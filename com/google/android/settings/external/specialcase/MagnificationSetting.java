...
public class MagnificationSetting implements Queryable {
    ...
    public Cursor getAccessCursor(Context context, SliceData sliceData) {
        ...
        String intentString = getIntentString(context, "magnification_preference_screen", AccessibilitySettings.class, getScreenTitle(context), C0444R.string.menu_key_accessibility);
    ...
    private String getScreenTitle(Context context) {
        return context.getString(C0444R.string.accessibility_settings_title);
    }
}
