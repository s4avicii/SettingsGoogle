...
public class WifiSetting implements Queryable {
    ...
    public Cursor getAccessCursor(Context context, SliceData sliceData) {
        ...
        String intentString = getIntentString(context, "master_wifi_toggle", WifiSettings.class, getScreenTitle(context), C0444R.string.menu_key_network);
    ...
    private String getScreenTitle(Context context) {
        return context.getString(C0444R.string.wifi_settings);
    }
}
