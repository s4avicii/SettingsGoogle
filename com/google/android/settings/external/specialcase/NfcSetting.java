...
public class NfcSetting implements Queryable {
    ...
    public Cursor getAccessCursor(Context context, SliceData sliceData) {
        ...
        String intentString = getIntentString(context, "nfc", ConnectedDeviceDashboardFragment.class, getScreenTitle(context), C0444R.string.menu_key_connected_devices);
    ...
    private String getScreenTitle(Context context) {
        return context.getString(C0444R.string.connected_devices_dashboard_title);
    }
}
