...
public class GameModeSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.game_mode_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.game_mode_settings;
    }
