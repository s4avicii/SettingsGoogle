...
public class GameModeHeaderController extends BasePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mEntityHeaderController = EntityHeaderController.newInstance(activity, this.mParent, this.mHeader.findViewById(C0444R.C0448id.entity_header)).setPackageName(this.mPackageName);
