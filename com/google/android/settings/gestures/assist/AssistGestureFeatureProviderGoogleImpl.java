...
public class AssistGestureFeatureProviderGoogleImpl extends AssistGestureFeatureProviderImpl {
    ...
    public boolean isDeskClockSupported(Context context) {
        ...
        try {
            PermissionInfo permissionInfo = packageManager.getPermissionInfo(resources.getString(C0444R.string.gesture_assist_deskclock_permission), 0);
            if (permissionInfo == null || !permissionInfo.packageName.equals(resources.getString(C0444R.string.gesture_assist_deskclock_package))) {
                return false;
            }
            return true;
    ...
    private static boolean isGsaCurrentAssistant(Context context) {
        String string = context.getResources().getString(C0444R.string.gesture_assist_component);
