...
public class AssistGestureBubbleActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C0444R.C0450layout.assist_gesture_bubble_activity);
        getWindow().setBackgroundDrawableResource(C0444R.C0447drawable.assist_gesture_bubble_activity_bg);
        this.mHandler = new Handler(getMainLooper());
        this.mAssistGestureHelper = new AssistGestureHelper(getApplicationContext());
        this.mCurrentScoreTextView = (TextView) findViewById(C0444R.C0448id.current_score);
        this.mGameView = (ImageView) findViewById(C0444R.C0448id.game_view);
        ...
        this.mPlayView = (ImageView) findViewById(C0444R.C0448id.play_view);
