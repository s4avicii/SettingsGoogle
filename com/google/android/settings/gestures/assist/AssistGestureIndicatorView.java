...
public class AssistGestureIndicatorView extends LinearLayout {
    ...
    public AssistGestureIndicatorView(Context context) {
        super(context);
        ViewGroup viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0444R.C0450layout.assist_gesture_indicator_container, this, false);
        this.mLayout = viewGroup;
        if (viewGroup != null) {
            addView(viewGroup);
            this.mLeftDrawable = new IndicatorDrawable(context, false);
            this.mRightDrawable = new IndicatorDrawable(context, true);
            this.mLeftIndicator = (ImageView) this.mLayout.findViewById(C0444R.C0448id.indicator_left);
            this.mRightIndicator = (ImageView) this.mLayout.findViewById(C0444R.C0448id.indicator_right);
