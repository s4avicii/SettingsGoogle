...
public class ContextualSuggestionFragment extends InstrumentedFragment implements SuggestionController.ServiceConnectionListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(C0444R.C0450layout.contextual_suggestion_tile, viewGroup, true);
    ...
    public int getSuggestionTitle(String str) {
        ...
        if (str.equals(SUW_PACKAGE)) {
            return C0444R.string.setup_suggestion_title;
        }
        if (!str.equals(TIPS_PACKAGE)) {
            return 0;
        }
        return C0444R.string.tips_suggestion_title;
    }
    ...
    public int getSuggestionSummary(String str) {
        str.hashCode();
        if (str.equals(SUW_PACKAGE)) {
            return C0444R.string.setup_suggestion_summary;
        }
        if (!str.equals(TIPS_PACKAGE)) {
            return 0;
        }
        return C0444R.string.tips_suggestion_summary;
    }
