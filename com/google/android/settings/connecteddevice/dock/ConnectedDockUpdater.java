...
public class ConnectedDockUpdater implements DockUpdater, DockAsyncQueryHandler.OnQueryListener {
    ...
    public void initPreference() {
        if (this.mDockPreference == null) {
            ...
            GearPreference gearPreference = new GearPreference(this.mPreferenceContext, (AttributeSet) null);
            this.mDockPreference = gearPreference;
            gearPreference.setSummary((CharSequence) this.mContext.getString(C0444R.string.dock_summary_charging_phone));
