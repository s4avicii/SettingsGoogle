...
public class AwareSettingsDialogPreference extends AwareDialogPreferenceBase {
    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder, DialogInterface.OnClickListener onClickListener) {
        ...
        builder.setTitle((int) C0444R.string.aware_settings_disabled_info_dialog_title).setMessage((int) C0444R.string.aware_settings_disabled_info_dialog_content).setPositiveButton((int) C0444R.string.nfc_how_it_works_got_it, (DialogInterface.OnClickListener) null).setNegativeButton((CharSequence) "", (DialogInterface.OnClickListener) null);
    }
}
