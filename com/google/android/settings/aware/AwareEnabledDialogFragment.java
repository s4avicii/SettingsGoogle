...
public class AwareEnabledDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        if (getArguments().getBoolean("extra_aware_allowed")) {
            i = C0444R.string.aware_settings_enabled_info_dialog_title;
            i2 = C0444R.string.aware_settings_enabled_info_dialog_content;
        } else {
            i = C0444R.string.aware_settings_disabled_info_dialog_title;
            i2 = C0444R.string.aware_settings_disabled_info_dialog_content;
        }
        return new AlertDialog.Builder(getContext()).setTitle(i).setMessage(i2).setPositiveButton((int) C0444R.string.nfc_how_it_works_got_it, (DialogInterface.OnClickListener) null).create();
    }
}
