...
abstract class AwareGestureDialogPreference extends AwareDialogPreferenceBase implements DialogInterface.OnClickListener {
    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder, DialogInterface.OnClickListener onClickListener) {
        ...
        if (!this.mHelper.isSupported()) {
            builder.setTitle(getGestureDialogTitle()).setMessage(getDialogDisabledMessage()).setPositiveButton((int) C0444R.string.gesture_aware_confirmation_action_button, (DialogInterface.OnClickListener) null).setNegativeButton((CharSequence) "", (DialogInterface.OnClickListener) null);
        } else {
            builder.setTitle(getGestureDialogTitle()).setMessage(getGestureDialogMessage()).setPositiveButton((int) C0444R.string.aware_disabled_preference_action, (DialogInterface.OnClickListener) this).setNegativeButton((int) C0444R.string.aware_disabled_preference_neutral, (DialogInterface.OnClickListener) null);
        }
    }
}
