...
public abstract class AwareGesturePreferenceController extends AwareBasePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        return this.mContext.getText((!isBatterySaverModeOn || !isAirplaneModeOn) ? isBatterySaverModeOn ? C0444R.string.aware_summary_when_batterysaver_on : isAirplaneModeOn ? C0444R.string.aware_summary_when_airplane_on : 0 : C0444R.string.aware_summary_when_airplane_batterysaver_on);
    }
}
