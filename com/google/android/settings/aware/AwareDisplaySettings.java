...
public class AwareDisplaySettings extends RadioButtonPickerFragment {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C0444R.xml.aware_wake_display_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C0444R.xml.aware_wake_display_settings;
    }
    ...
    public void addStaticPreferences(PreferenceScreen preferenceScreen) {
        ...
        illustrationPreference.setLottieAnimationResId(C0444R.raw.lottie_aware_display);
    ...
    public List<? extends CandidateInfo> getCandidates() {
        ...
        if (this.mHelper.isSupported()) {
            arrayList.add(new CandidateInfoExtra(context.getText(C0444R.string.aware_wake_display_title), context.getText(C0444R.string.aware_wake_display_summary), KEY_WAKE_DISPLAY, this.mHelper.isGestureConfigurable()));
        }
        if (this.mConfig.alwaysOnAvailableForUser(MY_USER)) {
            arrayList.add(new CandidateInfoExtra(context.getText(C0444R.string.doze_always_on_title), context.getText(C0444R.string.doze_always_on_summary), KEY_ALWAYS_ON, true));
        }
        arrayList.add(new CandidateInfoExtra(context.getText(C0444R.string.switch_off_text), (CharSequence) null, KEY_OFF, true));
        return arrayList;
    }
