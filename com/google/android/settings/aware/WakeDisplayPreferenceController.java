...
public class WakeDisplayPreferenceController extends AwareTogglePreferenceController {
    ...
    public CharSequence getSummary() {
        return this.mContext.getText(getAmbientConfig().alwaysOnEnabled(this.mUserId) ? C0444R.string.aware_wake_display_summary : C0444R.string.aware_wake_display_summary_aod_off);
    }
