...
public class FaceEnrollEnrolling extends FragmentActivity implements FaceEnrollSidecar.Listener {
    ...
    private class HelpController {
        ...
        public void showHelp(CharSequence charSequence) {
            ...
            if ((FaceEnrollEnrolling.this.mErrorText.getVisibility() != 0 || !TextUtils.equals(charSequence, FaceEnrollEnrolling.this.mErrorText.getText())) && !TextUtils.isEmpty(charSequence)) {
                ...
                float dimensionPixelSize = (float) FaceEnrollEnrolling.this.getResources().getDimensionPixelSize(C0444R.dimen.face_error_text_appear_distance);
        ...
        public void clearHelp() {
            ...
            if (this.mTextAnimation != null) {
                ...
                ViewPropertyAnimator withEndAction = FaceEnrollEnrolling.this.mErrorText.animate().alpha(0.0f).translationY((float) FaceEnrollEnrolling.this.getResources().getDimensionPixelSize(C0444R.dimen.face_error_text_appear_distance)).setDuration(200).setInterpolator(FaceEnrollEnrolling.this.mLinearOutSlowInInterpolator).withEndAction(new FaceEnrollEnrolling$HelpController$$ExternalSyntheticLambda1(this));
    ...
    public /* synthetic */ void lambda$new$0() {
        this.mHelpController.showHelp(getText(C0444R.string.face_enrolling_center_head));
    }
    ...
    public /* synthetic */ void lambda$new$1() {
        ...
        if (i == -1 || i == 25) {
            ...
            showErrorDialog(getText(C0444R.string.security_settings_face_enroll_error_timeout_dialog_message), 3);
        }
    }

    public void onCreate(Bundle bundle) {
        ThemeResolver.getDefault().applyTheme(this);
        setContentView((int) C0444R.C0450layout.face_enrolling);
        ((SquareFrameLayout) findViewById(C0444R.C0448id.square_frame_layout)).setOuterRegion(C0444R.C0448id.indicator_view, 30);
        ...
        this.mShouldManagePreview = getResources().getBoolean(C0444R.bool.config_face_settings_should_manage_preview);
        ...
        if (this.mFromSetupWizard) {
            this.mFooterBarMixin.setSecondaryButton(new FooterButton.Builder(this).setText((int) C0444R.string.face_enrolling_do_it_later).setListener(new FaceEnrollEnrolling$$ExternalSyntheticLambda3(this)).setButtonType(7).setTheme(C0444R.style.SudGlifButton_Secondary).build());
        } else {
            this.mFooterBarMixin.setSecondaryButton(new FooterButton.Builder(this).setText((int) C0444R.string.face_enrolling_gaze_dialog_cancel).setListener(new FaceEnrollEnrolling$$ExternalSyntheticLambda3(this)).setButtonType(2).setTheme(C0444R.style.SudGlifButton_Secondary).build());
        }
        ...
        if (!this.mRequireDiversity) {
            setHeaderText(C0444R.string.face_enrolling_title_accessibility);
            getLayout().setDescriptionText((int) C0444R.string.face_enrolling_center_head);
            this.mDisabledFeatures.add(2);
        } else {
            setHeaderText(C0444R.string.face_enrolling_title);
        }
    ...
    public void onEnrollmentHelp(int i, CharSequence charSequence) {
        ...
        if (this.mTalkbackEnabled || !this.mRequireDiversity) {
            switch (i) {
                case 4:
                    charSequence = getText(C0444R.string.face_enrolling_too_close);
                    break;
                case 5:
                    charSequence = getText(C0444R.string.face_enrolling_too_far);
                    break;
                case 6:
                    charSequence = getText(C0444R.string.face_enrolling_too_high);
                    break;
                case 7:
                    charSequence = getText(C0444R.string.face_enrolling_too_low);
                    break;
                case 8:
                    charSequence = getText(C0444R.string.face_enrolling_too_right);
                    break;
                case 9:
                    charSequence = getText(C0444R.string.face_enrolling_too_left);
                    break;
                case 11:
                    charSequence = getText(C0444R.string.face_enrolling_center_head);
                    break;
            }
        } else {
            if (i != 11) {
                switch (i) {
                    ...
                    default:
                        switch (i) {
                            ...
                            case 1132:
                            case 1133:
                                charSequence = getText(C0444R.string.face_enrolling_turned_too_far);
                                break;
                        }
                }
            }
    ...
    public void onEnrollmentError(int i, CharSequence charSequence) {
        ...
        if (i == 3) {
            charSequence2 = getText(C0444R.string.security_settings_face_enroll_error_timeout_dialog_message);
        } else {
            charSequence2 = (i < 1000 && i != 4) ? getText(C0444R.string.security_settings_face_enroll_error_generic_dialog_message) : charSequence;
        }
    ...
    private void showPartialEnrollmentDialog() {
        FaceEnrollDialogFactory.newBuilder(this).setTitle(C0444R.string.security_settings_face_enroll_partial_title).setMessage((int) C0444R.string.security_settings_face_enroll_partial_message).setPositiveButton(C0444R.string.security_settings_face_enroll_dialog_ok, new FaceEnrollEnrolling$$ExternalSyntheticLambda2(this)).setNegativeButton(C0444R.string.security_settings_face_enroll_partial_start_over, new FaceEnrollEnrolling$$ExternalSyntheticLambda0(this)).setOnBackKeyListener(new FaceEnrollEnrolling$$ExternalSyntheticLambda4(this)).build().show();
    }
    ...
    private GlifLayout getLayout() {
        return (GlifLayout) findViewById(C0444R.C0448id.setup_wizard_layout);
    }
