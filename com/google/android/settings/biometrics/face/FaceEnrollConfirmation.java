...
public class FaceEnrollConfirmation extends FragmentActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) C0444R.C0450layout.face_enroll_confirmation);
        ...
        setHeaderText(C0444R.string.security_settings_face_enroll_finish_title);
        getLayout().setDescriptionText((int) C0444R.string.security_settings_face_enroll_finish_description);
        FooterBarMixin footerBarMixin = (FooterBarMixin) getLayout().getMixin(FooterBarMixin.class);
        this.mFooterBarMixin = footerBarMixin;
        footerBarMixin.setPrimaryButton(new FooterButton.Builder(this).setText((int) C0444R.string.security_settings_face_enroll_done).setListener(new FaceEnrollConfirmation$$ExternalSyntheticLambda0(this)).setButtonType(5).setTheme(C0444R.style.SudGlifButton_Primary).build());
    }
    ...
    private GlifLayout getLayout() {
        return (GlifLayout) findViewById(C0444R.C0448id.face_enroll_confirmation);
    }
