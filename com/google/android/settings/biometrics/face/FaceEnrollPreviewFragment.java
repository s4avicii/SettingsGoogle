...
public class FaceEnrollPreviewFragment extends Fragment implements FaceEnrollSidecar.Listener, FaceEnrollSidecar.PreviewSurfaceProvider {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mTextureView = (SquareTextureView) getActivity().findViewById(C0444R.C0448id.texture_view);
        this.mCircleView = (ImageView) getActivity().findViewById(C0444R.C0448id.circle_view);
        if (bundle != null) {
        ...
        if (this.mRequireDiversity) {
            this.mAnimationDrawable = new FaceEnrollAnimationMultiAngleDrawable(getContext(), this.mLocalAnimationListener, (ImageView) getActivity().findViewById(C0444R.C0448id.indicator_view), (ImageView) getActivity().findViewById(C0444R.C0448id.distance_indicator_view), this.mFromSetupWizard, bundle);
        } else {
            this.mAnimationDrawable = new FaceEnrollAnimationSingleCaptureDrawable(getContext(), this.mLocalAnimationListener, (ImageView) getActivity().findViewById(C0444R.C0448id.distance_indicator_view), this.mFromSetupWizard);
        }
    ...
    public void configureTransform(int i, int i2) {
        if (this.mTextureView != null) {
            ...
            getResources().getValue(C0444R.dimen.face_preview_scale, typedValue, true);
            Matrix matrix = new Matrix();
            this.mTextureView.getTransform(matrix);
            TypedValue typedValue2 = new TypedValue();
            TypedValue typedValue3 = new TypedValue();
            getResources().getValue(C0444R.dimen.face_preview_translate_x, typedValue2, true);
            getResources().getValue(C0444R.dimen.face_preview_translate_y, typedValue3, true);
