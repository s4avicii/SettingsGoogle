...
public class ArcCollection {
    ...
    public ArcCollection(Context context, Handler handler) {
        ...
        int[] iArr = {context.getResources().getColor(C0444R.C0446color.face_enroll_single_capture_rotating_4), context.getResources().getColor(C0444R.C0446color.face_enroll_single_capture_rotating_3), context.getResources().getColor(C0444R.C0446color.face_enroll_single_capture_rotating_2), context.getResources().getColor(C0444R.C0446color.face_enroll_single_capture_rotating_1)};
