...
public class GridController {
    ...
    public GridController(Context context, FaceEnrollAnimationMultiAngleDrawable.BucketListener bucketListener) {
        ...
        this.mScrimNotEnrolledDefaultColor = context.getColor(C0444R.C0446color.face_enroll_cell_not_enrolled);
        this.mScrimNotEnrolledPrimaryColor = context.getColor(C0444R.C0446color.face_enroll_cell_not_enrolled_primary);
        this.mScrimNotEnrolledSecondaryColor = context.getColor(C0444R.C0446color.face_enroll_cell_not_enrolled_secondary);
        int[] intArray = context.getResources().getIntArray(C0444R.array.face_enroll_primary_buckets);
        ...
        this.mNoActivityScrimState = new ScrimState(context.getColor(C0444R.C0446color.face_enroll_no_activity_gone), context.getColor(C0444R.C0446color.face_enroll_no_activity_showing));
