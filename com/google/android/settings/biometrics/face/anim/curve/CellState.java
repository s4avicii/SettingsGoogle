...
public class CellState {
    ...
    public CellState(Context context, int i, FaceEnrollAnimationMultiAngleDrawable.BucketListener bucketListener, int i2) {
        ...
        this.mScrimColorEnrolled = context.getColor(C0444R.C0446color.face_enroll_cell_enrolled);
        this.mCursorColorAcquired = context.getColor(C0444R.C0446color.face_enroll_cursor_acquired);
        int color = context.getColor(C0444R.C0446color.face_enroll_cursor_gone);
        this.mCursorColorGone = color;
        int color2 = context.getColor(C0444R.C0446color.face_enroll_cell_no_activity_start);
        this.mScrimColorNoActivityStart = color2;
        this.mScrimColorNoActivityEnd = context.getColor(C0444R.C0446color.face_enroll_cell_no_activity_end);
        boolean z = false;
        ...
        if (z2) {
            ...
            i3 = context.getColor(C0444R.C0446color.face_enroll_cursor_shadow);
        }
