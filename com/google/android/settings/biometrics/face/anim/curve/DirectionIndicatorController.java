...
public class DirectionIndicatorController {
    ...
    public DirectionIndicatorController(Context context, ImageView imageView) {
        ...
        paint.setColor(context.getColor(C0444R.C0446color.blue_500));
    ...
    private void pulseAnimation(int i, int i2, boolean z) {
        if (this.mBounds != null) {
            ...
            if (animatedVectorDrawable == null || !animatedVectorDrawable.isRunning()) {
                AnimatedVectorDrawable animatedVectorDrawable2 = (AnimatedVectorDrawable) this.mContext.getDrawable(C0444R.C0447drawable.face_indicator_triangle);
