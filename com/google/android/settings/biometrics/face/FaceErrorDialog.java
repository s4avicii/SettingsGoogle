...
public class FaceErrorDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        if (z) {
            newBuilder.setTitle(C0444R.string.security_settings_face_enroll_timeout_title);
            newBuilder.setMessage((int) C0444R.string.security_settings_face_enroll_timeout_message);
            newBuilder.setPositiveButton(C0444R.string.security_settings_face_enroll_timeout_use_fast_setup, faceErrorDialog$$ExternalSyntheticLambda0);
            newBuilder.setNegativeButton(C0444R.string.security_settings_face_enroll_timeout_try_again, faceErrorDialog$$ExternalSyntheticLambda0);
        } else if (i == 1003) {
            newBuilder.setTitle(C0444R.string.security_settings_face_enroll_too_hot_title);
            newBuilder.setMessage((int) C0444R.string.security_settings_face_enroll_too_hot_message);
            if (z2) {
                newBuilder.setPositiveButton(C0444R.string.security_settings_face_enroll_too_hot_skip_face_unlock, faceErrorDialog$$ExternalSyntheticLambda0);
            } else {
                newBuilder.setPositiveButton(C0444R.string.security_settings_face_enroll_too_hot_exit_setup, faceErrorDialog$$ExternalSyntheticLambda0);
            }
        } else {
            newBuilder.setTitle(C0444R.string.security_settings_face_enroll_error_dialog_title);
            newBuilder.setMessage(charSequence);
            newBuilder.setPositiveButton(C0444R.string.security_settings_face_enroll_dialog_ok, faceErrorDialog$$ExternalSyntheticLambda0);
        }
    ...
    public /* synthetic */ void lambda$onCreateDialog$0(boolean z, int i, DialogInterface dialogInterface, int i2) {
        if (!z) {
            ...
            getActivity().overridePendingTransition(C0444R.C0445anim.sud_slide_next_in, C0444R.C0445anim.sud_slide_next_out);
