...
public final class CollapsingTextHelper {
    ...
    private void calculateBaseOffsets(boolean z) {
        ...
        int i = absoluteGravity & C0444R.styleable.AppCompatTheme_toolbarNavigationButtonStyle;
        if (i == 48) {
        ...
        int i3 = absoluteGravity2 & C0444R.styleable.AppCompatTheme_toolbarNavigationButtonStyle;
        if (i3 == 48) {
