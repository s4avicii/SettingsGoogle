...
public class HatsClient {
    ...
    public static boolean showSurveyIfAvailable(com.google.android.libraries.hats20.HatsShowRequest r12) {
        ...
        L_0x0015:
            ...
            monitor-enter(r0)
            boolean r2 = r0.get()     // Catch:{ all -> 0x015e }
            if (r2 == 0) goto L_0x0027
            java.lang.String r12 = "HatsLibClient"
            java.lang.String r2 = "Attempted to show a survey while another one was already running, bailing out."
            android.util.Log.d(r12, r2)     // Catch:{ all -> 0x015e }
            monitor-exit(r0)     // Catch:{ all -> 0x015e }
            return r1
        L_0x0027:
            android.app.Activity r2 = r12.getClientActivity()     // Catch:{ all -> 0x015e }
            boolean r3 = r2.isDestroyed()     // Catch:{ all -> 0x015e }
            if (r2 == 0) goto L_0x0155
            boolean r4 = r2.isFinishing()     // Catch:{ all -> 0x015e }
            if (r4 != 0) goto L_0x0155
            if (r3 == 0) goto L_0x003b
            goto L_0x0155
        L_0x003b:
            java.lang.String r5 = r12.getSiteId()     // Catch:{ all -> 0x015e }
            java.lang.Integer r8 = r12.getRequestCode()     // Catch:{ all -> 0x015e }
            android.app.Activity r3 = r12.getClientActivity()     // Catch:{ all -> 0x015e }
            com.google.android.libraries.hats20.storage.HatsDataStore r3 = com.google.android.libraries.hats20.storage.HatsDataStore.buildFromContext(r3)     // Catch:{ all -> 0x015e }
            r3.removeSurveyIfExpired(r5)     // Catch:{ all -> 0x015e }
            boolean r4 = r3.validSurveyExists(r5)     // Catch:{ all -> 0x015e }
            if (r4 != 0) goto L_0x0056
            monitor-exit(r0)     // Catch:{ all -> 0x015e }
            return r1
        L_0x0056:
            java.lang.String r4 = r3.getSurveyJson(r5)     // Catch:{ all -> 0x015e }
            r11 = 1
            if (r4 == 0) goto L_0x0144
            boolean r6 = r4.isEmpty()     // Catch:{ all -> 0x015e }
            if (r6 == 0) goto L_0x0065
            goto L_0x0144
        L_0x0065:
            android.content.res.Resources r6 = r2.getResources()     // Catch:{ MalformedSurveyException -> 0x0138, JSONException -> 0x0110 }
            com.google.android.libraries.hats20.model.SurveyController r6 = com.google.android.libraries.hats20.model.SurveyController.initWithSurveyFromJson(r4, r6)     // Catch:{ MalformedSurveyException -> 0x0138, JSONException -> 0x0110 }
            markSurveyRunning()     // Catch:{ all -> 0x015e }
            r3.removeSurvey(r5)     // Catch:{ all -> 0x015e }
            com.google.android.libraries.hats20.answer.AnswerBeacon r1 = new com.google.android.libraries.hats20.answer.AnswerBeacon     // Catch:{ all -> 0x015e }
            r1.<init>()     // Catch:{ all -> 0x015e }
            java.lang.String r3 = r6.getPromptParams()     // Catch:{ all -> 0x015e }
            com.google.android.libraries.hats20.answer.AnswerBeacon r7 = r1.setPromptParams(r3)     // Catch:{ all -> 0x015e }
            boolean r1 = r6.showInvitation()     // Catch:{ all -> 0x015e }
            if (r1 == 0) goto L_0x0101
            com.google.android.libraries.hats20.util.LayoutDimensions r1 = new com.google.android.libraries.hats20.util.LayoutDimensions     // Catch:{ all -> 0x015e }
            android.content.res.Resources r3 = r2.getResources()     // Catch:{ all -> 0x015e }
            r1.<init>(r3)     // Catch:{ all -> 0x015e }
            boolean r1 = r1.shouldDisplayPrompt()     // Catch:{ all -> 0x015e }
            if (r1 != 0) goto L_0x0096
            goto L_0x0101
        L_0x0096:
            boolean r1 = r2 instanceof androidx.fragment.app.FragmentActivity     // Catch:{ all -> 0x015e }
            if (r1 == 0) goto L_0x00ce
            androidx.fragment.app.FragmentActivity r2 = (androidx.fragment.app.FragmentActivity) r2     // Catch:{ all -> 0x015e }
            androidx.fragment.app.FragmentManager r1 = r2.getSupportFragmentManager()     // Catch:{ all -> 0x015e }
            java.lang.String r2 = "com.google.android.libraries.hats20.PromptDialogFragment"
            androidx.fragment.app.Fragment r2 = r1.findFragmentByTag(r2)     // Catch:{ all -> 0x015e }
            if (r2 != 0) goto L_0x00c6
            java.lang.Integer r9 = r12.getMaxPromptWidth()     // Catch:{ all -> 0x015e }
            boolean r10 = r12.isBottomSheet()     // Catch:{ all -> 0x015e }
            com.google.android.libraries.hats20.PromptDialogFragment r2 = com.google.android.libraries.hats20.PromptDialogFragment.newInstance(r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x015e }
            androidx.fragment.app.FragmentTransaction r1 = r1.beginTransaction()     // Catch:{ all -> 0x015e }
            int r12 = r12.getParentResId()     // Catch:{ all -> 0x015e }
            java.lang.String r3 = "com.google.android.libraries.hats20.PromptDialogFragment"
            androidx.fragment.app.FragmentTransaction r12 = r1.add((int) r12, (androidx.fragment.app.Fragment) r2, (java.lang.String) r3)     // Catch:{ all -> 0x015e }
            r12.commitAllowingStateLoss()     // Catch:{ all -> 0x015e }
            goto L_0x00ff
        L_0x00c6:
            java.lang.String r12 = "HatsLibClient"
            java.lang.String r1 = "PromptDialog was already open, bailing out."
            android.util.Log.w(r12, r1)     // Catch:{ all -> 0x015e }
            goto L_0x00ff
        L_0x00ce:
            android.app.FragmentManager r1 = r2.getFragmentManager()     // Catch:{ all -> 0x015e }
            java.lang.String r2 = "com.google.android.libraries.hats20.PromptDialogFragment"
            android.app.Fragment r2 = r1.findFragmentByTag(r2)     // Catch:{ all -> 0x015e }
            if (r2 != 0) goto L_0x00f8
            java.lang.Integer r9 = r12.getMaxPromptWidth()     // Catch:{ all -> 0x015e }
            boolean r10 = r12.isBottomSheet()     // Catch:{ all -> 0x015e }
            com.google.android.libraries.hats20.PlatformPromptDialogFragment r2 = com.google.android.libraries.hats20.PlatformPromptDialogFragment.newInstance(r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x015e }
            android.app.FragmentTransaction r1 = r1.beginTransaction()     // Catch:{ all -> 0x015e }
            int r12 = r12.getParentResId()     // Catch:{ all -> 0x015e }
            java.lang.String r3 = "com.google.android.libraries.hats20.PromptDialogFragment"
            android.app.FragmentTransaction r12 = r1.add(r12, r2, r3)     // Catch:{ all -> 0x015e }
            r12.commitAllowingStateLoss()     // Catch:{ all -> 0x015e }
            goto L_0x00ff
        L_0x00f8:
            java.lang.String r12 = "HatsLibClient"
        ...
        L_0x00ff:
            ...
            return r11
        L_0x0101:
            boolean r12 = r12.isBottomSheet()     // Catch:{ all -> 0x015e }
            r1 = r2
            r2 = r5
            r3 = r6
            r4 = r7
            r5 = r8
            r6 = r12
            com.google.android.libraries.hats20.SurveyPromptActivity.startSurveyActivity(r1, r2, r3, r4, r5, r6)     // Catch:{ all -> 0x015e }
            monitor-exit(r0)     // Catch:{ all -> 0x015e }
            return r11
        L_0x0110:
            r12 = move-exception
            java.lang.String r2 = "HatsLibClient"
            java.lang.String r3 = java.lang.String.valueOf(r5)     // Catch:{ all -> 0x015e }
            int r3 = r3.length()     // Catch:{ all -> 0x015e }
            int r3 = r3 + 46
            ...
            java.lang.String r3 = "."
            r4.append(r3)     // Catch:{ all -> 0x015e }
            java.lang.String r3 = r4.toString()     // Catch:{ all -> 0x015e }
            android.util.Log.e(r2, r3, r12)     // Catch:{ all -> 0x015e }
            monitor-exit(r0)     // Catch:{ all -> 0x015e }
            return r1
        L_0x0138:
            r12 = move-exception
            java.lang.String r2 = "HatsLibClient"
            java.lang.String r12 = r12.getMessage()     // Catch:{ all -> 0x015e }
            android.util.Log.e(r2, r12)     // Catch:{ all -> 0x015e }
            monitor-exit(r0)     // Catch:{ all -> 0x015e }
            return r1
        L_0x0144:
            java.lang.String r12 = "HatsLibClient"
            ...
            java.lang.Object[] r3 = new java.lang.Object[r11]     // Catch:{ all -> 0x015e }
            r3[r1] = r5     // Catch:{ all -> 0x015e }
            java.lang.String r2 = java.lang.String.format(r2, r3)     // Catch:{ all -> 0x015e }
            android.util.Log.e(r12, r2)     // Catch:{ all -> 0x015e }
            monitor-exit(r0)     // Catch:{ all -> 0x015e }
            return r1
        L_0x0155:
            java.lang.String r12 = "HatsLibClient"
            java.lang.String r2 = "Cancelling show request, activity was null, destroyed or finishing."
            android.util.Log.w(r12, r2)     // Catch:{ all -> 0x015e }
            monitor-exit(r0)     // Catch:{ all -> 0x015e }
            return r1
        L_0x015e:
            r12 = move-exception
