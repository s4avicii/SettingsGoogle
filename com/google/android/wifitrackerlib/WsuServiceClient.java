...
public class WsuServiceClient {
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 0) {
                ...
                if (networkGroupSubscription == null) {
                    ...
                    wsuServiceClient3.logd("The status of NetworkGroupSubscription of " + networkGroupSubscription + " is not loaded!");
                    return;
                }
    ...
    public WsuProvider getWsuProvider(NetworkGroupSubscription networkGroupSubscription) {
        return this.mWsuProviderCache.computeIfAbsent(networkGroupSubscription.uniqueIdentifier, new WsuServiceClient$$ExternalSyntheticLambda4(this, networkGroupSubscription));
    }
